pageextension 70092 JobJournalExt extends "Job Journal"
{
    ...
    layout
    {
        ...
        //Unsupported feature: Change Lookup on "Control 78". Please convert manually.
        ...
        modify("Control 1902114901")
        {

            //Unsupported feature: Change Name on "Control 1902114901". Please convert manually.

            ShowCaption = false;
        }

        //Unsupported feature: Change Name on "Control 1903098501". Please convert manually.
        ...
        //Unsupported feature: Change Name on "Control 1901991301". Please convert manually.
    ...
    actions
    {
        ...
        modify("Action 91")
        {
            ...
            //Unsupported feature: Change AccessByPermission on "Action 91". Please convert manually.

            Promoted = true;

            //Unsupported feature: Change Name on "Action 91". Please convert manually.
        ...
        //Unsupported feature: Change RunObject on "Action 37". Please convert manually.
        ...
        //Unsupported feature: Change Ellipsis on "Action 41". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "Control 100.OnAssistEdit.ChangeExchangeRate(Variable 1000)". Please convert manually.

    //var
    //>>>> ORIGINAL VALUE:
    //Control 100.OnAssistEdit.ChangeExchangeRate : 511;
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //Control 100.OnAssistEdit.ChangeExchangeRate : "Change Exchange Rate";
    //Variable type has not been exported.
