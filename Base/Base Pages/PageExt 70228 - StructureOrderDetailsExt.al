pageextension 70229 StructureOrderDetailsExt extends "Structure Order Details"
{
    ...
    layout
    {
        ...
        //Unsupported feature: CodeInsertion on ""Calculation Value"(Control 20)". Please convert manually.
        ...
        /*
         ...
         PURCHASE_LINE.SETRANGE(PURCHASE_LINE."Document No.","Document No.");
         PURCHASE_LINE.SETFILTER(PURCHASE_LINE."Frieght Charges",'>%1',0);
         IF PURCHASE_LINE.FINDFIRST THEN
           ERROR('PLEASE REMOVE THE FRIEGHT CHARGES IN PURCHASE LINES');
        */
        //end;
        addafter("Control 30")
        {
    ...
    //begin
    /*
    "Purchase Header".SETRANGE("Purchase Header"."Document Type","Document Type");
    "Purchase Header".SETRANGE("Purchase Header"."No.","Document No.");
    ...
    BEGIN
      "Purchase Header".TESTFIELD("Purchase Header".Status,"Purchase Header".Status::Open);
      "G|l".GET;
     // IF "G|l"."Active ERP-CF Connection" THEN
      //  "Purchase Header".Cashflow_Modification;
    END;
    */
    //end;
