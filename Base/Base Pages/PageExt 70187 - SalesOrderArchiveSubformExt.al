pageextension 70187 SalesOrderArchiveSubformExt extends "Sales Order Archive Subform"
{
    ...
    actions
    {
        ...
        //Unsupported feature: Change AccessByPermission on "Action 1907838004". Please convert manually.


        //Unsupported feature: Change Name on "Action 1907838004". Please convert manually.


        //Unsupported feature: Change Name on "Action 1903079504". Please convert manually.


        //Unsupported feature: Change Name on "Action 1902519704". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "ShowStrDetailsArchiveForm(PROCEDURE 1280001).StrOrderLineArchiveDetails(Variable 1280001)". Please convert manually.
    ...
    //Unsupported feature: CodeModification on "ShowStrDetailsArchiveForm(PROCEDURE 1280001)". Please convert manually.
