...
{
    // version NAVW19.00.00.50458,NAVIN9.00.00.50458
    ...
    layout
    {
        ...
        //Unsupported feature: CodeInsertion on ""No."(Control 4).OnValidate". Please convert manually.

        //trigger (Variable: Num)();
    ...
    actions
    {
        ...
        //Unsupported feature: Change AccessByPermission on "Action 1901991404". Please convert manually.


        //Unsupported feature: Change Name on "Action 1901991404". Please convert manually.


        //Unsupported feature: Change AccessByPermission on "Action 1900295904". Please convert manually.
        ...
        //Unsupported feature: Change Name on "Action 1900609704". Please convert manually.


        //Unsupported feature: Change Name on "Action 1904945204". Please convert manually.
        ...
        //Unsupported feature: Change AccessByPermission on "Action 1901033504". Please convert manually.


        //Unsupported feature: Change Name on "Action 1901033504". Please convert manually.


        //Unsupported feature: Change Name on "Action 1901288104". Please convert manually.
        ...
        //Unsupported feature: Change Name on "Action 1906943604". Please convert manually.


        //Unsupported feature: Change RunObject on "Action 1500009". Please convert manually.


        //Unsupported feature: Change RunPageLink on "Action 1500009". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "ShowPrices(PROCEDURE 15).PurchHeader(Variable 1102628001)". Please convert manually.
    ...
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //ShowPrices : "Purchase Header";
    //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "ShowPrices(PROCEDURE 15).PurchPriceCalcMgt(Variable 1102628000)". Please convert manually.
    ...
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //ShowPrices : "Purch. Price Calc. Mgt.";
    //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "ShowLineDisc(PROCEDURE 16).PurchHeader(Variable 1102628001)". Please convert manually.
    ...
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //ShowLineDisc : "Purchase Header";
    //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "ShowLineDisc(PROCEDURE 16).PurchPriceCalcMgt(Variable 1102628000)". Please convert manually.
    ...
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //ShowLineDisc : "Purch. Price Calc. Mgt.";
    //Variable type has not been exported.
