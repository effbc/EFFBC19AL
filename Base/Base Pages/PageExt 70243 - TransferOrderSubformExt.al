...
{
    // version NAVW19.00.00.50293,NAVIN9.00.00.50293,B2B1.0
    ...
    layout
    {
        ...
        //Unsupported feature: Change BlankZero on "Control 6". Please convert manually.
        ...
        //Unsupported feature: Change BlankZero on "Control 38". Please convert manually.
        ...
        //Unsupported feature: Change BlankZero on "Control 40". Please convert manually.
        ...
        //Unsupported feature: Change BlankZero on "Control 10". Please convert manually.
        ...
        //Unsupported feature: Change BlankZero on "Control 14". Please convert manually.
        ...
        addafter("Control 1500005")
        {
            ...
            field("Requirement Reason"; "Requirement Reason")
            {
            }
    ...
    actions
    {
        ...
        //Unsupported feature: Change Name on "Action 1901742204". Please convert manually.


        //Unsupported feature: Change Name on "Action 3". Please convert manually.


        //Unsupported feature: Change Name on "Action 1903866904". Please convert manually.


        //Unsupported feature: Change Name on "Action 1901313304". Please convert manually.


        //Unsupported feature: Change AccessByPermission on "Action 1901991604". Please convert manually.


        //Unsupported feature: Change Name on "Action 1901991604". Please convert manually.


        //Unsupported feature: Change Name on "Action 5". Please convert manually.


        //Unsupported feature: Change AccessByPermission on "Dimensions(Action 1901652204)". Please convert manually.


        //Unsupported feature: Change Name on "Action 1900295404". Please convert manually.


        //Unsupported feature: Change Name on "Action 1901992804". Please convert manually.


        //Unsupported feature: Change Name on "Action 1900296804". Please convert manually.


        //Unsupported feature: Change Name on "Action 1904418904". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "Control 14.OnDrillDown.TransShptLine(Variable 1001)". Please convert manually.

    //var
    //>>>> ORIGINAL VALUE:
    //Control 14.OnDrillDown.TransShptLine : 5745;
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //Control 14.OnDrillDown.TransShptLine : "Transfer Shipment Line";
    //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "Control 16.OnDrillDown.TransRcptLine(Variable 1001)". Please convert manually.

    //var
    //>>>> ORIGINAL VALUE:
    //Control 16.OnDrillDown.TransRcptLine : 5747;
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //Control 16.OnDrillDown.TransRcptLine : "Transfer Receipt Line";
    //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "OnDeleteRecord.ReserveTransferLine(Variable 1000)". Please convert manually.

    //var
    //>>>> ORIGINAL VALUE:
    //OnDeleteRecord.ReserveTransferLine : 99000836;
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //OnDeleteRecord.ReserveTransferLine : "Transfer Line-Reserve";
    //Variable type has not been exported.
