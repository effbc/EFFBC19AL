pageextension 70021 BlanketSaleOrderSubformExt extends "Blanket Sales Order Subform"
{
    ...
    layout
    {
        ...
        modify("No.")
        {
            ...
            begin
                item.RESET;
                IF (COPYSTR("Document No.", 15, 1) = 'L') THEN BEGIN
        ...
        addafter("Co&mments")
        {
            action("Create Production Order")
            {
                ...
                begin
                    ...
                    Rec.Quantity := CurrPage.SalesLines.PAGE.MakeLines(SalesLineRec);
    ...
    LOCAL PROCEDURE ValidateSaveShortcutDimCode@7(FieldNumber: Integer; VAR ShortcutDimCode: Code[20]);
    BEGIN
    ...
    var
        ...
        NewStatus: 'Simulated,Planned,"Firm Planned",Released';
      NewOrderType: 'ItemOrder,ProjectOrder';
