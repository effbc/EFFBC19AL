...
{
    // version NAVW19.00.00.50458,NAVIN9.00.00.50458,DWS1.0,SH1.0,B2BQTO
    ...
    layout
    {
        ...
        //Unsupported feature: Change BlankZero on "Control 36". Please convert manually.
        ...
        //Unsupported feature: Change BlankZero on "Control 58". Please convert manually.
        ...
        //Unsupported feature: Change DrillDown on ""Total Amount Excl. VAT"(Control 33)". Please convert manually.


        //Unsupported feature: Change ImplicitType on ""Total VAT Amount"(Control 31)". Please convert manually.

        modify(RefreshTotals)
        {

            //Unsupported feature: Change DrillDown on "RefreshTotals(Control 27)". Please convert manually.

            ShowCaption = false;

            //Unsupported feature: Change ImplicitType on "RefreshTotals(Control 27)". Please convert manually.
        ...
        */
        ...
        addafter("Control 1500025")
        {
            field("Amount To Customer"; "Amount To Customer")
            {
            }
        }
        addafter("Control 306")
        {
    ...
    actions
    {
        ...
        //Unsupported feature: Change AccessByPermission on "Action 1903134404". Please convert manually.


        //Unsupported feature: Change Name on "Action 1903134404". Please convert manually.


        //Unsupported feature: Change Name on "Action 26". Please convert manually.


        //Unsupported feature: Change Name on "Action 1901092104". Please convert manually.


        //Unsupported feature: Change AccessByPermission on "Action 1907075804". Please convert manually.


        //Unsupported feature: Change Name on "Action 1907075804". Please convert manually.
        ...
        //Unsupported feature: Change Name on "Action 1905987604". Please convert manually.
        ...
        //Unsupported feature: Change AccessByPermission on "Action 9". Please convert manually.


        //Unsupported feature: Change Ellipsis on "Action 9". Please convert manually.


        //Unsupported feature: Change Name on "Action 9". Please convert manually.


        //Unsupported feature: Change AccessByPermission on "Action 7". Please convert manually.


        //Unsupported feature: Change Ellipsis on "Action 7". Please convert manually.
        ...
        //Unsupported feature: Change AccessByPermission on "Action 23". Please convert manually.
        ...
        //Unsupported feature: Change AccessByPermission on "Action 19". Please convert manually.


        //Unsupported feature: Change Name on "Action 19". Please convert manually.


        //Unsupported feature: Change AccessByPermission on "InsertExtTexts(Action 17)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "Action 1905987604.OnAction.Item(Variable 1001)". Please convert manually.

    //var
    //>>>> ORIGINAL VALUE:
    //Action 1905987604.OnAction.Item : 27;
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //Action 1905987604.OnAction.Item : Item;
    //Variable type has not been exported.


    //Unsupported feature: PropertyModification on ""Invoice Discount Amount"(Control 47).OnValidate.SalesHeader(Variable 1000)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "ShowStrDetailsForm(PROCEDURE 1280001).StrOrderLineDetailsForm(Variable 1280000)". Please convert manually.

    //var
    //>>>> ORIGINAL VALUE:
    //ShowStrDetailsForm : 16306;
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //ShowStrDetailsForm : "Structure Order Line Details";
    //Variable type has not been exported.
    ...
    //Unsupported feature: PropertyModification on "TotalSalesHeader(Variable 1017)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "TotalSalesLine(Variable 1016)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "SalesPriceCalcMgt(Variable 1004)". Please convert manually.
