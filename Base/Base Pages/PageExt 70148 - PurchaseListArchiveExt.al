pageextension 70148 PurchaseListArchiveExt extends "Purchase List Archive"
{
    ...
    //Unsupported feature: PropertyModification on "Card(Action 64).OnAction.PageManagement(Variable 1000)". Please convert manually.
