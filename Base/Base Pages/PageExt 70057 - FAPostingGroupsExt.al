pageextension 70057 FAPostingGroupsExt extends "FA Posting Groups"
{
    ...
    actions
    {
        ...
        //Unsupported feature: Change RunObject on "Acquisition(Action 73)". Please convert manually.


        //Unsupported feature: Change RunPageLink on "Acquisition(Action 73)". Please convert manually.


        //Unsupported feature: Change RunObject on "Depreciation(Action 79)". Please convert manually.


        //Unsupported feature: Change RunPageLink on "Depreciation(Action 79)". Please convert manually.


        //Unsupported feature: Change RunObject on "WriteDown(Action 80)". Please convert manually.


        //Unsupported feature: Change RunPageLink on "WriteDown(Action 80)". Please convert manually.


        //Unsupported feature: Change RunObject on "Appreciation(Action 74)". Please convert manually.


        //Unsupported feature: Change RunPageLink on "Appreciation(Action 74)". Please convert manually.


        //Unsupported feature: Change RunObject on "Custom1(Action 81)". Please convert manually.


        //Unsupported feature: Change RunPageLink on "Custom1(Action 81)". Please convert manually.


        //Unsupported feature: Change RunObject on "Custom2(Action 82)". Please convert manually.


        //Unsupported feature: Change RunPageLink on "Custom2(Action 82)". Please convert manually.


        //Unsupported feature: Change RunObject on "Disposal(Action 83)". Please convert manually.


        //Unsupported feature: Change RunPageLink on "Disposal(Action 83)". Please convert manually.


        //Unsupported feature: Change RunObject on "Maintenance(Action 96)". Please convert manually.


        //Unsupported feature: Change RunPageLink on "Maintenance(Action 96)". Please convert manually.


        //Unsupported feature: Change RunObject on "Gain(Action 97)". Please convert manually.


        //Unsupported feature: Change RunPageLink on "Gain(Action 97)". Please convert manually.


        //Unsupported feature: Change RunObject on "Loss(Action 98)". Please convert manually.


        //Unsupported feature: Change RunPageLink on "Loss(Action 98)". Please convert manually.


        //Unsupported feature: Change RunObject on "BookValueGain(Action 99)". Please convert manually.


        //Unsupported feature: Change RunPageLink on "BookValueGain(Action 99)". Please convert manually.


        //Unsupported feature: Change RunObject on "BookValueLoss(Action 100)". Please convert manually.
