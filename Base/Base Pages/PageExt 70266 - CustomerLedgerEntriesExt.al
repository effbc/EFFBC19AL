                ...
                field(FiscialYear; FiscialYear)
                {
                    ...
                    begin
                        CASE FiscialYear OF
                            FiscialYear::"08-09":
                                BEGIN
                                    SETRANGE("Posting Date", DMY2DATE(1, 4, 2008), DMY2DATE(31, 3, 2009));
                                END;
                            FiscialYear::"09-10":
                                BEGIN
                                    SETRANGE("Posting Date", DMY2DATE(1, 4, 2009), DMY2DATE(31, 3, 2010));
                                END;
                            FiscialYear::"10-11":
                                BEGIN
                        ...
                        IF USERID IN ['EFFTRONICS\DURGARAOV', 'EFFTRONICS\RAMKUMARL', 'EFFTRONICS\SITARAJYAM', 'EFFTRONICS\PURNACHAND',
                            ...
                            IF GETRANGEMIN(Rec."Posting Date") > DMY2DATE(1, 4, 2008) THEN BEGIN
                                CLE.SETRANGE(CLE."Posting Date", DMY2DATE(1, 4, 2008), GETRANGEMIN(Rec."Posting Date") - 1);
                                IF CLE.FINDSET THEN
                                    REPEAT
                                        DLE.RESET;
        ...
        addafter(ReverseTransaction)
        {
            action("Un Apply")
            {
                ...
                END ELSE BEGIN */
                    ...
                    Amt := 0;
                    DLE.RESET;
                    DLE.SETRANGE(DLE."Customer No.", "Customer No.");
                    DLE.SETRANGE(DLE."Entry Type", DLE."Entry Type"::Application);
                    DLE.SETRANGE(DLE."Cust. Ledger Entry No.", "Entry No.");
                    ...
                    CLE.RESET;
                    CLE.SETRANGE(CLE."Customer No.", "Customer No.");
                    CLE.SETRANGE(CLE."Closed by Entry No.", "Entry No.");
                    IF CLE.FINDSET THEN
                        REPEAT
                            CLE."Closed by Entry No." := 0;
                            CLE."Closed at Date" := 0D;
