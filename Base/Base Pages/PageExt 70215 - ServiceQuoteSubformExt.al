pageextension 70215 ServiceQuoteSubformExt extends "Service Quote Subform"
{
    ...
    layout
    {
        ...
        //Unsupported feature: Change RunPageLink on "Control 60". Please convert manually.
    ...
    actions
    {
        ...
        //Unsupported feature: Change Name on "Action 1900545504". Please convert manually.


        //Unsupported feature: Change Name on "Action 1902479904". Please convert manually.


        //Unsupported feature: Change Name on "Action 1900978604". Please convert manually.


        //Unsupported feature: Change AccessByPermission on "Action 1907528404". Please convert manually.


        //Unsupported feature: Change Name on "Action 1907528404". Please convert manually.
        ...
        //Unsupported feature: Change Name on "Action 1900295704". Please convert manually.


        //Unsupported feature: Change Ellipsis on "Action 1902740204". Please convert manually.


        //Unsupported feature: Change Name on "Action 1902740204". Please convert manually.


        //Unsupported feature: Change Name on "Action 1900038104". Please convert manually.

        addafter("Action 1902740204")
        {
            action("&Attachments")
            {
                Caption = '&Attachments';
    ...
    //Unsupported feature: PropertyModification on "Action 1902740204.OnAction.StdServItemGrCode(Variable 1001)". Please convert manually.

    //var
        //>>>> ORIGINAL VALUE:
        //Action 1902740204.OnAction.StdServItemGrCode : 5998;
        //Variable type has not been exported.
        //>>>> MODIFIED VALUE:
        //Action 1902740204.OnAction.StdServItemGrCode : "Standard Service Item Gr. Code";
        //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "Control 6.OnLookup.ServOrderMgt(Variable 1000)". Please convert manually.

    //var
        //>>>> ORIGINAL VALUE:
        //Control 6.OnLookup.ServOrderMgt : 5900;
        //Variable type has not been exported.
        //>>>> MODIFIED VALUE:
        //Control 6.OnLookup.ServOrderMgt : ServOrderManagement;
        //Variable type has not been exported.
    ...
    //var
        //>>>> ORIGINAL VALUE:
        //RegisterServInvLines : 5966;
        //Variable type has not been exported.
        //>>>> MODIFIED VALUE:
        //RegisterServInvLines : "Service Quote Lines";
        //Variable type has not been exported.
    ...
    //Unsupported feature: PropertyModification on "ShowServItemEventLog(PROCEDURE 13).ServItemLog(Variable 1000)". Please convert manually.

    //var
        //>>>> ORIGINAL VALUE:
        //ShowServItemEventLog : 5942;
        //Variable type has not been exported.
        //>>>> MODIFIED VALUE:
        //ShowServItemEventLog : "Service Item Log";
        //Variable type has not been exported.
    ...
    //Unsupported feature: PropertyModification on "ShowFaultResolutionRelation(PROCEDURE 9).ServMgtSetup(Variable 1008)". Please convert manually.

    //var
        //>>>> ORIGINAL VALUE:
        //ShowFaultResolutionRelation : 5911;
        //Variable type has not been exported.
        //>>>> MODIFIED VALUE:
        //ShowFaultResolutionRelation : "Service Mgt. Setup";
        //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "ShowFaultResolutionRelation(PROCEDURE 9).FaultResolutionRelation(Variable 1005)". Please convert manually.

    //var
        //>>>> ORIGINAL VALUE:
        //ShowFaultResolutionRelation : 5930;
        //Variable type has not been exported.
        //>>>> MODIFIED VALUE:
        //ShowFaultResolutionRelation : "Fault/Resol. Cod. Relationship";
        //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "CreateServItemOnServItemLine(PROCEDURE 10).ServItemMgt(Variable 1000)". Please convert manually.

    //var
        //>>>> ORIGINAL VALUE:
        //CreateServItemOnServItemLine : 5920;
        //Variable type has not been exported.
        //>>>> MODIFIED VALUE:
        //CreateServItemOnServItemLine : ServItemManagement;
        //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "ServLoanerMgt(Variable 1005)". Please convert manually.
