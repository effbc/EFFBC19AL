pageextension 70075 InventoryPostingSetupExt extends "Inventory Posting Setup"
{
    ...
    layout
    {
        ...
        //Unsupported feature: Change ImplicitType on ""Location Code2"(Control 28)". Please convert manually.


        //Unsupported feature: Change ImplicitType on ""Invt. Posting Group Code2"(Control 26)". Please convert manually.
