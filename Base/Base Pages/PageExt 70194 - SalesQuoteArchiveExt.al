pageextension 70194 SalesQuoteArchiveExt extends "Sales Quote Archive"
{
    ...
    layout
    {
        ...
        //Unsupported feature: Change SubPageLink on "SalesLinesArchive(Control 98)". Please convert manually.


        //Unsupported feature: Change PagePartID on "SalesLinesArchive(Control 98)". Please convert manually.
