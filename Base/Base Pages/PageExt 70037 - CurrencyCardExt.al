pageextension 70037 CurrencyCardExt extends "Currency Card"
{
    ...
    layout
    {
        ...
        //Unsupported feature: Change Name on "Control 1907140501". Please convert manually.
        ...
        //Unsupported feature: Change Name on "Control 1510110". Please convert manually.


        //Unsupported feature: Change ImplicitType on "Control 1510110". Please convert manually.
    ...
    actions
    {
        ...
        modify("Action 1901143306")
        {

            //Unsupported feature: Change RunObject on "Action 1901143306". Please convert manually.

            Promoted = true;

            //Unsupported feature: Change Name on "Action 1901143306". Please convert manually.
        ...
        modify("Action 1905388206")
        {

            //Unsupported feature: Change RunObject on "Action 1905388206". Please convert manually.

            Promoted = true;

            //Unsupported feature: Change Name on "Action 1905388206". Please convert manually.
        ...
        //Unsupported feature: Change AccessByPermission on "CRMSynchronizeNow(Action 9)". Please convert manually.


        //Unsupported feature: Change AccessByPermission on "ManageCRMCoupling(Action 5)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "Action 58.OnAction.ChangePmtTol(Variable 1001)". Please convert manually.

    //var
    //>>>> ORIGINAL VALUE:
    //Action 58.OnAction.ChangePmtTol : 34;
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //Action 58.OnAction.ChangePmtTol : "Change Payment Tolerance";
    //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "CRMGotoTransactionCurrency(Action 15).OnAction.CRMIntegrationManagement(Variable 1000)". Please convert manually.

    //var
    //>>>> ORIGINAL VALUE:
    //CRMGotoTransactionCurrency : 5330;
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //CRMGotoTransactionCurrency : "CRM Integration Management";
    //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "CRMSynchronizeNow(Action 9).OnAction.Currency(Variable 1000)". Please convert manually.
    ...
    //Variable type has not been exported.
    //>>>> MODIFIED VALUE:
    //CRMSynchronizeNow : Currency;
    //Variable type has not been exported.


    //Unsupported feature: PropertyModification on "CRMSynchronizeNow(Action 9).OnAction.CRMIntegrationManagement(Variable 1001)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "ManageCRMCoupling(Action 5).OnAction.CRMIntegrationManagement(Variable 1000)". Please convert manually.
