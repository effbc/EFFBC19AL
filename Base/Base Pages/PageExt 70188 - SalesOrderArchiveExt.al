pageextension 70188 SalesOrderArchiveExt extends "Sales Order Archive"
{
    ...
    layout
    {
        ...
        //Unsupported feature: Change SubPageLink on "SalesLinesArchive(Control 122)". Please convert manually.


        //Unsupported feature: Change PagePartID on "SalesLinesArchive(Control 122)". Please convert manually.
        ...
        //Unsupported feature: Change Name on "Control 247". Please convert manually.


        //Unsupported feature: Change ImplicitType on "Control 247". Please convert manually.


        //Unsupported feature: Change Name on "Control 253". Please convert manually.


        //Unsupported feature: Change ImplicitType on "Control 253". Please convert manually.
        ...
        //Unsupported feature: Change Name on "Control 1904291901". Please convert manually.
        ...
        addafter("Control 1500000")
        {
            ...
            field("Cancel / Short Close"; "Cancel / Short Close")
            {
            }
    ...
    actions
    {
        ...
        //Unsupported feature: Change AccessByPermission on "Action 127". Please convert manually.
        ...
        //Unsupported feature: Change RunPageLink on "Action 140". Please convert manually.
        ...
        //Unsupported feature: Change Name on "Action 258". Please convert manually.


        //Unsupported feature: Change RunObject on "Action 259". Please convert manually.


        //Unsupported feature: Change RunPageLink on "Action 259". Please convert manually.


        //Unsupported feature: Change Name on "Action 259". Please convert manually.
        ...
        modify(Restore)
        {
            ...
            //Unsupported feature: Change Ellipsis on "Restore(Action 130)". Please convert manually.
    ...
    //Unsupported feature: PropertyModification on "Restore(Action 130).OnAction.ArchiveManagement(Variable 1000)". Please convert manually.
