    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            begin
                ...
                TCS_Amount := 0;
                PAN := '';
                IF EInvoiceEntry.GET(EInvoiceEntry."Document Type"::"Sales Invoice", "Sales Invoice Header"."No.") THEN;
                    ...
                    IF SIL.FIND('-') THEN BEGIN
                        REPEAT
                            IF (SIL."HSN/SAC Code" <> CurrHSN) THEN BEGIN
                                ...
                                EnterCell(row, 54, FORMAT(EInvoiceEntry."IRN Cancelled"), FALSE, TempExcelBuffer."Cell Type"::Text);
                            END;
