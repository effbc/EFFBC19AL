    ...
    begin
        ...
        IF User.FINDSET THEN
          REPEAT
            ...
            REPEAT
              IF NOT (USER_SETUP."User ID" IN['EFFTRONICS\RAJANI','EFFTRONICS\SITARAJYAM','EFFTRONICS\ASWINI','EFFTRONICS\YESU','EFFTRONICS\MBNAGAMANI'])THEN
              BEGIN
              ...
              USER_SETUP.MODIFY;
              END
              ELSE IF  (USER_SETUP."User ID" IN['EFFTRONICS\RAJANI','EFFTRONICS\YESU','EFFTRONICS\MBNAGAMANI'])THEN BEGIN
