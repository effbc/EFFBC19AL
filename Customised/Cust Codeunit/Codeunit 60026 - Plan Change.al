        ...
        "Item Wise Req2".RESET;
         ...
         // reqqty:="Item Wise Req2"."Required Quantity";
          ...
          REPEAT
            ...
            Item.RESET;
            IF Item.GET(Alternate_Item) THEN
            BEGIN
              ...
              IF Shortage_Det3.FINDFIRST THEN
              BEGIN
              ...
              BEGIN
                ...
                ELSE BEGIN
                  ...
                  IF NOT(Dum_Purch_Line.FINDFIRST) THEN
                  BEGIN
                    Total_Buffer:=FORMAT(Item."Safety Lead Time");
