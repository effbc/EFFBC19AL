codeunit 33000250 "Post-Inspection Data Sheet"
{
    ...
    begin
        IF InspectHeader."Source Type" = InspectHeader."Source Type" :: "In Bound" THEN BEGIN
          ...
          ELSE IF InspectHeader."Document Type" = InspectHeader."Document Type" :: Receipt THEN BEGIN
          ...
          END
          ELSE IF InspectHeader."Document Type" = InspectHeader."Document Type" :: "Return Orders" THEN BEGIN
            ...
            InspectReportHeader.SETRANGE("Rework Reference No.",InspectHeader."Rework Reference No.");
          END ELSE IF InspectHeader."Document Type" = InspectHeader."Document Type" :: "Item Inspection" THEN BEGIN
              ...
              END;
        END ELSE IF InspectHeader."Source Type" = InspectHeader."Source Type" :: Calibration THEN BEGIN
          InspectReportHeader.SETRANGE("Item No.",InspectHeader."Item No.");
