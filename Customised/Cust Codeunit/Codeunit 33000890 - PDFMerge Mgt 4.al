codeunit 33000890 "PDFMerge Mgt 4"
{
    ...
    var
        ...
        PDFReader: DotNet "'PdfSharp, Version=1.0.898.0, Culture=neutral, PublicKeyToken=f94615aa0424f9eb'.PdfSharp.Pdf.IO.PdfReader";
        PDFOpenDocMode: DotNet "'PdfSharp, Version=1.0.898.0, Culture=neutral, PublicKeyToken=f94615aa0424f9eb'.PdfSharp.Pdf.IO.PdfDocumentOpenMode";
        i: Integer;
    begin
