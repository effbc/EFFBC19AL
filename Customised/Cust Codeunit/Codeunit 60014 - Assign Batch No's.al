codeunit 60014 "Assign Batch No's"
{
    ...
    begin
        ...
        IF (Item."Product Group Code"<>'LED') OR (Manual=TRUE) THEN
        BEGIN
          ...
          IF "ILEQty." < MaterialIssuesLine."Qty. to Receive" THEN
          BEGIN
               ...
               (USERID<>'EFFTRONICS\SUJANI') AND
                (USERID<>'EFFTRONICS\ANILKUMAR') AND
                    (USERID<>'EFFTRONICS\SPURTHI') AND
                       ...
                       (USERID<>'EFFTRONICS\BSATISH') AND (USERID<>'EFFTRONICS\SARDHAR') AND (USERID<>'EFFTRONICS\GRAVI') AND
    ...
    begin
        ...
        IF BatchndSerialNos.FINDSET THEN
        BEGIN
          REPEAT
            BatchndSerialNos.CALCFIELDS(BatchndSerialNos."Assigned Qty.");
            ...
            IF "Material Issues Header".GET(BatchndSerialNos."Order No.") THEN
            BEGIN
        ...
        // SANTHOSH KUMAR.K
          ...
          IF MaterialIssuesLine.Quantity>=AssignedQty THEN
          BEGIN
