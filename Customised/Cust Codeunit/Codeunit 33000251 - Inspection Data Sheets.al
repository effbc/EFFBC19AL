codeunit 33000251 "Inspection Data Sheets"
{
    ...
    begin
        WITH ProdOrderRoutingLine2 DO BEGIN
          ...
          END;
          //NSS 030907
          "Quantity Produced" := "Quantity Produced" + "Qty.To Produce";
          "Quantity Sent To Quality" := "Quantity Produced";
          IF Quantity - "Quantity Produced" > 0 THEN
    ...
    begin
        ...
        IF InspectionType = InspectionType :: Purchase THEN BEGIN
          ...
          InspectDataHeader."Product Group Code" := Item."Product Group Code";
        ...
        END ELSE IF InspectionType = InspectionType :: "Purchase Before Inspection" THEN BEGIN
        ...
        //B2B-ESPL-KNR
        END ELSE IF InspectionType = InspectionType :: "Repeated Inspection" THEN BEGIN
        ...
        END ELSE IF InspectionType = InspectionType :: SalesCrMemo THEN BEGIN
        ...
        END ELSE IF InspectionType = InspectionType :: ReturnOrder THEN BEGIN
          ...
          InspectDataHeader."Document Type" := InspectDataHeader."Document Type" :: "Return Orders";
        //B2B-ESPL
        END ELSE IF InspectionType = InspectionType :: "Production Order" THEN BEGIN
          //NSS 030907
        ...
        END ELSE IF InspectionType = InspectionType :: "Purchase Lot" THEN BEGIN
          InspectDataHeader.Description := PurchRcptHeader."Buy-from Vendor No.";
          InspectDataHeader."Receipt No." := PurchRcptHeader."No.";
          InspectDataHeader."Order No." := PurchRcptHeader."Order No.";
          InspectDataHeader."Posting Date" := PurchRcptHeader."Posting Date";
        ...
        //Hot fix
         ...
         //Hot fix 1.0
          ...
          InspectDataHeader."Quantity(Base)" := PurchRcptLine."Quantity (Base)";
        //Hot fix 1.0
        END ELSE IF InspectionType = InspectionType :: Rework THEN BEGIN
         ...
         //to get serial no
          ...
          //RQC1.0
        //Bhavani
        END ELSE IF InspectionType = InspectionType :: Calibration THEN BEGIN
          ...
          END ELSE IF Calibration."Calibration Party" = Calibration."Calibration Party" :: "External Calibration" THEN BEGIN
            InspectDataHeader."Calibration Party" := Calibration."Calibration Party";
