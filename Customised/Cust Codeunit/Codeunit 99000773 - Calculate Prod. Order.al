codeunit 99000773 "Calculate Prod. Order"
{
    ...
    begin
        ...
        IF NOT ProdOrderComp.FINDFIRST THEN BEGIN
          ...
          IF (Item."Product Group Code" = 'CPCB' )AND (AlternatePCB_BOM = TRUE) THEN
           BEGIN
             Alt.RESET;
          ...
          BEGIN
            IF Item2."Invert Solder type" =TRUE THEN
            BEGIN
              IF Item2."Type of Solder"=Item2."Type of Solder"::DIP  THEN
                 ProdOrderComp."Type of Solder2":='SMD'
              ELSE IF  (Item2."Type of Solder"=Item2."Type of Solder"::SMD) THEN
