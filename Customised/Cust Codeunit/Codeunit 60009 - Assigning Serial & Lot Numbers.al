codeunit 60009 "Assigning Serial & Lot Numbers"
{
    ...
    begin
        ...
        END ELSE IF "ILEQty." = 0 THEN BEGIN
          ItemJournalLine.Quantity := "ILEQty.";
          ItemJournalLine.VALIDATE(ItemJournalLine.Quantity);
          ItemJournalLine.MODIFY;
        END;
    ...
    begin
        ...
        IF Item.FINDFIRST THEN
          IF ItemTrackingCode.GET(Item."Item Tracking Code") THEN BEGIN
            ...
            END ELSE IF (ItemTrackingCode."Lot Specific Tracking") AND (ItemTrackingCode."SN Transfer Tracking") THEN BEGIN
              SerialNos := '';
              LotNos := LotNo;
              PurchaseTrackingLines(PurchaseLine,SerialNos,LotNos);
            END ELSE IF (ItemTrackingCode."SN Transfer Tracking") THEN BEGIN
              SerialNos := '';
              LotNos := '';
              PurchaseTrackingLines(PurchaseLine,SerialNos,LotNos);
            END;
