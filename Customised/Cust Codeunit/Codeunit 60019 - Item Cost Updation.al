codeunit 60019 "Item Cost Updation"
{
    ...
    begin
        ...
        REPEAT
          ...
          BEGIN
            ...
            BEGIN
              IF PurchaseInvLine.Quantity>0 THEN
              BEGIN
                ...
                IF PurchaseInvLine."Gen. Bus. Posting Group"<>'FOREIGN' THEN
                BEGIN
            ...
            IF RoutingHeader.Status<>RoutingHeader.Status::Certified THEN BEGIN
              ...
              IF RoutingLine.FINDSET THEN BEGIN
                 ...
                 IF RoutingLine.Type=RoutingLine.Type::"Work Center" THEN BEGIN
                   ...
                   END ELSE IF RoutingLine.Type=RoutingLine.Type::"Machine Center" THEN BEGIN
    ...
    begin
        ...
        IF PBMH.FINDSET THEN
        REPEAT
          IF FPO_ITEM.GET(PBMH."No.") THEN
          BEGIN
            IF FPO_ITEM."Product Group Code"='FPRODUCT' THEN
            BEGIN
              Window.UPDATE(1,PBMH."No.");
              PBMH."Total Soldering Points DIP":=0;
              PBMH."Total Soldering Points":=0;
              ...
              REPEAT
                ...
                BEGIN
                  ...
                  PBML.MODIFY;
                END ELSE IF Item.GET(PBML."No.") THEN
                BEGIN
        ...
        REPEAT
          IF FPO_ITEM.GET(PBMH."No.") THEN
          BEGIN
            IF FPO_ITEM."Product Group Code"='CPCB' THEN
            BEGIN
               Window.UPDATE(1,PBMH."No.");
              PBMH."Total Soldering Points DIP":=0;
              PBMH."Total Soldering Points":=0;
    ...
    begin
           ...
           BEGIN
             ...
             REPEAT
               IF BOM_HEADER2.GET(BOM_LINE."No.") THEN
               BEGIN
               ...
               END ELSE IF Item.GET(BOM_LINE."No.") THEN
               BEGIN
