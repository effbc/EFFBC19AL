codeunit 60029 "OMS Dump"
{
    ...
    // //Deleted Var(BOMJnlManagementCodeunitCodeunit250)
    ...
    begin
        ...
        REPEAT
          ...
          SQLQuery:='INSERT INTO ERP_ITEM (ITEM_NO,INVENTORY_AT_STORE,SAFETY_LEAD_TIME,AVERAGE_UNIT_COST,QUANTITY_UNDER_INSPECTION,'+
                    ...
                    ' VALUES ('''+ITEM."No."+''','''+
                      ...
                      CommaRemoval(FORMAT(ROUND(ITEM."Quantity Under Inspection",0.01)))+''','''+ITEM."Product Group Code"+''','''+
        ...
        REPEAT
          ...
          IF PURCHASE_HEADER.FINDFIRST THEN
          BEGIN
        ...
        REPEAT
          ...
          IF MATERIAL_ISSUES_HEADER.FIND('-') THEN
          BEGIN
        ...
        REPEAT
          IF (ALTERNATIVE_ITEMS."Item No."<>ALTERNATIVE_ITEMS."Alternative Item No.") THEN
          BEGIN
            IF PREV_ITEM<>ALTERNATIVE_ITEMS."Item No." THEN
            BEGIN
              FOR I:=1 TO 10 DO
                ALTERNATE_ITEMS[I]:='';
        ...
        REPEAT
          ...
          SQLQuery:=' INSERT INTO ERP_SALES_LINE VALUES ('''+SALES_LINE."Document No."+''','''+
                    SALES_LINE."No."+''','''+FORMAT(SALES_LINE.Type)+''','''+SALES_LINE."Product Group Code"+''','''+
