codeunit 60010 "Release MaterialIssue Document"
{
    ...
    begin
        ...
        IF "Transfer-to Code" = 'CST' THEN BEGIN
    ...
    begin
        IF USERID IN ['EFFTRONICS\ANILKUMAR', 'EFFTRONICS\MARY', 'EFFTRONICS\ANANDA', 'EFFTRONICS\RATNA', 'EFFTRONICS\DMADHAVI', 'EFFTRONICS\PADMASRI',
                      ...
                      'EFFTRONICS\GRAVI', 'EFFTRONICS\VISHNUPRIYA', 'EFFTRONICS\PKOTESWARARAO', 'EFFTRONICS\DURGAMALLESWARI', 'EFFTRONICS\TLAKSHMI', 'EFFTRONICS\TULASI', 'EFFTRONICS\RENUKACH', 'EFFTRONICS\RRAHUL', 'EFFTRONICS\B2BOTS'] THEN BEGIN
