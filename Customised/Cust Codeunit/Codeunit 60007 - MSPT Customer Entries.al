codeunit 60007 "MSPT Customer Entries"
{
    ...
    begin
        ...
        END ELSE IF (DtldCustLedgEntry."Entry Type" = DtldCustLedgEntry."Entry Type" :: "Unrealized Gain") THEN BEGIN
        ...
        IF MSPTCustLedgEntry.FINDSET THEN BEGIN
          REPEAT
            IF (I = 0) THEN BEGIN
              ...
              END ELSE IF ( DtldCustLedgEntry."Entry Type" = DtldCustLedgEntry."Entry Type" :: "Unrealized Loss" ) THEN BEGIN
              ...
              END ELSE IF (DtldCustLedgEntry."Entry Type" <> DtldCustLedgEntry."Entry Type"::"Initial Entry") AND
        ...
        //B2B         DtldMSPTCustLedgEntry."Export Document" := DtldCustLedgEntry."Export Document";
              ...
              END ELSE IF (DtldCustLedgEntry."Entry Type"=DtldCustLedgEntry."Entry Type"::Application) THEN BEGIN
                ...
                END ELSE IF (  - (Amount) > MSPTCustLedgEntry."MSPT Remaining Amount") THEN BEGIN
                  MSPTCustLedgEntry.CALCFIELDS( MSPTCustLedgEntry."MSPT Remaining Amount");
