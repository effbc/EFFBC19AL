codeunit 33000012 "Payroll Jnl.-Post Line"
{
    ...
    begin
        ...
        ///New Added
        IF PayrollJournalLine."Bal. Account No." <> '' THEN BEGIN
    ...
    begin
        ...
        IF RecNewEmpLdgrEntryBuf."Currency Code" = RecOldEmpLdgrEntryBuf2."Currency Code" THEN BEGIN
    ...
    begin
        ...
        ///////////
        IF NOT RecOldEmpLdgrEntryBuf.Open THEN BEGIN
        ...
        IF NOT RecNewEmpLdgrEntryBuf.Open AND RecOldEmpLdgrEntryBuf.Open THEN BEGIN
    ...
    begin
        ...
        IF AdjustedAmountLCY <> RecEmpLedgerEntryBuf."Remaining Amt. (LCY)" THEN BEGIN
            InitNewCELedgEntry(RecDtldEmpLedgEntryBuf, RecPayrollJournalLine);
    ...
    begin
        ...
        IF RecDtldEmpLedgEntryBuf.FIND('-') THEN BEGIN
        ...
        IF RecDtldEmpLedgEntryBuf."Entry Type" = RecDtldEmpLedgEntryBuf."Entry Type"::"Initial Entry" THEN BEGIN
    ...
    begin
        ...
        */
        ...
        IF RecNewEmpLedgrEntryBuf."Currency Code" <> '' THEN BEGIN
        ...
        IF RecPayrollJournalLine."Applies-to Doc. No." <> '' THEN BEGIN
            ...
            IF OldEmpLedgerEntryLocal.FIND('-') THEN BEGIN
            ...
            */
            ...
            IF OldEmpLedgerEntryLocal.FIND('-') THEN BEGIN
                ...
                REPEAT
                    ...
                    IF RecNewEmpLedgrEntryBuf."Currency Code" <> OldEmpLedgerEntryLocal."Currency Code" THEN BEGIN
        ...
        REPEAT
            ...
            IF RecNewEmpLedgrEntryBuf."Currency Code" <> OldEmpLedgerEntryBufLocal2."Currency Code" THEN BEGIN
            ...
            IF RecPayrollJournalLine."Applies-to Doc. No." <> '' THEN
                Completed := TRUE
            ELSE
                IF OldEmpLedgerEntryLocal.GETFILTER(OldEmpLedgerEntryLocal.Positive) <> '' THEN BEGIN
    ...
    begin
        ...
        IF RecPayrollJournalLine."Account Type" = RecPayrollJournalLine."Account Type"::Employee THEN BEGIN
            ...
            THEN
                IF (TotalAmountLCY <> 0) THEN BEGIN
                    BEGIN
                        //////////New Added
                        IF (RecPayrollJournalLine."Payment Indicator" = RecPayrollJournalLine."Payment Indicator"::Reimbursement) THEN BEGIN
                            InitGLEntry(EmpPostingGroup."Reimbursement Salary Acct", (TotalAmountLCY), (TotalAmountAddCurr), TRUE, TRUE);
                            InsertGLEntry(TRUE);
                        END
                        ELSE
                            IF (RecPayrollJournalLine."Payment Indicator" = RecPayrollJournalLine."Payment Indicator"::Include) THEN BEGIN
            ...
            //////New Added By Tanmoy
            IF NOT GLEntryTmp.FIND('-') AND RecDtldEmpLedgEntryBuf.FIND('-') THEN BEGIN
                //////////New Added
                IF (RecPayrollJournalLine."Payment Indicator" = RecPayrollJournalLine."Payment Indicator"::Reimbursement) THEN BEGIN
    ...
    var
        ...
        EmpLedgerEntryLocal: Record "Employee Ledger Entry";
    begin
        WITH RecEmpLdgrEntryBuf DO BEGIN
            IF EmpLedgerEntryLocal.GET("Closed by Entry No.") THEN BEGIN
