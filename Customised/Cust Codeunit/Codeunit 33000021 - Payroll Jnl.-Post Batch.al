codeunit 33000021 "Payroll Jnl.-Post Batch"
{
              ...
              IF NOT EmptyLine THEN
                BEGIN
                  ...
                  IF (PayGenJnlBatch."No. Series" <> '') AND  ("Document No." <> LastDocNo) THEN
                    ...
                    END;
                  */
                  IF ("Posting Date" <> LastDate) OR ("Document Type" <> LastDocType) OR ("Document No." <> LastDocNo) THEN
                    BEGIN
                      IF Correction THEN
                  ...
                  BEGIN
                    ...
                    */
                    ...
                    IF NOT PayrollJnlLine3.FIND('+') THEN
                      IF INCSTR("Pay Journal Batch") <> '' THEN
                        BEGIN
                    ...
                    PayrollJnlLine3.SETRANGE("Pay Journal Batch","Pay Journal Batch");
                    IF (PayGenJnlBatch."No. Series" = '') AND NOT PayrollJnlLine3.FIND('+') THEN
                      BEGIN
    ...
    begin
        WITH PayrollJnlLine DO
          BEGIN
            ...
            IF (LastCurrencyCode <> '') AND (CurrencyBalance <> 0) THEN
              BEGIN
                GET("Pay Journal Template","Pay Journal Batch",StartLineNo);
                /*
                IF PayJnlTemplate."Force Doc. Balance" THEN
    ...
    begin
        WITH AllocatePayJournalLine DO
          BEGIN
            IF "Account No." <> '' THEN
              BEGIN
                GenJnlAlloc.RESET;
              ...
              IF NOT EmptyLine THEN
                ...
                ELSE
                  BEGIN
                    ...
                    IF NOT NoSeries.GET(PayGenJnlBatch."No. Series") THEN
                      BEGIN
        ...
        IF PayrollJnlLine4.FIND('-') THEN
          REPEAT
            ...
            IF PayrollJnlLine6.FIND('-') THEN
              REPEAT
                IF (PayrollJnlLine6."Account No." = '') <> (PayrollJnlLine6."Bal. Account No." = '') THEN
                  BEGIN
                    /*
