          ...
          BEGIN
            ...
            REPEAT
              ...
              */
              ...
              THEN
                BEGIN
                  IF CheckCurrBalance AND (TotalAmountLCY <> 0) THEN
                    BEGIN
              ...
              IF "Bal. Account No." = '' THEN
                BEGIN
                  IF TempCurrTotalBuffer.GET("Currency Code") THEN
                    BEGIN
              ...
              */
              IF PayJnlLine."Line No." <> PrevPayJnlLine."Line No." THEN
                BEGIN
                  //DIM1.0 Start
                  //Commented
                  /*
