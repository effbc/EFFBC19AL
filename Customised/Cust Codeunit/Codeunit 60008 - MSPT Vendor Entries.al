codeunit 60008 "MSPT Vendor Entries"
{
    ...
    begin
        ...
        END ELSE IF (DtldVendLedgEntry."Entry Type" = DtldVendLedgEntry."Entry Type" :: "Unrealized Gain") THEN BEGIN
        ...
        IF MSPTVendLedgEntry.FINDSET THEN BEGIN
          REPEAT
            IF (I = 0) THEN BEGIN
              ...
              END ELSE IF ( DtldVendLedgEntry."Entry Type" = DtldVendLedgEntry."Entry Type" :: "Unrealized Loss" ) THEN BEGIN
              ...
              END ELSE IF (DtldVendLedgEntry."Entry Type" <> DtldVendLedgEntry."Entry Type"::"Initial Entry") AND
              ...
              END ELSE IF (DtldVendLedgEntry."Entry Type" = DtldVendLedgEntry."Entry Type"::Application) THEN BEGIN
        ...
        //          DtldMSPTVendLedgEntry."Import Document" := DtldVendLedgEntry."Import Document"; //B2B
                ...
                END ELSE IF (Amount > - (MSPTVendLedgEntry."MSPT Remaining Amount")) THEN BEGIN
                  MSPTVendLedgEntry.CALCFIELDS( MSPTVendLedgEntry."MSPT Remaining Amount");
    ...
    begin
        ...
        //  DtldMSPTVendLedgEntry."Import Document" := DtldVendLedgEntry."Import Document";
          ...
          IF DtldMSPTVendLedgEntry2.FINDFIRST THEN BEGIN
            ...
            END ELSE IF CheckAmount > - MSPTValue THEN BEGIN
              Value := - (MSPTValue);
              CheckAmount := CheckAmount + MSPTValue;
            END;
          END;
    ...
    begin
        ...
        //  DtldMSPTVendLedgEntry."Import Document" := DtldVendLedgEntry."Import Document";
          ...
          IF DtldMSPTVendLedgEntry2.FINDFIRST THEN BEGIN
            ...
            END ELSE IF - (CheckAmount1)  > MSPTValue THEN BEGIN
              Value :=  -(MSPTValue);
              CheckAmount1 := CheckAmount1 + MSPTValue;
            END;
          END;
