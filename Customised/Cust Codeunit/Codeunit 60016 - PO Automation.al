    ...
    begin
        ...
        IF IndentLine.FINDSET THEN
          ...
          //  "Purch Line".SETRANGE("Purch Line"."Location Code",'STR');
            IF NOT("Purch Line".FINDFIRST) THEN
            BEGIN
              CreateIndents.RESET;
    ...
    begin
        ...
        ;
               ...
               QuoteCompare.Quality := CalculateQuality(PurchaseLine."Buy-from Vendor No.",PurchaseLine."No.",PurchaseHeader."RFQ No.");
                ...
                QuoteCompare."P & F" :=PurchaseLine."Amount Added to Inventory";
                ...
                PurchaseLine."Tax Amount"- QuoteCompare.Discount;
                //sankar end
          ...
          REPEAT
            ...
            IndentVendorItems."Part Number" := CreateIndents."Part Number"; // added by Vishnu Priya on 13-11-2020
              ...
              BEGIN
                ...
                IF CreateIndents."Location Code"='STR' THEN
                BEGIN
        ...
        REPEAT
         ...
         // IndentVendorEnquiry.SETRANGE("ICN No.",IndentVendorItems."ICN No.");  //reach ssr
          IF IndentVendorEnquiry.FINDFIRST THEN BEGIN
            ...
            ELSE IF IndentVendorEnquiry."Location Code" ='CS STR' THEN
              PurchaseHeader."Shortcut Dimension 1 Code":='CUS-005'
            ELSE IF IndentVendorEnquiry."Location Code" ='R&D STR' THEN
            ...
            REPEAT
              ...
              ELSE IF IndentVendorEnquiry.Type = IndentVendorEnquiry.Type::Item THEN
                PurchaseLine.Type := PurchaseLine.Type::Item
              ELSE IF IndentVendorEnquiry.Type = IndentVendorEnquiry.Type::"Fixed Asset" THEN
    ...
    begin
        ...
        REPEAT
          ...
          BEGIN
            ...
            REPEAT
              //BOITable.RESET;
              IF (SL."Gen. Prod. Posting Group" IN ['BOI','RAW-MAT']) AND (SL."Outstanding Quantity" > 0) /*AND NOT (SL."No." IN ['ECBOUBT00004','BOICHAR00014'])*/ THEN
              BEGIN
                BOITable.INIT;
              ...
              IF Sch.FINDSET THEN
              REPEAT
                IF (Sch."Document Line No." <> Sch."Line No.") OR ((Sch."No." <> SL."No.") AND (Sch."Document Line No." = Sch."Line No.")) /*AND NOT (Sch."No." IN ['ECBOUBT00004','BOICHAR00014'])*/ THEN
                BEGIN
                  //BOITable.RESET;
                  BOITable.INIT;
                  BOITable."Document Type" := BOITable."Document Type"::Order;
