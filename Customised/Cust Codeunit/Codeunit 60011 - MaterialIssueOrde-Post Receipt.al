codeunit 60011 "MaterialIssueOrde-Post Receipt"
{
    ...
    begin
        ...
        */
        ...
        END;
        RequistionNo := "No.";
        IF NOT (("Transfer-to Code" = 'SITE') AND ("Transfer-from Code" <> 'CS')) THEN BEGIN
            /*
        ...
        IF NOT (USERID IN ['EFFTRONICS\RAMADEVI', 'EFFTRONICS\BHAVANIP', 'EFFTRONICS\SRIVALLI', 'EFFTRONICS\NAGALAKSHMI', 'EFFTRONICS\VISHNUPRIYA']) THEN BEGIN
        ...
        WITH MaterialIssueHeader DO BEGIN
            ...
            IF (FORMAT("BOM Type") IN ['Mechanical', 'Wiring', 'Testing', 'Packing']) THEN BEGIN
                MaterialIssueLine.RESET;
                MaterialIssueLine.SETRANGE("Document No.", "No.");
                MaterialIssueLine.SETFILTER(Quantity, '<>0');
                MaterialIssueLine.SETFILTER("Qty. to Receive", '<>0');
        ...
        END ELSE BEGIN
            IF Itm.GET(MILine."Item No.") AND (Itm.MSL <> 0) AND NOT (Itm."Floor Life at 25 C 40% RH" IN ['', 'INFINITE']) THEN BEGIN
                ...
                IF MSL_ILE.FINDFIRST THEN BEGIN
                    ...
                    IF (DateAndTime.DateDiff('N', MILine."MBB Packet Open DateTime", MILine."MBB Packet Close DateTime", DayofWeekInput, WeekofYearInput)) > 15 THEN BEGIN
