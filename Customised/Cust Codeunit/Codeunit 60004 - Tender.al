codeunit 60004 Tender
{
    ...
    begin
        ...
        IF ErrorMess<>'Please Enter the Following fields :' THEN
        BEGIN
         ERROR( ErrorMess);
         EXIT;
        END;
        ...
        */
        ...
        BEGIN
          ...
          BEGIN
            ...
            END
            ELSE "to mail"+='anvesh@efftronics.com,mk@effe.in,erp@efftronics.com';
            ...
            */
            ...
            IF TenderHead2.GET("Tender No.") THEN
            BEGIN
