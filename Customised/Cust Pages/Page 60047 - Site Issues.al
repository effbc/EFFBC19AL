            ...
            group("&Line")
            {
                ...
                group("Item Availability by")
                {
                    ...
                    action(Period)
                    {
                        ...
                        trigger OnAction();
                        begin
                            CurrPage.MaterialIssueLine.PAGE.ItemAvailability(0);
                        end;
                    }
                    action(Variant)
                    {
                        ...
                        trigger OnAction();
                        begin
                            CurrPage.MaterialIssueLine.PAGE.ItemAvailability(1);
                        end;
                    }
                    action(Location)
                    {
                        ...
                        trigger OnAction();
                        begin
                            CurrPage.MaterialIssueLine.PAGE.ItemAvailability(2);
                        end;
                    }
                }
                ...
                action(Dimensions)
                {
                    ...
                    trigger OnAction();
                    begin
                        CurrPage.MaterialIssueLine.PAGE.ShowDimensions;
                    end;
                }
                    ...
                    begin
                        ...
                        BEGIN
                          IF     ("Reason Code"<>'DEPT MNT') AND ("Reason Code"<>'DISPATCH')
                             ...
                             AND ("Reason Code"<>'SITE') AND ("Reason Code"<>'R&D')  AND ("Reason Code"<>'TOOLS') THEN
            ...
            group("P&osting")
            {
                ...
                action("P&ost")
                {
                    ...
                    begin
                        ...
                        END;
                         ...
                         Subject:='';
                           ...
                           // Mail_To:='krishnad@efftronics.com,santhoshk@efftronics.com';
                            ...
                            ELSE IF (MaterialIssuesHeader."Transfer-to Code"='STR') OR (MaterialIssuesHeader."Transfer-to Code"='R&D STR') OR
                        ...
                        OR (Mat_Issue_sLine."Item No."='METOLGN00034') OR (Mat_Issue_sLine."Item No."='METOLGN00086')) THEN
                        BEGIN
