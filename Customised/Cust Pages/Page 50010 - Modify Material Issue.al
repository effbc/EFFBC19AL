        ...
        area(processing)
        {
            group(Action1102152005)
            {
                ...
                action("Change SITE LOCATION")
                {
                    ...
                    trigger OnAction();
                    begin
                        IF ("Current Id" <> '') AND  ("Modified Id" = '') AND ("To Division" <> '') AND (USERID IN ['EFFTRONICS\VISHNUPRIYA','EFFTRONICS\TULASI','EFFTRONICS\NAGALAKSHMI']) THEN
                        BEGIN
                          t1 := "To Division";
