    ...
    actions
    {
        ...
        area(processing)
        {
                ...
                action("Request for Authorization")
                {
                    ...
                    begin
                        ...
                        */
                        ...
                        END;
                        IF ("Transfer-to Code"='R&D STR') AND ("Transfer-to Code"='DAMAGE') THEN
                        BEGIN
                        IF "Reason Code"='' THEN
                        ...
                        REPORT.SAVEASHTML(50182,'\\erpserver\ErpAttachments\ErpAttachments1\'+"No."+'.htm',FALSE,MR);
            ...
            action("Mail Alerts")
            {
                ...
                begin
                     puserid := '';
                     IF CONFIRM('Do you want to send the mail alert?') THEN
                     BEGIN
                      ...
                      IF  "Mail alert".OPEN THEN
                        BEGIN


                        WHILE "Mail alert".READ DO
                        BEGIN
