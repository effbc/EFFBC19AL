            ...
            action("<CS Stock Indents>")
            {
                ...
                begin
                    ...
                    REPEAT
                      ...
                      IF Items."Stock at CS Stores" < Items."Safety Stock Qty (CS)" THEN
                      BEGIN
                        PurchaseQuantity := 0;
                        PL.RESET;
                        ...
                        UNTIL PL.NEXT = 0;
                        IF (Items."Stock at CS Stores" + PurchaseQuantity ) < Items."Safety Stock Qty (CS)" THEN
                        BEGIN
                            IndentQuantity := 0;
                            IL1.RESET;
                            ...
                            UNTIL IL1.NEXT = 0;
                            IF   (Items."Stock at CS Stores" + PurchaseQuantity + IndentQuantity ) < Items."Safety Stock Qty (CS)" -1  THEN
                            BEGIN
