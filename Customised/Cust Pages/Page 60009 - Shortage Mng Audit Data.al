page 60009 "Shortage Mng Audit Data"
{
    ...
    begin
          ...
          BEGIN
            ...
            END ELSE IF Color='YELLOW' THEN
            BEGIN
              "Sale OrderEmphasize" :=TRUE;
            END ELSE IF Color='GREY' THEN
            BEGIN
              "Sale OrderEmphasize" :=TRUE;
          ...
          BEGIN
            IF  "90 Days_S"<>'' THEN
            BEGIN
              IF (Start_Date-"G\L"."Shortage. Calc. Date")<=90 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")<97 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")=97 THEN
              BEGIN
            ...
            END ELSE IF "60 Days_S" <>'' THEN
            BEGIN
              IF (Start_Date-"G\L"."Shortage. Calc. Date")<=60 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")<67 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")=67 THEN
              BEGIN
            ...
            END ELSE IF "45 Days_S" <>'' THEN
            BEGIN
              IF (Start_Date-"G\L"."Shortage. Calc. Date")<=45 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")<52 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")=52 THEN
              BEGIN
            ...
            END ELSE IF "30 Dyas_S" <>'' THEN
            BEGIN
              IF (Start_Date-"G\L"."Shortage. Calc. Date")<=30 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")<37 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")=37 THEN
              BEGIN
            ...
            END ELSE IF "25 Dyas_S" <>'' THEN
            BEGIN
              IF (Start_Date-"G\L"."Shortage. Calc. Date")<=25 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")<32 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")=32 THEN
              BEGIN
            ...
            END ELSE IF "21 Days_S" <>'' THEN
            BEGIN
              IF (Start_Date-"G\L"."Shortage. Calc. Date")<=21 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")<28 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")=28 THEN
              BEGIN
            ...
            END ELSE IF "15 Dyas_S" <>'' THEN
            BEGIN
              IF (Start_Date-"G\L"."Shortage. Calc. Date")<=15 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")<22 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")=22 THEN
              BEGIN
            ...
            END ELSE IF "7 Days_S" <>'' THEN
            BEGIN
              IF (Start_Date-"G\L"."Shortage. Calc. Date")<=7 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")<14 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")=14 THEN
              BEGIN
            ...
            END ELSE IF "4 Days_S" <>'' THEN
            BEGIN
              IF (Start_Date-"G\L"."Shortage. Calc. Date")<=4 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")<11 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")=11 THEN
              BEGIN
            ...
            END ELSE IF "2 Days_S" <>'' THEN
            BEGIN
              IF (Start_Date-"G\L"."Shortage. Calc. Date")<=2 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")<9 THEN
              BEGIN
                "Sale OrderEmphasize" :=TRUE;
              END ELSE IF (Start_Date-"G\L"."Shortage. Calc. Date")=9 THEN
              BEGIN
