page 50012 "Shortage Cumulative1"
{
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Group)
            {
                ...
                field("Total Shortage Inc Purch Qty";"Total Shortage Inc Purch Qty")
                {
                    Caption = 'Total Shortage Inc Stock Considerations';
                    Editable = false;
                    StyleExpr = Color_Critical_Items;
                }
                field("Alt Item Qty. in Purch Orders";"Alt Item Qty. in Purch Orders")
                {
                    Editable = false;
                    ...
                    begin
                        ...
                        ProdOrdShortage.SETRANGE(ProdOrdShortage."Shortage At","Shortage At");
                        ...
                        REPEAT
                          ...
                          IF ProdOrdr.FINDFIRST THEN
                          BEGIN
                            IF ProdOrdr."Item Sub Group Code" <> '' THEN
                            BEGIN
                            ...
                            END ELSE BEGIN
                              IF ITEM1.GET(ProdOrdr."Source No.") THEN
                              BEGIN
                                IF ITEM1."Item Sub Group Code" <> '' THEN
                                BEGIN
                        ...
                        Alt_Items.SETRANGE(Alt_Items."Item No.",Item);
                ...
                field("Alt Item PO No";"Alt Item PO No")
                {
                }
                field("Alt Item Vendor No";"Alt Item Vendor No")
                {
                }
                    ...
                    begin
                        ...
                        REPEAT
                          ...
                          BEGIN
                            ...
                            REPEAT
                              IF (MaterialIssueLine."Item No." = Item ) THEN
                              BEGIN
                ...
                field(CreateReq_CS;CreateReq_CS)
                {
                    ...
                    begin
                        ...
                        IF MaterialIssueHeader.FINDSET THEN
                        REPEAT
                          IF (MaterialIssueHeader."Transfer-from Code" = 'CS STR') THEN
                          BEGIN
                            MaterialIssueLine.RESET;
                            MaterialIssueLine.SETRANGE(MaterialIssueLine."Document No.",MaterialIssueHeader."No.");
                            IF MaterialIssueLine.FINDSET THEN
                            REPEAT
                              ...
                              BEGIN
                                ...
                                ERROR('Material Request already created for this Item '+MaterialIssueHeader."No.");
                              END
                            UNTIL MaterialIssueLine.NEXT =0;  END;
                        UNTIL MaterialIssueHeader.NEXT=0;
                    end;
                }
                ...
                field(CreateReq_RD;CreateReq_RD)
                {
                    ...
                    begin
                        ...
                        IF MaterialIssueHeader.FINDSET THEN
                        REPEAT
                          IF (MaterialIssueHeader."Transfer-from Code" = 'R&D STR') THEN
                          BEGIN
                            MaterialIssueLine.RESET;
                            MaterialIssueLine.SETRANGE(MaterialIssueLine."Document No.",MaterialIssueHeader."No.");
                            IF MaterialIssueLine.FINDSET THEN
                ...
                field(CreateReq_MCH;CreateReq_MCH)
                {
                    ...
                    begin
                        ...
                        IF MaterialIssueHeader.FINDSET THEN
                        REPEAT
                          IF (MaterialIssueHeader."Transfer-from Code" = 'MCH') THEN
                          BEGIN
                            MaterialIssueLine.RESET;
                            MaterialIssueLine.SETRANGE(MaterialIssueLine."Document No.",MaterialIssueHeader."No.");
                            IF MaterialIssueLine.FINDSET THEN
                ...
                field("Earliest Material Arrival Qty";"Earliest Material Arrival Qty")
                {
                    Editable = false;
                }
                field("Earliest Material Shortage Dat";"Earliest Material Shortage Dat")
                {
                    Editable = false;
                }
                field("Earliest Material Shortage Qty";"Earliest Material Shortage Qty")
                {
                    Editable = false;
                }
                ...
                field(Field1;MATRIX_CellData[1])
                {
                    ...
                    trigger OnLookup(Text : Text) : Boolean;
                    begin
                        PO_SHORTAGEITEMS.SETRANGE(PO_SHORTAGEITEMS.Item,Item);
            ...
            action("Create Material Request")
            {
                ...
                begin
                    ...
                    BEGIN
                      ...
                      MaterialIssueHeader."Transfer-to Code":="Shortage At";
                      ...
                      REPEAT
                        GetStock(Item);
                        IF (CreateReq_STR) OR NOT(Req_created) THEN
                        BEGIN
                          LineNo := LineNo + 10000;
                          IF ITEM1.GET(Item) THEN
                          BEGIN
                            ...
                            IF "Total Shortage" <= "Stock at Stores" THEN
                              MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,"Total Shortage")
                            ELSE
                    ...
                    RESET;
                    //ProdOrdShortage.SETFILTER(ProdOrdShortage."Production Order","Production Order");
                    SETRANGE("Shortage At",'MCH');

                    SETRANGE(CreateReq_CS,TRUE);
                    IF FINDFIRST THEN
                    BEGIN
                      MaterialIssueHeader.RESET;
                      MaterialIssueHeader.INIT;
                      ...
                      REPEAT
                        ...
                        BEGIN
                          ...
                          BEGIN
                            ...
                            IF CreateReq_STR THEN
                            BEGIN
                              IF ("Total Shortage"-"Stock at Stores") <= "Stock at CS Stores" THEN
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,("Total Shortage"-"Stock at Stores"))
                              ELSE
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,"Stock at CS Stores");
                            END ELSE
                            BEGIN
                              IF "Total Shortage" <= "Stock at CS Stores" THEN
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,"Total Shortage")
                              ELSE
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,"Stock at CS Stores");
                            END;
                      ...
                      REPEAT
                        ...
                        BEGIN
                          ...
                          BEGIN
                            ...
                            IF CreateReq_STR AND CreateReq_CS THEN
                            BEGIN
                              IF ("Total Shortage"-("Stock at Stores"+"Stock at CS Stores")) <= "Stock at RD Stores" THEN
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,("Total Shortage"-("Stock at Stores"+"Stock at CS Stores")))
                              ELSE
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,"Stock at RD Stores");
                            END ELSE IF CreateReq_STR THEN
                            BEGIN
                              IF ("Total Shortage"-"Stock at Stores") <= "Stock at RD Stores" THEN
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,("Total Shortage"-"Stock at Stores"))
                              ELSE
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,"Stock at RD Stores");
                            END ELSE IF CreateReq_CS THEN
                            BEGIN
                              IF ("Total Shortage"-"Stock at CS Stores") <= "Stock at RD Stores" THEN
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,("Total Shortage"-"Stock at CS Stores"))
                              ELSE
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,"Stock at RD Stores");
                            END ELSE
                            BEGIN
                              IF "Total Shortage" <= "Stock at RD Stores" THEN
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,"Total Shortage")
                              ELSE
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,"Stock at RD Stores");
                            END;
                      ...
                      REPEAT
                        ...
                        BEGIN
                          ...
                          BEGIN
                            ...
                            IF CreateReq_MCH AND CreateReq_CS THEN
                            BEGIN
                              IF ("Total Shortage"-("Stock at Stores"+"Stock at CS Stores")) <= "Stock at RD Stores" THEN
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,("Total Shortage"-("Stock at Stores"+"Stock at CS Stores")))
                              ELSE
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,"Stock at RD Stores");
                            END ELSE IF CreateReq_MCH THEN
                            BEGIN
                              IF ("Total Shortage"-"Stock at MCH") <= "Stock at RD Stores" THEN
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,("Total Shortage"-"Stock at Stores"))
                              ELSE
                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,"Stock at RD Stores");
                            END ELSE IF CreateReq_CS THEN
                      ...
                      REPEAT
                        ...
                        BEGIN
                          ...
                          BEGIN
                            ...
                            IF "Total Shortage" <= "Stock at MCH" THEN
                              MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity,"Total Shortage")
                            ELSE
    ...
    begin
        ...
        "Earliest Material Shortage Dat" := 0D;
        "Earliest Material Shortage Qty" := 0;

        ProdOrdShortageRec.RESET;
        ProdOrdShortageRec.SETCURRENTKEY(Item,"Prod. Start Date");
        ProdOrdShortageRec.SETFILTER(ProdOrdShortageRec.Item,Item);
        ProdOrdShortageRec.SETRANGE(ProdOrdShortageRec."Shortage At","Shortage At");
        ...
        REPEAT
          ...
          BEGIN
            ...
            IF ProdOrdShortageRec."Prod. Start Date" = tempdate THEN
            BEGIN
              IF Tot_Stock_Inc_Others > 0 THEN
              BEGIN
                IF ProdOrdShortageRec.Shortage > Tot_Stock_Inc_Others THEN
                BEGIN
        ...
        BEGIN
          ...
          BEGIN
            "Earliest Material Shortage Dat" := tempdate;
            "Earliest Material Shortage Qty" := MATRIX_CellData[i];
            i := 60;
          END;
        END;
        MODIFY;
        Color_Shotg_Inc_Purch := '';
        IF "Total Shortage Inc Purch Qty" > 0 THEN
          Color_Shotg_Inc_Purch := 'Ambiguous';
        Color_Critical_Items := '';

        IF ("Earliest Material Shortage Qty" > 0) THEN
        BEGIN
          IF ("Earliest Material Arrival Date" = 0D) THEN
            Color_Critical_Items := 'Unfavorable'
          ELSE BEGIN
            IF ("Earliest Material Arrival Date"  < "Earliest Material Shortage Dat") THEN
            BEGIN
              IF ("Earliest Material Shortage Qty" > "Earliest Material Arrival Qty") THEN
                Color_Critical_Items := 'Unfavorable';
            END ELSE
              Color_Critical_Items := 'Unfavorable';
          END;
    ...
    begin
        ...
        REPEAT
          RESET;
          SETRANGE(Item,ProdOrdShortage1.Item);
          SETRANGE("Shortage At",ProdOrdShortage1."Shortage At");
          IF NOT FINDFIRST THEN
          BEGIN
            INIT;
            Item := ProdOrdShortage1.Item;
            Description := ProdOrdShortage1.Description;
            "Shortage At":= ProdOrdShortage1."Shortage At";
            Remarks :=ProdOrdShortage1.Remarks;
            /*
            ...
            UNTIL QILE.NEXT=0;
            */
            "Alt Item Qty. in Purch Orders":=0;
            ProdGrpsList:='ALL PRODUCTS|';
            Prev_ProdGrp:='';
            ProdOrdShortage.RESET;
            ...
            REPEAT
              ...
              BEGIN
                ...
                IF "Purchase Line".FIND('-') THEN
                REPEAT
                  "Alt Item Qty. in Purch Orders" +="Purchase Line"."Qty. to Receive";
                    "Alt Item Qty. in Purch Orders" +="Purchase Line"."Qty. to Receive";
                  "Alt Item PO No" := "Purchase Line"."Document No.";
                  BEGIN
                    vendor.RESET;
                    IF vendor.GET("Purchase Line"."Buy-from Vendor No.") THEN
                   "Alt Item Vendor No" := vendor.Name
            ...
            ProdOrdShortage.SETRANGE(ProdOrdShortage."Shortage At",ProdOrdShortage1."Shortage At");
            IF ProdOrdShortage.FINDFIRST THEN
              "Earliest Material Shortage Dat" := ProdOrdShortage."Prod. Start Date";
        
            ProdOrdShortage.RESET;
            ProdOrdShortage.SETCURRENTKEY(Item,"Shortage At","Prod. Start Date");
            ProdOrdShortage.SETRANGE(ProdOrdShortage.Item,ProdOrdShortage1.Item);
            ProdOrdShortage.SETRANGE(ProdOrdShortage."Shortage At",ProdOrdShortage1."Shortage At");
            ProdOrdShortage.SETRANGE(ProdOrdShortage."Prod. Start Date","Earliest Material Shortage Dat");
            IF ProdOrdShortage.FINDSET THEN
            REPEAT
              "Earliest Material Shortage Qty"+=ProdOrdShortage.Shortage;
            UNTIL ProdOrdShortage.NEXT=0;
            ...
            "Total Shortage Inc Purch Qty" :="Total Shortage";
            ProdOrdShortage1.CALCFIELDS(ProdOrdShortage1."Qty. in Purchase Orders",ProdOrdShortage1."Qty. Under Inspection");
            "Qty. in Purchase Orders":=ProdOrdShortage1."Qty. in Purchase Orders";
            "Qty. Under Inspection":=ProdOrdShortage1."Qty. Under Inspection";
            ...
            BEGIN
              IF "Total Shortage" > "Stock at Stores" THEN
                INSERT;
            END ELSE IF "Shortage At" = 'STR' THEN
            BEGIN
              IF "Total Shortage" > "Stock at MCH" THEN
                INSERT;
            END;
    ...
    begin
        ...
        BEGIN
          ...
          ITEM1.CALCFIELDS(ITEM1."Quantity Under Inspection",ITEM1."Quantity Rejected",ITEM1."Quantity Rework",ITEM1."Quantity Sent for Rework",ITEM1."Stock At MCH Location",ITEM1."Stock at CS Stores",
           ...
           IF (ITEM1."Quantity Under Inspection"=0)AND (ITEM1."Quantity Rejected"=0) AND (ITEM1."Quantity Rework"=0) AND (ITEM1."Quantity Sent for Rework"=0) THEN
            BEGIN
              ItemLedgEntry.RESET;
    ...
    begin
        ...
        IF MaterialIssueHeader.FINDSET THEN
        REPEAT
          IF (MaterialIssueHeader."Transfer-from Code" = 'STR') THEN
          BEGIN
            MaterialIssueLine.RESET;
            MaterialIssueLine.SETRANGE(MaterialIssueLine."Document No.",MaterialIssueHeader."No.");
            IF MaterialIssueLine.FINDSET THEN
    ...
    begin
        ...
        REPEAT
          ...
          IF Include_Purch_Qty = TRUE THEN
            tempStock+="Qty. in Purchase Orders";
          IF Include_QC_Stock = TRUE THEN
            tempStock+="Qty. Under Inspection";
          ...
          */
          ...
          "Total Shortage Inc Purch Qty" := "Total Shortage"-tempStock;
          MODIFY;
        UNTIL NEXT=0;
        Calc_Shortage_items_Count;
        CurrPage.UPDATE(FALSE);
    ...
    begin
        ...
        RESET;
        SETFILTER("Total Shortage Inc Purch Qty",'>%1',0);
        IF FINDSET THEN
          Tot_Shortg_Items_Cnt := COUNT;
        RESET;
        CurrPage.UPDATE(FALSE);
        // End by Pranavi
    end;
        ...
        BEGIN
          ...
          */
          ...
          REPEAT
            ...
            IF ShortageItem = TRUE THEN
            BEGIN
              Entercell(Row,2,FORMAT(Item),FALSE,TempExcelbuffer."Cell Type"::Text,5);
              Entercell(Row,3,FORMAT(Description),FALSE,TempExcelbuffer."Cell Type"::Text,5);
              Entercell(Row,4,FORMAT("Shortage At"),FALSE,TempExcelbuffer."Cell Type"::Text,5);
              Entercell(Row,5,FORMAT("Lead Time"),FALSE,TempExcelbuffer."Cell Type"::Text,5);
              Entercell(Row,6,FORMAT("Total Shortage"),FALSE,TempExcelbuffer."Cell Type"::Number,5);
            END ELSE BEGIN
              Entercell(Row,2,FORMAT(Item),FALSE,TempExcelbuffer."Cell Type"::Text,0);
              Entercell(Row,3,FORMAT(Description),FALSE,TempExcelbuffer."Cell Type"::Text,0);
              Entercell(Row,4,FORMAT("Shortage At"),FALSE,TempExcelbuffer."Cell Type"::Text,0);
              Entercell(Row,5,FORMAT("Lead Time"),FALSE,TempExcelbuffer."Cell Type"::Text,0);
              Entercell(Row,6,FORMAT("Total Shortage"),FALSE,TempExcelbuffer."Cell Type"::Number,0);
            END;
        
        
            IF CriticalItem = TRUE THEN
            BEGIN
              Entercell(Row,7,FORMAT("Qty. in Purchase Orders"),FALSE,TempExcelbuffer."Cell Type"::Number,4);
              Entercell(Row,8,FORMAT("Total Shortage Inc Purch Qty"),FALSE,TempExcelbuffer."Cell Type"::Number,4);
            END ELSE BEGIN
              Entercell(Row,7,FORMAT("Qty. in Purchase Orders"),FALSE,TempExcelbuffer."Cell Type"::Number,0);
              Entercell(Row,8,FORMAT("Total Shortage Inc Purch Qty"),FALSE,TempExcelbuffer."Cell Type"::Number,0);
            END;
            ...
            Entercell(Row,10,FORMAT("Alt Item Qty. in Purch Orders"),FALSE,TempExcelbuffer."Cell Type"::Number,0);
            Entercell(Row,11,FORMAT("Qty. Under Inspection"),FALSE,TempExcelbuffer."Cell Type"::Number,0);
            ...
            Entercell(Row,15,FORMAT("Earliest Material Arrival Date"),FALSE,TempExcelbuffer."Cell Type"::Date,0);
            Entercell(Row,16,FORMAT("Earliest Material Arrival Qty"),FALSE,TempExcelbuffer."Cell Type"::Number,0);
            Entercell(Row,17,FORMAT("Earliest Material Shortage Dat"),FALSE,TempExcelbuffer."Cell Type"::Date,0);
            Entercell(Row,18,FORMAT("Earliest Material Shortage Qty"),FALSE,TempExcelbuffer."Cell Type"::Number,0);
            Entercell(Row,19,FORMAT(Remarks),FALSE,TempExcelbuffer."Cell Type"::Text,0);
            Entercell(Row,20,"Alt Item PO No",FALSE,TempExcelbuffer."Cell Type"::Text,0);
            Entercell(Row,21,"Alt Item Vendor No",FALSE,TempExcelbuffer."Cell Type"::Text,0);
