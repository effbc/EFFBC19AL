page 50012 "Shortage Cumulative1"
{
                            ...
                            REPEAT
                                ...
                                IF NOT (Req_created) THEN BEGIN
                                    ...
                                    IF ITEM1.GET(Item) THEN BEGIN
                                        ...
                                        IF CreateReq_MCH AND CreateReq_CS THEN BEGIN
                                            IF ("Total Shortage" - ("Stock at Stores" + "Stock at CS Stores")) <= "Stock at RD Stores" THEN
                                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity, ("Total Shortage" - ("Stock at Stores" + "Stock at CS Stores")))
                                            ELSE
                                                MaterialIssueLine.VALIDATE(MaterialIssueLine.Quantity, "Stock at RD Stores");
    ...
    begin
        ...
        IF ("Earliest Material Shortage Qty" > 0) THEN BEGIN
            IF ("Earliest Material Arrival Date" = 0D) THEN
                Color_Critical_Items := 'Unfavorable'
            ELSE BEGIN
                IF ("Earliest Material Arrival Date" < "Earliest Material Shortage Dat") THEN BEGIN
            ...
            REPEAT
                ...
                IF NOT FINDFIRST THEN BEGIN
                    ...
                    */
                    ...
                    IF "Shortage At" = 'MCH' THEN BEGIN
                        IF "Total Shortage" > "Stock at Stores" THEN
                            INSERT;
                    END ELSE
                        IF "Shortage At" = 'STR' THEN BEGIN
                            IF "Total Shortage" > "Stock at MCH" THEN
                                INSERT;
                        END;
                END;
            ...
            */
            ...
            IF FINDSET THEN
                REPEAT
                    ...
                    ShortageItem := FALSE;
                    ItemType := ItemType::" ";
                    IF "Total Shortage Inc Purch Qty" > 0 THEN BEGIN
                        ShortageItem := TRUE;
                        ItemType := ItemType::Shortage;
                    END;

                    IF ("Earliest Material Shortage Qty" > 0) THEN BEGIN
                        IF ("Earliest Material Arrival Date" = 0D) THEN BEGIN
                            CriticalItem := TRUE;
                            ItemType := ItemType::Critical;
                        END
                        ELSE BEGIN
                            IF ("Earliest Material Arrival Date" < "Earliest Material Shortage Dat") THEN BEGIN
                                IF ("Earliest Material Shortage Qty" > "Earliest Material Arrival Qty") THEN BEGIN
                                    CriticalItem := TRUE;
                                    ItemType := ItemType::Critical;
                                END;
                            END ELSE BEGIN
