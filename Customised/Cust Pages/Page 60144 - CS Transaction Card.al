        ...
        area(content)
        {
            group(General)
            {
                    ...
                    begin
                        ...
                        BEGIN
                          IF "Transaction Status"<>"Transaction Status"::"In-Transit" THEN
                            custEnable := TRUE
                          ELSE custEnable := FALSE;
                        END ELSE custEnable := FALSE;
                    end;
                }
                ...
                field("Mode of Transport";"Mode of Transport")
                {
                    ...
                    trigger OnValidate();
                    begin
                        IF "Mode of Transport"="Mode of Transport"::"By Hand" THEN
                        BEGIN
                              "Courier Details":='';
                        END;
                    end;
                    ...
                    begin
                          ...
                          REPEAT
                            ...
                            BEGIN
                              ...
                              IF NOT( UPPERCASE(USERID) IN ['EFFTRONICS\SUJANI','EFFTRONICS\GRAVI','EFFTRONICS\VISHNUPRIYA'] )THEN
                              BEGIN
                ...
                action(Received)
                {
                    ...
                    begin
                          ...
                          REPEAT
                            ...
                            IF CsTransactionLine.Quantity<CsTransactionLine."Qty to be Receive"+QtyRcvd THEN
                            BEGIN
                            ...
                            IF CsTransactionLine.Quantity-QtyRcvd-CsTransactionLine."Qty to be Receive" >0 THEN
                            BEGIN
                              entryNo:=entryNo+1;
                              CsStockLedger.INIT;
                              CsStockLedger."Entry No.":=entryNo;
                          ...
                          IF ("Transfer To Location"='SERVICE') THEN
                          BEGIN
                            MIHGRec.RESET;
                            MIHGRec.INIT;
                           ...
                           // MIHGRec.VALIDATE("Shortcut Dimension 2 Code");
                            ...
                            REPEAT
                              ...
                              IF Item.GET(MILGRec."Item No.") THEN
                              BEGIN
                                IF MIH1.GET(MIHNo) THEN
                                BEGIN
    ...
    begin
        ...
        IF Users.FINDFIRST THEN
          ...
          REPEAT
            ...
            IF NOT CsStockLineLRec.FINDFIRST THEN
            BEGIN
