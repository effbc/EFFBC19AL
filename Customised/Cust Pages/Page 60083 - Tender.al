                    ...
                    begin
                        ...
                        Mail_Body:='';
                          ...
                          IF "Mail-Id".FINDFIRST THEN
                           ...
                           "to mail"+='renukach@efftronics.net,baji@efftronics.com,prasannat@efftronics.com,anuradhag@efftronics.com,';
                           "to mail"+='anulatha@efftronics.com,milind@efftronics.com,srasc@efftronics.com,mohang@efftronics.com,';
                            "to mail"+='sganesh@efftronics.com,rajani@efftronics.com,dsr@efftronics.com,sunil@efftronics.com';
                        MODIFY;
                        END;
                ...
                action("Make to &Order")
                {
                    ...
                    begin
                        ...
                        BEGIN
                          ...
                          ELSE IF ("EMD Mode of Payment" = "EMD Mode of Payment"::DD) AND ("EMD DD No." = '') THEN
                          ...
                          BEGIN
                            ...
                            BEGIN
                             ...
                             // MESSAGE(SQLQuery);
                              ...
                              END;
                            END
                            ELSE ERROR('EMD Details not present in CashFLow.\Please Release the Tender to create EMD details in CashFLow!');
                          END
                          ELSE ERROR('Tender: '+"Tender No."+' not created in CashFlow.\Please release the Tender to create tender in Cashflow!');
                          SQLConnection.CommitTrans;
                          RecordSet.Close;
                          SQLConnection.Close;
                          ConnectionOpen:=0;
    ...
    begin
        ...
        IF TenderLine.FINDSET THEN
          REPEAT
            ...
            ELSE SalesLine."Document Type" := SalesLine."Document Type"::Order;
            SalesLine."Document No." := SalesHeader."No.";
          ...
          BEGIN
            ...
            BEGIN
              ...
              BEGIN
                ...
                RecordSet.MoveNext;
              END;
            END ELSE PaymentId := 'temp';
          END
          ELSE ERROR('EMD is not created in Cashflow.\Please release the tender again to create EMD in Cashflow!');
        END
        ELSE ERROR('Tender is not created in ERP.\Please release the tender again to create Tender in Cashflow!');
