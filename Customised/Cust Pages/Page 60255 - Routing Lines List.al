    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Sequence No. (Forward)"; "Sequence No. (Forward)")
                {
                }
                field("Sequence No. (Backward)"; "Sequence No. (Backward)")
                {
                }
                field("Fixed Scrap Qty. (Accum.)"; "Fixed Scrap Qty. (Accum.)")
                {
                }
                field("Scrap Factor % (Accumulated)"; "Scrap Factor % (Accumulated)")
                {
                }
