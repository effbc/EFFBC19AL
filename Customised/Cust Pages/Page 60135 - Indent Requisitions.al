page 60135 "Indent Requisitions"
{
                        ...
                        WITH CreateIndentsRec DO BEGIN
                          ...
                          REPEAT
                           ...
                           // IRH.SETRANGE(IRH."Vendor No.","Suitable Vendor"); // Added by Vishnu Priya on 30-06-2020 for avoiding the Orders placing of flaged items to concenred vendor.
                            IF NOT IRH.FINDFIRST THEN
                            BEGIN
                              IF "Previous Vendor"<>"Suitable Vendor" THEN
                              BEGIN
                           ...
                           // IRH.SETRANGE(IRH."Vendor No.","Suitable Vendor"); // Added by Vishnu Priya on 30-06-2020 for avoiding the Orders placing of flaged items to concenred vendor.
                            ...
                            BEGIN
                              ...
                              BEGIN
                                ...
                                BEGIN
                                    IF STRLEN(FORMAT(Itm."Safety Lead Time")) >0 THEN
                                        BEGIN
                                ...
                                ELSE IF "Location Code" ='CS STR' THEN
                                  PurchaseHeader."Shortcut Dimension 1 Code":='CUS-005'
                                ELSE IF "Location Code" ='R&D STR' THEN
                                ...
                                ELSE IF Rec.Type = Rec.Type::Item THEN
                                    PurchaseLine.Type := PurchaseLine.Type::Item
                                ELSE IF Rec.Type = Rec.Type::"Fixed Asset" THEN
                                ...
                                IF COPYSTR("ICN No.",STRLEN("ICN No.")-2,STRLEN("ICN No."))='NC' THEN
                                BEGIN
                                  ...
                                  IF SHORTAGE_DET.FINDFIRST THEN
                                  BEGIN
                                ...
                                IF PurchaseLine."Deviated Receipt Date" <> 0D THEN
                                BEGIN
                            ...
                            BEGIN
                                ...
                                IF Rec.Type = Rec.Type::Item THEN
                                  PurchaseLine.Type := PurchaseLine.Type::Item
                                ELSE IF Rec.Type = Rec.Type::"G/L Account" THEN
                                  PurchaseLine.Type := PurchaseLine.Type::"G/L Account"
                                ELSE IF Rec.Type = Rec.Type::"Fixed Asset" THEN
                                  PurchaseLine.Type := PurchaseLine.Type::"Fixed Asset";
                                // added by vishnu priya on 09-11-2020
    ...
    begin
        ...
        IndentHeader.RESET;
          IF IndentHeader.Description = 'Created From QC Inward Item Rejection' THEN
          BEGIN
              "No.Format" := 'StrongAccent';
          END
          ELSE IF IndentHeader.Description = 'Created for CS Minimum Stock' THEN
          BEGIN
             "No.Format" := 'Favorable';
          END
          ELSE "No.Format" := 'None';
