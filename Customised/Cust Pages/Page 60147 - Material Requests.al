page 60147 "Material Requests"
{
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action("A&uthorize")
                {
                    ...
                    begin
                        ...
                        IF NOT((USERID='EFFTRONICS\CHOWDARY')) THEN
                        BEGIN
                        ...
                        IF ("Transfer-from Code"='CST') AND ("Transfer-to Code"='CS STR') THEN
                        BEGIN
                        ...
                        IF ("Transfer-from Code"='CS STR') AND ("Transfer-to Code"='SITE') THEN
                        BEGIN
                        ...
                        IF ("Transfer-from Code"='CS STR') AND ("Transfer-to Code"='CST') THEN
                        BEGIN
                          IF     ("Reason Code"<>'DEPT MNT') AND ("Reason Code"<>'DISPATCH')
                             ...
                             AND ("Reason Code"<>'SITE') AND ("Reason Code"<>'R&D')  AND ("Reason Code"<>'TOOLS') AND
                               ("Reason Code"<>'TES ZIG') AND ("Reason Code"<>'SERVICING') THEN
                          BEGIN
                            IF "Prod. Order No."=' ' THEN
                               ERROR('Please Select the production Order No.');
                            IF "Service Order No." ='' THEN
                            BEGIN
                              IF ("Prod. BOM No."='') OR  ("Shortcut Dimension 2 Code"='') THEN
                              BEGIN
                                 ERROR('Please Enter the Service Order No. ');
                                 EXIT;
                              END;
                            END ELSE IF "Service Item" ='' THEN
                            BEGIN
                                ERROR('Please Enter the Service Item ');
                                EXIT;
                            END;
                          END ELSE IF ("Reason Code"='STOCK PCB') THEN
                          BEGIN
                        ...
                        IF (("Transfer-from Code"='CS') AND ("Transfer-to Code"='SITE')) OR
                           (("Transfer-to Code"='CS') AND ("Transfer-from Code"='SITE')) THEN
                        BEGIN
                          ...
                          REPEAT
                            ...
                            IF "Transfer-from Code"='SITE' THEN
                            BEGIN
                            ...
                            REPEAT
                              ...
                              BEGIN
                                ...
                                BEGIN
                                  IF itemledgerentry."Location Code"='CS' THEN
                                  BEGIN
                                    ...
                                    IF "Posted Material Issues Lines".FINDFIRST THEN
                                    BEGIN
                                      "Posted Material Issues Header".GET("Posted Material Issues Lines"."Document No.");
                                      IF "Posted Material Issues Header"."Shortcut Dimension 2 Code"="Shortcut Dimension 2 Code" THEN
                                      BEGIN
                        ...
                        IF (("Transfer-from Code"='SITE') AND ("Transfer-to Code"='PRODUCT')) THEN
                        BEGIN
                          IF "Shortcut Dimension 2 Code"='' THEN
                             ERROR('PLEASE ENTER THE DIMENSION')
                        ...
                        IF (("Transfer-to Code"='SITE') AND ("Transfer-from Code"='PRODCUT')) THEN
                        BEGIN
                          IF "Shortcut Dimension 2 Code"='' THEN
                             ERROR('PLEASE ENTER THE DIMENSION');
                        //  ELSE IF "Shortcut Dimension 2 Code"<>'PRODUCT' THEN
                                ...
                                BEGIN
                                  ...
                                  BEGIN
                                    ...
                                    BEGIN
                                      ...
                                      IF Dmg_Qty<=itemledgerentry."Remaining Quantity" THEN
                                      BEGIN
                ...
                action("Assign Batches From Prod -STR")
                {
                    ...
                    begin
                           ...
                           IF (("Transfer-to Code"='STR') OR ("Transfer-to Code"='MCH'))  AND
                              (("Transfer-from Code"='PROD') OR ("Transfer-from Code"='MCH'))THEN
                           BEGIN
                             "Material Issues Line".SETRANGE("Material Issues Line"."Document No.","No.");
                             IF "Material Issues Line".FINDSET THEN
                             REPEAT
                ...
                action("Request for Authorization")
                {
                    ...
                    begin
                        ...
                        */
                        ...
                        "Mail-Id".RESET;
                        "Mail-Id".SETRANGE("Mail-Id"."User Name","Request for Authorization");
                        IF "Mail-Id".FINDFIRST THEN
                        BEGIN
                          ...
                          BEGIN
                            ...
                            ELSE ERROR('Authorized person do not have Mail id In ERP & Please inform the ERP Administrtor to create mail id!');
                          END
                          ELSE
                        ...
                        IF ("Transfer-to Code"='R&D STR') OR ("Transfer-to Code"='DAMAGE') THEN
                        BEGIN
                          IF "Reason Code"='' THEN
            ...
            group("P&osting")
            {
                    ...
                    begin
                        ...
                        */
                        ...
                        //>>Added by Pranavi on 20-05-2017 for MSL Process
                          IF "Transfer-from Code" IN ['CS STR','R&D STR','PRODSTR','STR','MCH'] THEN
                          BEGIN
                            MIL.RESET;
                            MIL.SETFILTER(MIL."Document No.","No.");
                        ...
                        IF  ("Transfer-from Code"='CS') AND ("Transfer-to Code"='SITE') THEN
                        BEGIN
                             ...
                             //Customer cards transactions.   added by MNRaju on 10Sep14
                              ...
                              BEGIN
                                ...
                                END;
                              END
                              ELSE ERROR('Please Give Serial No. Tracking for: '+"Material Issues Line"."Item No.");
                             UNTIL "Material Issues Line".NEXT=0;
                          ...
                          REPEAT
                            ...
                            REPEAT
                              ...
                              IF NOT("Service_ Item".FINDFIRST) THEN
                              BEGIN
                                "Service_ Item".INIT;
                          ...
                          UNTIL "Material Issues Line".NEXT=0;
                        END;
                        IF (("Transfer-from Code"='SITE') AND ("Transfer-to Code"='CS')) OR ("Transfer-to Code"='SERVICE') THEN
                        BEGIN
                            SMSetup.GET;
                          "Material Issues Line".RESET;
                          "Material Issues Line".SETRANGE("Material Issues Line"."Document No.","No.");
                          ...
                          REPEAT
                            ...
                            BEGIN
                              ...
                              IF NOT ("Service Header".FINDFIRST) THEN
                              BEGIN
                                "Service Header".INIT;
                                ...
                                IF "Material Issues Line"."Non-Returnable"=TRUE THEN
                                BEGIN
                        ...
                        IF (("Transfer-to Code"='OLD STOCK') AND ("Transfer-from Code"='SITE'))  THEN
                        BEGIN
                          SMSetup.GET();
                          "Material Issues Line".RESET;
                          "Material Issues Line".SETRANGE("Material Issues Line"."Document No.","No.");
                        ...
                        //added by Sundar---
                        IF (("Transfer-from Code"='OLD STOCK') AND ("Transfer-to Code"='SITE'))  THEN
                        BEGIN
                          SMSetup.GET();
                          "Material Issues Line".RESET;
                          "Material Issues Line".SETRANGE("Material Issues Line"."Document No.","No.");
                        ...
                        IF ("Transfer-from Code"='SITE') AND ("Transfer-to Code"='DUMMY') THEN
                        BEGIN
                          SMSetup.GET();
                          "Material Issues Line".RESET;
                          "Material Issues Line".SETRANGE("Material Issues Line"."Document No.","No.");
                        ...
                        IF ("Transfer-from Code"='DUMMY') AND ("Transfer-to Code"='SITE') THEN
                        BEGIN
                          SMSetup.GET();
                          "Material Issues Line".RESET;
                          "Material Issues Line".SETRANGE("Material Issues Line"."Document No.","No.");
                        ...
                        REPEAT
                          ...
                          REPEAT
                            ...
                            BEGIN
                              ...
                              ELSE IF "Transfer-to Code"='QC' THEN
                                MTS."Responsible Person":='QC'
                              ELSE IF "Transfer-to Code"='CS' THEN
                ...
                action("Service Order")
                {
                    ...
                    trigger OnAction();
                    begin
                        IF (("Transfer-from Code"='SITE') AND ("Transfer-to Code"='CS')) THEN
                        BEGIN
                            SMSetup.GET;
                          "Material Issues Line".RESET;
                          "Material Issues Line".SETRANGE("Material Issues Line"."Document No.","No.");
    ...
    begin
        ...
        user.SETRANGE(user."User Name",USERID);
        user.FINDSET;
        IF (Rec."Prod. Order No." = 'EFF14STA01')  THEN
        BEGIN
            LinesCount := 0;
            StationaryCount := 0;
            MIL.RESET;
            ...
            IF StationaryCount <> LinesCount THEN
            BEGIN
                  NonStationary := '';
                  MIL.RESET;
                  MIL.SETFILTER("Document No.",Rec."No.");
