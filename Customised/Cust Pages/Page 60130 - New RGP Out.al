                ...
                action("Get RGP &In")
                {
                    ...
                    begin
                        ...
                        END ELSE BEGIN
                            RGPOutLineNo := 0;
                        END;
                        RGPIn.SETRANGE(Consignee, Consignee);
                        RGPIn.SETRANGE("Consignee No.", "Consignee No.");
                                    ...
                                    IF RGPOutLine."Quantity to Recieve" = 0 THEN BEGIN
                                        ...
                                        IF RGPApplied.FINDSET THEN BEGIN
                                            REPEAT
                                                ...
                                                RGPLedgerEntry."Document Date" := "RGP Date";
