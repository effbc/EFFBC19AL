page 60082 "Bank Guarntee"
{
            ...
            group(General)
            {
                ...
                field("Doc No.";"Doc No.")
                {
                    ...
                    begin
                        ...
                        IF PAGE.RUNMODAL(0,SH)=ACTION::LookupOK THEN
                        BEGIN
                           "Doc No.":=SH."No.";
                          ...
                          ELSE IF SH."Document Type" = SH."Document Type"::Amc THEN
            ...
            group("F&unctions")
            {
                    ...
                    begin
                        IF NOT CONFIRM(Text01,FALSE) THEN
                          EXIT;
                            ...
                            IF SH."BG Status"=SH."BG Status"::Pending THEN
                            BEGIN
                ...
                action("Releasing to finance")
                {
                    ...
                    begin
                        ...
                        IF "Released to Finance" = TRUE THEN
                        BEGIN
                            IF(NOT(CONFIRM('Again do you want Release to Finance'))) THEN
                            BEGIN
                                EXIT;
                            END;
                         END;
    ...
    begin
        IF NOT (UPPERCASE(USERID) IN ['EFFTRONICS\RAJANI','EFFTRONICS\YESU','EFFTRONICS\MDIVYA','EFFTRONICS\SUSMITHAL','EFFTRONICS\SHABANABEGUM',
                                      'EFFTRONICS\20TE168','EFFTRONICS\RADHIKAK','EFFTRONICS\SITARAJYAM','EFFTRONICS\DIVYA','EFFTRONICS\VISHNUPRIYA']) THEN
        BEGIN
