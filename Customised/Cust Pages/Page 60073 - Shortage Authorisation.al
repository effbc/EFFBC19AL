page 60073 "Shortage Authorisation"
{
        ...
        area(content)
        {
            group(Filters)
            {
                ...
                field(Choice;Choice)
                {
                    ...
                    begin
                        IF Choice = Choice :: Shortage THEN BEGIN
                          ...
                          "Show Shortage";
                        END ELSE IF Choice = Choice :: Purchase THEN BEGIN
                          RESET;
                ...
                field("Data Choice";Data_Choice)
                {
                    ...
                    trigger OnValidate();
                    begin
                        IF (Choice=Choice::Purchase) OR(Choice=Choice::PNUC) THEN
                        BEGIN
                          RESET;
                          FormShow;
                          "Show Shortage";
                ...
                field(Authorise;Authorise)
                {
                    ...
                    begin
                        ...
                        IF ( Data_Choice=Data_Choice::WFA) AND (Choice=Choice::Purchase)  THEN
                        BEGIN
                          IF (USERID='EFFTRONICS/ANILKUMAR') OR (USERID='EFFTRONICS/PADMAJA') OR (USERID='EFFTRONICS\ANVESH') OR (USERID='EFFTRONICS\SPURTHI') OR (USERID='EFFTRONICS/CHOWDARY') THEN
                          BEGIN
                          ...
                          END;
                        END ELSE
                        IF ( Data_Choice=Data_Choice::WFA) AND (Choice=Choice::PNUC)  THEN
                        BEGIN
                          IF (USERID='EFFTRONICS/ANILKUMAR') OR (USERID='EFFTRONICS/PADMAJA') OR (USERID='EFFTRONICS/CHOWDARY') OR (USERID='EFFTRONICS\ANVESH') OR (USERID='EFFTRONICS\SPURTHI') THEN
                          BEGIN
            ...
            repeater(Control1102152044)
            {
                ...
                field("Purchase Orders";"Purchase Orders")
                {
                    ...
                    begin
                        ...
                        IF (Data_Choice<>Data_Choice::WAP) THEN
                        BEGIN
                ...
                field("Accepted By Purchase";"Accepted By Purchase")
                {
                    ...
                    begin
                        ...
                        OR(USERID='EFFTRONICS\RENUKACH') OR(USERID='EFFTRONICS\BRAHMAIAH') OR (USERID='EFFTRONICS\ANANDA') OR (USERID='EFFTRONICS\ANVESH') OR (USERID='EFFTRONICS\SPURTHI') OR (USERID='EFFTRONICS\BSATISH') OR (USERID='EFFTRONICS\GRAVI')
                          OR (USERID='EFFTRONICS\PRANAVI') THEN
                        BEGIN
                          IF (Choice=Choice::PNUC) AND (Data_Choice=Data_Choice::Open) THEN
                          BEGIN
                            IF "Accepted By Purchase" THEN
                            BEGIN
                              "Shortage Details".RESET;
                              "Shortage Details".SETCURRENTKEY("Shortage Details"."Planned Purchase Date");
                              "Shortage Details".SETRANGE("Shortage Details"."Planned Purchase Date",0D);
                ...
                field("Get From R&D";"Get From R&D")
                {
                    ...
                    begin
                        ...
                        IF "Overall Requirement"<"Qty. In R&D" THEN
                        BEGIN
                          IF "Get From R&D" THEN
                          BEGIN
                ...
                field("Get From CS";"Get From CS")
                {
                    ...
                    begin
                        ...
                        IF "Overall Requirement"<"Qty. In CS" THEN
                        BEGIN
                ...
                field("Production  Orders";"Production  Orders")
                {
                    ...
                    begin
                        ...
                        END ELSE IF Choice=Choice::Purchase THEN
                        BEGIN
                         "Shortage Details".RESET;
        ...
        area(processing)
        {
                ...
                action(Prodcution)
                {
                    ...
                    begin
                         ...
                         REPEAT
                           ...
                           IF Shortage_Det2.FINDLAST THEN
                           BEGIN
                             IF Shortage_Det2."Possible Production Plan Date">0D THEN
                             BEGIN
            ...
            group("Other Actions")
            {
                ...
                action(Refresh)
                {
                    ...
                    trigger OnAction();
                    begin
                        IF UPPERCASE(USERID) IN['EFFTRONICS\ANILKUMAR','EFFTRONICS\PADMAJA','EFFTRONICS\ANVESH','EFFTRONICS\PADMASRI','SUPER','EFFTRONICS\PRANAVI','EFFTRONICS\BSATISH','EFFTRONICS\VIJAYA','EFFTRONICS\SARDHAR','EFFTRONICS\GRAVI'] THEN
                        BEGIN
                          //Rev01 Start
                          //Code Commented
                          /*
            ...
            group("Forward Actions")
            {
                action("Frwd To Purch. For Availbility")
                {
                    ...
                    begin
                        ...
                        IF UPPERCASE(USERID) IN ['EFFTRONICS\PADMAJA','SUPER','EFFTRONICS\DMADHAVI','EFFTRONICS\ANILKUMAR','EFFTRONICS\ANVESH'] THEN
                        BEGIN
                          IF (Choice=Choice::PNUC) AND ( Data_Choice=Data_Choice::Open) THEN
                          BEGIN
                ...
                action("Frwd Avail. To Prod.Incharge")
                {
                    ...
                    begin
                        ...
                        IF UPPERCASE(USERID) IN['EFFTRONICS\CHOWDARY','SUPER','EFFTRONICS\BRAHMAIAH','EFFTRONICS\RENUKACH','EFFTRONICS\ANANDA','EFFTRONICS\ANVESH','EFFTRONICS\SPURTHI'] THEN
                        BEGIN
                          IF (Choice=Choice::PNUC) AND ( Data_Choice=Data_Choice::Open) THEN
                          BEGIN
                ...
                action("Specify Change Acording Avail.")
                {
                    ...
                    begin
                        ...
                        REPEAT
                          ...
                          IF "Shortage Details".FINDSET THEN
                          REPEAT
                            IF "Shortage Details"."Production Order No."<>'' THEN
                            BEGIN
                              "Production Order".RESET;
                ...
                group("&Functions")
                {
                    ...
                    action("Dump to Cash Flow")
                    {
                        ...
                        begin
                            ...
                            WINDOW.UPDATE(1,"Shortage Details"."Planned Purchase Date");
                               ...
                               IF "Shortage Details"."Planned Purchase Date"=0D THEN
                               BEGIN
                               ...
                               BEGIN
                                 IF  ((DATE2DWY("Shortage Details"."Planned Purchase Date",1)=1) OR
                                      (DATE2DWY("Shortage Details"."Planned Purchase Date",1)=4))THEN
                                 BEGIN
                                   "Shortage Details"."Vitual Purchase Date":="Shortage Details"."Planned Purchase Date"+2;
                                 END ELSE IF ((DATE2DWY("Shortage Details"."Planned Purchase Date",1)=2) OR
                                              (DATE2DWY("Shortage Details"."Planned Purchase Date",1)=5)) THEN
                                 BEGIN
                    ...
                    action("Make Intdent")
                    {
                        ...
                        begin
                            ...
                            IF (Choice=Choice::Purchase) AND (Data_Choice=Data_Choice::Authorised) THEN
                            BEGIN
                            /*
                              "Shortage Details".RESET;
                            ...
                            */ //added by pranavi to fill empty sales order number in item lot numbers on 06-01-2015
                              ...
                              REPEAT
                                ...
                                IF Prev_Sale_Order<>"Shortage Details"."Sales Order No." THEN
                                BEGIN
                                  IF Prev_Sale_Order<>'' THEN
                                  BEGIN
                                    Line_no+=10000;
                                    "Indent Line".INIT;
                                  ...
                                  IF "No_Of Indent">Ind_Count THEN
                                  BEGIN
                               ...
                               /*  "Shortage Details".SETFILTER("Shortage Details"."Material Required Date",'<>%1',0D);
                                ...
                                END ELSE
                                BEGIN
                                  IF Prev_Item<>"Shortage Details"."Item No" THEN
                                  BEGIN
                                    Line_no+=10000;
                                    "Indent Line".INIT;
                                    "Indent Line"."Document No.":='IND-AU'+FORMAT(DATE2DMY(TODAY,1))+FORMAT(DATE2DMY(TODAY,2))+FORMAT(DATE2DMY(TODAY,3))
                              ...
                              END;
                            END ELSE
                            IF (Choice=Choice::PNUC) AND (Data_Choice=Data_Choice::Authorised) THEN
                            BEGIN
                    ...
                    action("ConfirmtheVendor & Item Costs")
                    {
                        ...
                        begin
                            ...
                            BEGIN
                              ...
                              ELSE
                              BEGIN */
                                IF (USERID='89OF002') OR (USERID='SUPER') OR (USERID='20P2007') THEN
                                BEGIN
                                  IF (Choice=Choice::Purchase) THEN
                                  BEGIN
                    ...
                    action("Assign Suitable Vendors & Cost")
                    {
                        ...
                        begin
                            ...
                            IF USERID IN ['EFFTRONICS\CHOWDARY','EFFTRONICS\BRAHMAIAH','EFFTRONICS\ANILKUMAR','EFFTRONICS\RENUKACH','EFFTRONICS\ANANDA','EFFTRONICS\ANVESH','EFFTRONICS\SPURTHI','ERPSERVER\ADMINISTRATOR'
                                      ,'EFFTRONICS\VISHNUPRIYA','EFFTRONICS\GRAVI','EFFTRONICS\SUJANI'] THEN
                            BEGIN
                              "Cost Estimation":=0;
                              IF (Choice=Choice::Purchase) AND (Data_Choice=Data_Choice::WAP) THEN
                              BEGIN
                                SETFILTER(Shortage,'>%1',0);
                                 ...
                                 /* "Item vendor".SETCURRENTKEY("Item vendor"."Item No.","Item vendor"."Variant Code","Item vendor"."Vendor No.");
                                  ...
                                  BEGIN
                                    ...
                                    BEGIN
                                      ...
                                      IF Item."Base Unit of Measure" = "Purch. Inv. Line"."Unit of Measure Code" THEN
                                      BEGIN
                                ...
                                UNTIL NEXT=0;
                              END ELSE
                              IF (Choice=Choice::PNUC) AND (Data_Choice=Data_Choice::WAP) THEN
                              BEGIN
                                SETFILTER(Shortage,'>%1',0);
                                //SETFILTER(Confirmed,'%1',FALSE);
                                IF FINDSET THEN
                    ...
                    action("Forward To Purchase")
                    {
                        ...
                        begin
                                ...
                                IF (Choice=Choice::Purchase) THEN
                                BEGIN
                                  IF USERID IN ['EFFTRONICS\VISHNUPRIYA','EFFTRONICS\PADMAJA','EFFTRONICS\DMADHAVI','EFFTRONICS\ANILKUMAR','EFFTRONICS\SPURTHI','EFFTRONICS\ANVESH','EFFTRONICS\BSATISH','EFFTRONICS\GRAVI']   THEN
                                  BEGIN
        ...
        BEGIN
          ...
          BEGIN
            IF ("Overall Requirement"<>(("Required  Qty"+"Qty. In Material Issues")-
                                      (Item."Stock At MCH Location"+Item."Stock at Stores" +"Qty Under Inspection"))) AND Show_REQ_Det THEN
            BEGIN
    ...
    begin
        ...
        IF  (USERID<>'EFFTRONICS\PHANI') AND (USERID<>'EFFTRONICS\BRAHMAIAH') AND (USERID<>'EFFTRONICS\RENUKACH') AND (USERID<>'EFFTRONICS\ANANDA') THEN
        BEGIN
          RESET;
          DELETEALL;
        END;
    ...
    begin
        ...
        BEGIN
          ...
          ELSE
            ...
            "Shortage Details".SETFILTER("Shortage Details".Authorisation,'Open');
          END
          ELSE IF Data_Choice=Data_Choice::WAP THEN
          BEGIN
            ...
            IF Sale_Order<>'' THEN
              "Shortage Details".SETRANGE("Shortage Details"."Sales Order No.",Sale_Order);
            "Shortage Details".SETFILTER("Shortage Details".Authorisation,'WAP');
          END ELSE IF Data_Choice=Data_Choice::WFA THEN
          BEGIN
            ...
            IF Sale_Order<>'' THEN
              "Shortage Details".SETRANGE("Shortage Details"."Sales Order No.",Sale_Order);
            "Shortage Details".SETFILTER("Shortage Details".Authorisation,'WFA');
          END ELSE IF Data_Choice=Data_Choice::Authorised THEN
          BEGIN
            "Shortage Details".SETFILTER("Shortage Details"."Planned Purchase Date",'>%1',0D);
            ...
            IF Sale_Order<>'' THEN
              "Shortage Details".SETRANGE("Shortage Details"."Sales Order No.",Sale_Order);
            "Shortage Details".SETFILTER("Shortage Details".Authorisation,'Authorised');
          END ELSE IF Data_Choice=Data_Choice::Indent THEN
          BEGIN
          ...
          END ELSE IF Data_Choice=Data_Choice::SendAuth THEN
          BEGIN
            "Shortage Details".SETCURRENTKEY("Shortage Details"."Item No","Shortage Details"."Planned Purchase Date",
                                           "Shortage Details"."Production Order No.");
            "Shortage Details".SETFILTER("Shortage Details".Authorisation,'WAP');
            ...
            BEGIN
              ...
              BEGIN
                ...
                BEGIN
                  ...
                  IF ((Data_Choice=Data_Choice::WAP) OR (Data_Choice=Data_Choice::Open ) OR (Data_Choice=Data_Choice::WFA)) THEN
                  BEGIN
                  ...
                  //  "Purchase Line".SETFILTER("Purchase Line"."Deviated Receipt Date",'>=%1',"G\L"."Shortage. Calc. Date");
                   ...
                   // "Purchase Line".SETFILTER("Purchase Line"."Deviated Receipt Date",'>=%1',prdLastDate);
                    ...
                    "Req Qty":=0;
                    IF Item_Req.GET(Prev_Item) THEN
                    BEGIN
                    ...
                    IF "Minimum Order Qty.">"Present Week" THEN
                    BEGIN
                  ...
                  BEGIN
                    ...
                    IF (MOQ_Temp>0) AND (Item."Standard Packing Quantity"=0) THEN
                    BEGIN
                      IF MOQ_Temp>1 THEN
                      BEGIN
                    ...
                    END ELSE IF (MOQ_Temp>0) AND (Item."Standard Packing Quantity"<=MOQ_Temp) THEN
                    BEGIN
                      IF MOQ_Temp>1 THEN
                      BEGIN
                        IF Tot_Shortage<MOQ_Temp THEN
                    ...
                    BEGIN
                      ...
                      END ELSE
                        Order_Qty:=Tot_Shortage;
                    END ELSE IF (MOQ_Temp=0) AND (Item."Standard Packing Quantity">0) THEN
                    BEGIN
                  ...
                  */
                  ...
                  IF Item.GET("Item No.") THEN
                     IF "Overall Requirement"<>(("Required  Qty"+"Qty. In Material Issues"+Item."Safety Stock Quantity")-
                                         (Item."Stock At MCH Location"+Item."Stock at Stores" +"Qty Under Inspection")) THEN
                     BEGIN
                  ...
                  IF ("Purchase Orders"+Difference)>=("Overall Requirement") THEN
                  BEGIN
          ...
          BEGIN
            ...
            BEGIN
              ...
              "Total Cost":=Prev_Cost*Tot_Shortage;
              Item.RESET;
              IF Item.GET("Shortage Details"."Item No") THEN
              BEGIN
                Item.CALCFIELDS(Item."Inventory at Stores",Item."Qty. on Purch. Order",
                              Item."Quantity Under Inspection",Item."Stock At MCH Location",Item."Stock at PROD Stores");
                "Lead Time":=Item."Safety Lead Time";
                ...
                IF (Data_Choice=Data_Choice::WFA) OR (Data_Choice=Data_Choice::Authorised)  OR (Data_Choice=Data_Choice::WAP) THEN
                BEGIN
                  Order_Qty:=0;
                  IF Item.GET(Prev_Item) THEN
                  BEGIN
        ...
        BEGIN
          ...
          END ELSE IF Data_Choice=Data_Choice::WAP THEN
          BEGIN
            "Shortage Details".SETRANGE("Shortage Details"."Planned Purchase Date",0D);
            "Shortage Details".SETFILTER("Shortage Details".Authorisation,'WAP')
          END ELSE IF Data_Choice=Data_Choice::WFA THEN
               ...
               // "Purchase Orders"+"Qty Under Inspection"))));
                ...
                BEGIN
                  ...
                  IF (Data_Choice=Data_Choice::WFA) OR (Data_Choice=Data_Choice::Authorised) OR (Data_Choice=Data_Choice::CBP)  OR
                   (Data_Choice=Data_Choice::WAP)  OR (Data_Choice=Data_Choice::Indent) THEN
                  BEGIN
                    Order_Qty:=Tot_Shortage;
                    IF Item.GET(Prev_Item) THEN
                    BEGIN
                ...
                END;
                  ...
                  */
                  ...
                  BEGIN
                    ...
                    END;
                  IF ("Purchase Orders")>=("Overall Requirement"-Difference) THEN
                  BEGIN
           ...
           //    MESSAGE(FORMAT(Shortage));
               ...
               BEGIN
                 ...
                 IF (Data_Choice=Data_Choice::WFA) OR (Data_Choice=Data_Choice::Authorised) OR (Data_Choice=Data_Choice::CBP)
                     OR (Data_Choice=Data_Choice::WAP) OR (Data_Choice=Data_Choice::Indent) THEN
                 BEGIN
                 Order_Qty:=Tot_Shortage;
             IF Item.GET(Prev_Item) THEN
             BEGIN
              ...
              BEGIN
                ...
                BEGIN
                  ...
                  BEGIN
                    ...
                    IF "Planned Purchase Date (WOB)">=TODAY THEN
                    BEGIN
    ...
    begin
           ...
           BEGIN
             ...
             */ //Rev01
           END ELSE
           IF (Choice<>Choice::Shortage) AND (Data_Choice=Data_Choice::Open) THEN
           BEGIN
             /*
             Currpage."Suitable Vendor".VISIBLE:=FALSE;
             Currpage."Unit Cost".VISIBLE:=FALSE;
           ...
           END ELSE IF (Choice<>Choice::Shortage) AND (Data_Choice=Data_Choice::WAP) THEN
           BEGIN
             /*
             Currpage."Suitable Vendor".VISIBLE:=TRUE;
             Currpage."Unit Cost".VISIBLE:=TRUE;
             ...
             Currpage."Minimum Order Qty.".VISIBLE:=TRUE;
             */ //Rev01
           END ELSE IF (Choice<>Choice::Shortage) AND (Data_Choice=Data_Choice::Authorised) THEN
           BEGIN
           /*
             Currpage."Suitable Vendor".VISIBLE:=TRUE;
             Currpage."Unit Cost".VISIBLE:=TRUE;
    ...
    begin
        ...
        //BEGIN
          ...
          REPEAT
            ...
            BEGIN
              IF (item."Item Sub Group Code"='FILM') OR (item."Product Group Code"='VARIST') THEN
              BEGIN
                TCount:=TCount+1;
              END;
            END;
