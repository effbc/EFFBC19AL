    ...
    dataset
    {
        dataitem("G/L Entry";"G/L Entry")
        {
            ...
            begin
                ...
                IF COPYSTR("G/L Entry"."Document No.",1,2) = 'JV' THEN
                BEGIN
                  textcap := 'Journal';
                END ELSE
                ...
                END ELSE BEGIN
                  IF "G/L Entry"."Payment Type"="G/L Entry"."Payment Type"::Advance THEN
                    textcap:='Receipt'
                  ELSE IF "G/L Entry"."Payment Type"="G/L Entry"."Payment Type"::"Supply Payment" THEN
                    textcap:='Receipt'
                  ELSE IF "G/L Entry"."Payment Type"="G/L Entry"."Payment Type"::"Final Payment" THEN
                    textcap:='Receipt'
                  ELSE
                  textcap:=FORMAT("G/L Entry"."Payment Type");
                END;
                ...
                IF ("G/L Entry"."G/L Account No." IN['41000','36200','36300']) THEN
                BEGIN
                ...
                IF ("G/L Entry"."G/L Account No."='20300') OR ("G/L Entry"."G/L Account No."='20400')
                   OR ("G/L Entry"."G/L Account No."='20500') OR ("G/L Entry"."G/L Account No."='20600') THEN
                BEGIN
                ...
                */
                ...
                IF (acno='33200') OR (acno='22200')  THEN
                BEGIN
                ...
                // copy code from //G/L Entry, Body (5) - OnPostSection() >>
                  ...
                  ("G/L Entry"."G/L Account No."='22100') OR ("G/L Entry"."G/L Account No."='22101')  THEN
                  BEGIN
                  BodyVisiable2:=FALSE;
                ...
                IF ("Payment Type"="Payment Type"::payment) THEN
                  FooterVis1:=TRUE
                ELSE IF ("Journal Batch Name"='JV') OR ("Journal Batch Name"='JV-E') OR
                ...
                // copy code from // G/L Entry, Footer (7) - OnPostSection() <<
                 ...
                 BEGIN
                   ...
                   IF (CLE."Customer ord No" <>'') AND (("G/L Entry"."Payment Type"="G/L Entry"."Payment Type"::"Final Payment")
                    OR ("G/L Entry"."Payment Type"="G/L Entry"."Payment Type"::"Final Payment")) THEN
                   BEGIN
        ...
        dataitem("Detailed GST Ledger Entry";"Detailed GST Ledger Entry")
        {
            ...
            begin
                ...
                END ELSE IF "Detailed GST Ledger Entry"."Source Type" = "Detailed GST Ledger Entry"."Source Type" :: Customer THEN BEGIN
                ...
                END ELSE IF "Detailed GST Ledger Entry"."GST Component Code" = 'SGST' THEN BEGIN
                ...
                END ELSE IF "Detailed GST Ledger Entry"."GST Component Code" = 'IGST' THEN BEGIN
