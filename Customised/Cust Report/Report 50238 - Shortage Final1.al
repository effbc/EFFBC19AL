report 50238 "Shortage Final1"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Shortage Final1.rdlc';
    ...
    dataset
    {
        ...
        dataitem("Item Lot Numbers2"; "Item Lot Numbers")
        {
            ...
            begin
                ...
                ELSE IF  "Item Lot Numbers2"."Lead Time2"='4D' THEN
                   TOTAL_LEAD_PRICES[2]+="Item Lot Numbers2".Total
                ELSE IF  "Item Lot Numbers2"."Lead Time2"='7D' THEN
                   TOTAL_LEAD_PRICES[3]+="Item Lot Numbers2".Total
                ELSE IF  "Item Lot Numbers2"."Lead Time2"='15D' THEN
                   TOTAL_LEAD_PRICES[4]+="Item Lot Numbers2".Total
                ELSE IF  "Item Lot Numbers2"."Lead Time2"='21D' THEN
                   TOTAL_LEAD_PRICES[5]+="Item Lot Numbers2".Total
                ELSE IF  "Item Lot Numbers2"."Lead Time2"='25D' THEN
                   TOTAL_LEAD_PRICES[6]+="Item Lot Numbers2".Total
                ELSE IF  "Item Lot Numbers2"."Lead Time2"='30D' THEN
                   TOTAL_LEAD_PRICES[7]+="Item Lot Numbers2".Total
                ELSE IF  "Item Lot Numbers2"."Lead Time2"='45D' THEN
                   TOTAL_LEAD_PRICES[8]+="Item Lot Numbers2".Total
                ELSE IF  "Item Lot Numbers2"."Lead Time2"='60D' THEN
                   TOTAL_LEAD_PRICES[9]+="Item Lot Numbers2".Total
                ELSE IF  "Item Lot Numbers2"."Lead Time2"='90D' THEN
                   TOTAL_LEAD_PRICES[10]+="Item Lot Numbers2".Total;
                
                    CASE "Item Lot Numbers2"."Lead Time2" OF
                
                      '2D'  :PRICES[1]+= "Item Lot Numbers2".Total;
                      '3D'  :PRICES[2]+= "Item Lot Numbers2".Total;
                      '4D'  :PRICES[3]+= "Item Lot Numbers2".Total;
                      '5D'  :PRICES[4]+= "Item Lot Numbers2".Total;
                      '7D'  :PRICES[5]+= "Item Lot Numbers2".Total;
                      '10D' :PRICES[6]+= "Item Lot Numbers2".Total;
                      '14D' :PRICES[7]+= "Item Lot Numbers2".Total;
                      '15D' :PRICES[8]+= "Item Lot Numbers2".Total;
                      '20D' :PRICES[9]+= "Item Lot Numbers2".Total;
                      '21D' :PRICES[10]+="Item Lot Numbers2".Total;
                      '25D' :PRICES[11]+="Item Lot Numbers2".Total;
                      '30D' :PRICES[12]+="Item Lot Numbers2".Total;
                      '45D' :PRICES[13]+="Item Lot Numbers2".Total;
                      '56D' :PRICES[14]+="Item Lot Numbers2".Total;
                      '60D' :PRICES[15]+="Item Lot Numbers2".Total;
                      '65D' :PRICES[16]+="Item Lot Numbers2".Total;
                      '70D' :PRICES[17]+="Item Lot Numbers2".Total;
                      '75D' :PRICES[18]+="Item Lot Numbers2".Total;
                      '90D' :PRICES[19]+="Item Lot Numbers2".Total;
                      '120D':PRICES[20]+="Item Lot Numbers2".Total;
                ...
                /*
                IF Previous_Prod_Order='' THEN BEGIN
                ...
                */
                ...
                //Item Lot Numbers2, GroupFooter (4) - OnPreSection()
                 /* IF  (Previous_Prod_Order<>"Item Lot Numbers2"."Production Order No.")   THEN BEGIN
                    Row+=1;
                    xlWorkSheet2.Range('A' + FORMAT(Row)).Value := "Prev_Sales_Order_No.";
                    xlWorkSheet2.Range('B' + FORMAT(Row)).Value := Prev_Customer_Name;
                    xlWorkSheet2.Range('C' + FORMAT(Row)).Value := Previous_Prod_Order;
                    xlWorkSheet2.Range('D' + FORMAT(Row)).Value := Prev_Product;
                    xlWorkSheet2.Range('E' + FORMAT(Row)).Value := PRICES[1];
                    xlWorkSheet2.Range('F' + FORMAT(Row)).Value := PRICES[2];
                    xlWorkSheet2.Range('G' + FORMAT(Row)).Value := PRICES[3];
                    xlWorkSheet2.Range('H' + FORMAT(Row)).Value := PRICES[4];
                    xlWorkSheet2.Range('I' + FORMAT(Row)).Value := PRICES[5];
                    xlWorkSheet2.Range('J' + FORMAT(Row)).Value := PRICES[6];
                    xlWorkSheet2.Range('K' + FORMAT(Row)).Value := PRICES[7];
                    xlWorkSheet2.Range('L' + FORMAT(Row)).Value := PRICES[8];
                    xlWorkSheet2.Range('M' + FORMAT(Row)).Value := PRICES[9];
                    xlWorkSheet2.Range('N' + FORMAT(Row)).Value := PRICES[10];
                    xlWorkSheet2.Range('O' + FORMAT(Row)).Value := PRICES[11];
                    xlWorkSheet2.Range('P' + FORMAT(Row)).Value := PRICES[12];
                    xlWorkSheet2.Range('Q' + FORMAT(Row)).Value := PRICES[13];
                    xlWorkSheet2.Range('R' + FORMAT(Row)).Value := PRICES[14];
                    xlWorkSheet2.Range('S' + FORMAT(Row)).Value := PRICES[15];
                    xlWorkSheet2.Range('T' + FORMAT(Row)).Value := PRICES[16];
                    xlWorkSheet2.Range('U' + FORMAT(Row)).Value := PRICES[17];
                    xlWorkSheet2.Range('V' + FORMAT(Row)).Value := PRICES[18];
                    xlWorkSheet2.Range('W' + FORMAT(Row)).Value := PRICES[19];
                    xlWorkSheet2.Range('X' + FORMAT(Row)).Value := PRICES[20];
                    xlWorkSheet2.Range('Y' + FORMAT(Row)).Value := PRICES[1]+PRICES[2]+PRICES[3]+PRICES[4]+PRICES[5]+PRICES[6]+PRICES[7]+
                                                                   PRICES[8]+PRICES[9]+PRICES[10]+PRICES[11]+PRICES[12]+PRICES[13]+PRICES[14]+
                                                                   PRICES[15]+PRICES[16]+PRICES[17]+PRICES[18]+PRICES[19]+PRICES[20];
                    FOR temp:=1 TO 20 DO
                      PRICES[temp]:=0;
                  END;
                ...
                */
                FOR temp:=1 TO 20 DO BEGIN
                  IF PRICES[temp]<>0 THEN BEGIN
                    Row+=1;
                    xlWorkSheet2.Range('A' + FORMAT(Row)).Value := "Item Lot Numbers2"."Sales Order No.";
                    xlWorkSheet2.Range('B' + FORMAT(Row)).Value := "Item Lot Numbers2"."Customer Name";
                    xlWorkSheet2.Range('C' + FORMAT(Row)).Value := "Item Lot Numbers2"."Production Order No.";
                    xlWorkSheet2.Range('D' + FORMAT(Row)).Value := "Item Lot Numbers2"."Product Type";
                    IF  "Item Lot Numbers2"."Sales Order No."='STR INTERNAL' THEN
                      xlWorkSheet2.Range('G' + FORMAT(Row)).Value := 'STR INTERNAL'
                    ELSE IF COPYSTR("Item Lot Numbers2"."Sales Order No.",1,7)='EFF/EXP' THEN
                      xlWorkSheet2.Range('G' + FORMAT(Row)).Value := 'EXPECTED ORDER'
                    ELSE IF COPYSTR("Item Lot Numbers2"."Sales Order No.",1,7)='EFF/SAL' THEN
                      xlWorkSheet2.Range('G' + FORMAT(Row)).Value := 'SALE ORDER'
                    ELSE
                      xlWorkSheet2.Range('G' + FORMAT(Row)).Value := 'INTERNAL ORDER';
                
                    CASE temp OF
                      1 : xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='002D';
                      2 : xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='003D';
                      3 : xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='004D';
                      4 : xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='005D';
                      5 : xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='007D';
                      6 : xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='010D';
                      7 : xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='014D';
                      8 : xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='015D';
                      9 : xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='020D';
                      10: xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='021D';
                      11: xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='025D';
                      12: xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='030D';
                      13: xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='045D';
                      14: xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='056D';
                      15: xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='060D';
                      16: xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='065D';
                      17: xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='070D';
                      18: xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='075D';
                      19: xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='090D';
                      20: xlWorkSheet2.Range('E' + FORMAT(Row)).Value :='120D';
                    END;
                    xlWorkSheet2.Range('F' + FORMAT(Row)).Value :=PRICES[temp];
                  END;
                END;
                ...
                IF  ("Prev_Sales_Order_No."<>"Item Lot Numbers2"."Sales Order No.")   THEN BEGIN
                 ...
                 IF(i=1)THEN BEGIN
                  ...
                  CASE "Item Lot Numbers2"."Lead Time2" OF
                    ...
                    '2D' :PRODUCTS_LEAD_PRICES[i][1]+="Item Lot Numbers2".Total;
                    '4D' :PRODUCTS_LEAD_PRICES[i][2]+="Item Lot Numbers2".Total;
                    '7D' :PRODUCTS_LEAD_PRICES[i][3]+="Item Lot Numbers2".Total;
                    '15D':PRODUCTS_LEAD_PRICES[i][4]+="Item Lot Numbers2".Total;
                    '21D':PRODUCTS_LEAD_PRICES[i][5]+="Item Lot Numbers2".Total;
                    '25D':PRODUCTS_LEAD_PRICES[i][6]+="Item Lot Numbers2".Total;
                    '30D':PRODUCTS_LEAD_PRICES[i][7]+="Item Lot Numbers2".Total;
                    '45D':PRODUCTS_LEAD_PRICES[i][8]+="Item Lot Numbers2".Total;
                    '60D':PRODUCTS_LEAD_PRICES[i][8]+="Item Lot Numbers2".Total;
                    '90D':PRODUCTS_LEAD_PRICES[i][10]+="Item Lot Numbers2".Total;
                  END;
                ...
                END;
                  ...
                  xlWorkSheet1.Range('D:F').NumberFormat:='_ * #,##0_ ;_ * -#,##0_ ;_ * ""-""??_ ;_ @_ ';
        ...
        dataitem("Shortage Temp";"Shortage Temp")
        {
            ...
            DataItemTableView = SORTING(Total Cost,Lead Time,Item No.) ORDER(Descending) WHERE(Not Needed=CONST(No),Don't Repeat=CONST(No));
            ...
            begin
                ...
                */
                ...
                IF Item.GET("Shortage Temp"."Item No.") THEN BEGIN
                  ...
                  IF (MOQ_Temp>0) AND (Item."Standard Packing Quantity"=0) THEN BEGIN
                    ...
                    END ELSE BEGIN
                      Order_Qty:="Shortage Temp".Shortage;
                    END;
                  END ELSE IF (MOQ_Temp>0) AND (Item."Standard Packing Quantity"<=MOQ_Temp) THEN BEGIN
                    IF MOQ_Temp>1 THEN BEGIN
                      IF "Shortage Temp".Shortage<MOQ_Temp THEN
                        Order_Qty:=MOQ_Temp
                      ELSE BEGIN
                  ...
                  END ELSE IF (MOQ_Temp=0) AND (Item."Standard Packing Quantity">0) THEN BEGIN
                ...
                IF Vendor.GET("Shortage Temp"."Suitable Vendor") THEN
                BEGIN
                  ...
                  IF (Vendor."Payment Terms Code"='15D') OR (Vendor."Payment Terms Code"='15PDC')  OR (Vendor."Payment Terms Code"='15D-E') THEN
                  BEGIN
                    PLT:=FORMAT("Shortage Temp"."Lead Time");
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                     PLT:='15D';
                  ...
                  END ELSE IF  (Vendor."Payment Terms Code"='100D') THEN
                  BEGIN
                    PLT:=FORMAT("Shortage Temp"."Lead Time");
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                     PLT:='100D';
                    ...
                    "Funds Allocation"("Expected Payment Date",((Order_Qty*"Shortage Temp"."Unit Cost")));
                     ExpecPayDate:=FORMAT("Expected Payment Date");
                  END ELSE IF  (Vendor."Payment Terms Code"='1M') OR (Vendor."Payment Terms Code"='30PDC') THEN
                  BEGIN
                    PLT:=FORMAT("Shortage Temp"."Lead Time");
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                     PLT:='1M';
                    ...
                    "Funds Allocation"("Expected Payment Date",((Order_Qty*"Shortage Temp"."Unit Cost")));
                     ExpecPayDate:=FORMAT("Expected Payment Date");
                  END ELSE IF  (Vendor."Payment Terms Code"='QUART')  THEN
                  BEGIN
                    PLT:=FORMAT("Shortage Temp"."Lead Time");
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                     PLT:='3M';
                    ...
                    "Funds Allocation"("Expected Payment Date",((Order_Qty*"Shortage Temp"."Unit Cost")));
                     ExpecPayDate:=FORMAT("Expected Payment Date");
                  END ELSE IF  (Vendor."Payment Terms Code"='40PDC') OR (Vendor."Payment Terms Code"='40D') THEN
                  BEGIN
                    PLT:=FORMAT("Shortage Temp"."Lead Time");
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                     PLT:='40D';
                    ...
                    "Funds Allocation"("Expected Payment Date",((Order_Qty*"Shortage Temp"."Unit Cost")));
                     ExpecPayDate:=FORMAT("Expected Payment Date");
                  END ELSE IF  (Vendor."Payment Terms Code"='45D') OR (Vendor."Payment Terms Code"='45D-B')  THEN
                  BEGIN
                    PLT:=FORMAT("Shortage Temp"."Lead Time");
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                     PLT:='45D';
                    ...
                    "Funds Allocation"("Expected Payment Date",((Order_Qty*"Shortage Temp"."Unit Cost")));
                     ExpecPayDate:=FORMAT("Expected Payment Date");
                  END ELSE IF  (Vendor."Payment Terms Code"='7D') THEN
                  BEGIN
                    PLT:=FORMAT("Shortage Temp"."Lead Time");
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                     PLT:='7D';
                    ...
                    "Funds Allocation"("Expected Payment Date",((Order_Qty*"Shortage Temp"."Unit Cost")));
                     ExpecPayDate:=FORMAT("Expected Payment Date");
                  END ELSE IF  (Vendor."Payment Terms Code"='60PDC') OR (Vendor."Payment Terms Code"='60D')  THEN
                  BEGIN
                    PLT:=FORMAT("Shortage Temp"."Lead Time");
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                     PLT:='60D';
                    ...
                    "Funds Allocation"("Expected Payment Date",((Order_Qty*"Shortage Temp"."Unit Cost")));
                     ExpecPayDate:=FORMAT("Expected Payment Date");
                  END ELSE IF  (Vendor."Payment Terms Code"='ADVANCE') OR (Vendor."Payment Terms Code"='AG') OR
                               (Vendor."Payment Terms Code"='AR') OR (Vendor."Payment Terms Code"='CASH') OR
                               (Vendor."Payment Terms Code"='15D-A') THEN
                  BEGIN
                    PLT:=FORMAT("Shortage Temp"."Lead Time");
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                    "Funds Allocation"("Expected Payment Date",((Order_Qty*"Shortage Temp"."Unit Cost")));
                    ExpecPayDate:=FORMAT("Expected Payment Date");
                  END ELSE IF  (Vendor."Payment Terms Code"='TOTADV') OR (Vendor."Payment Terms Code"='45D-A') THEN
                  BEGIN
                    PLT:='1D';
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                    "Funds Allocation"("Expected Payment Date",((Order_Qty*"Shortage Temp"."Unit Cost")));
                    ExpecPayDate:=FORMAT("Expected Payment Date");
                  END ELSE IF  (Vendor."Payment Terms Code"='ADV') OR (Vendor."Payment Terms Code"='30D-B') OR
                               (Vendor."Payment Terms Code"='30D-C') OR (Vendor."Payment Terms Code"='15-DAYS') OR
                               (Vendor."Payment Terms Code"='30D-A') THEN
                  BEGIN
                    PLT:='1D';
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                    ExpecPayDate:=FORMAT("Expected Payment Date")+' (50%) ,';
                  ...
                  END ELSE IF (Vendor."Payment Terms Code"='25%') OR (Vendor."Payment Terms Code"='30-G') THEN
                  BEGIN
                    PLT:='1D';
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                    ExpecPayDate:=FORMAT("Expected Payment Date")+' (50%) ,';
                  ...
                  END ELSE IF (Vendor."Payment Terms Code"='30-F') OR (Vendor."Payment Terms Code"='30-G') OR
                              (Vendor."Payment Terms Code"='7D-B') THEN
                  BEGIN
                    PLT:='1D';
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                    ExpecPayDate:=FORMAT("Expected Payment Date")+' (50%) ,';
                  ...
                  END ELSE IF (Vendor."Payment Terms Code"='30D')  THEN
                  BEGIN
                    PLT:='1D';
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                    ExpecPayDate:=FORMAT("Expected Payment Date")+' (50%) ,';
                  ...
                  END ELSE IF (Vendor."Payment Terms Code"='30D-D') OR (Vendor."Payment Terms Code"='30D-H') OR
                              (Vendor."Payment Terms Code"='7D-A') THEN
                  BEGIN
                    PLT:='1D';
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                    ExpecPayDate:=FORMAT("Expected Payment Date")+' (50%) ,';
                  ...
                  END ELSE IF (Vendor."Payment Terms Code"='30D-E') THEN
                  BEGIN
                    PLT:='1D';
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                    ExpecPayDate:=FORMAT("Expected Payment Date")+' (50%) ,';
                    ...
                    ExpecPayDate+=FORMAT("Expected Payment Date")+' (50%) ';
                    "Funds Allocation"("Expected Payment Date",((Order_Qty*"Shortage Temp"."Unit Cost")*0.4));
                  END ELSE IF (Vendor."Payment Terms Code"='30D-I') THEN
                  BEGIN
                    PLT:='1D';
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                    ExpecPayDate:=FORMAT("Expected Payment Date")+' (50%) ,';
                  ...
                  END ELSE IF   (Vendor."Payment Terms Code"='100%COD') THEN
                  BEGIN
                    PLT:=FORMAT("Shortage Temp"."Lead Time");
                    "Expected Payment Date":=CALCDATE(PLT,TODAY);
                     PLT:='0D';
                ...
                ELSE IF STRLEN(FORMAT("Shortage Temp"."Lead Time"))=3 THEN
                ...
                xlWorkSheet3.Range('L' + FORMAT(ROW1)).Value := (Order_Qty-"Shortage Temp".Shortage)*"Shortage Temp"."Unit Cost";
                //Shortage Temp, Body (3) - OnPreSection()
            ...
            begin
                 ...
                 xlWorkSheet3.Range('K:L').NumberFormat:='_ * #,##0_ ;_ * -#,##0_ ;_ * ""-""??_ ;_ @_ ';
            end;
            ...
            begin
                ...
                i4.DELETEALL;
                  ...
                  xlWorkSheet3.Range('L1').Value := 'Excess MOQ_Value';
                  ROW1:=1;
            end;
        }
        dataitem("Item Lot Numbers";"Item Lot Numbers")
        {
            DataItemTableView = SORTING(Sales Order No.,Production Order No.) ORDER(Ascending) WHERE(Authorisation=CONST(WFA),Shortage=FILTER(>0));
    ...
    begin
          ...
          xlWorkSheet2.Columns.AutoFit ;
            ...
            //Pivot Table 2
            ExcelBuffer.VALIDATE("Column No.",6 + NoOfColumns);
        ...
        //Pivot table 3
          ...
          FOR i:= 5 TO 500 DO
          BEGIN
            IF FORMAT(xlWorkSheet2.Range('Z' + FORMAT(i)).Value) = 'Grand Total' THEN
            BEGIN
              Sheet_row:=i;
              i:=500;
            END;
          ...
          BEGIN
            cell_value:= xlWorkSheet2.Range('AB'+FORMAT(i)).Value;
        ...
        //Pivot Table 4
            ...
            xlPivotCache :=
              XLaPP.ActiveWorkbook.PivotCaches.Add(1,STRSUBSTNO('%1!A1:%2%3',
            xlWorkSheet3.Name, ExcelBuffer.xlColID, ROW1));


            xlPivotCache.CreatePivotTable(xlWorkSheet2.Range('A60:A60'),'PivotTable4');
            xlPivotTable := xlWorkSheet2.PivotTables('PivotTable4');
    ...
    var
        ...
        PO : Record "Production Order" temporary;
        ExpecPayDate : Text[100];
        "Break" : Boolean;
        "Purchase Line" : Record "Purchase Line" temporary;
        Line : Integer;
        Pay_Temp : Decimal;
        Pay_Date : Code[100];
        TOT : Decimal;
        ...
        Req_Qty : Integer;
        Unit_Cost : Decimal;
        Item_Wise_Req : Record "Item wise Requirement";
        ...
        Alternate_Item : Record "Alternate Items";
        I1 : Record Item temporary;
        I2 : Record Item temporary;
        I3 : Record Item temporary;
        i4 : Record Item temporary;
        Item_Desc : Text[50];
        Excess_Cost : Decimal;
        Excess_Qty : Decimal;
        Moq : Text[50];
        ...
        PRODUCTS_LIST : array [10,2] of Code[20];
        PRODUCTS_COUNT : array [10] of Integer;
        PRODUCTS_LEAD_PRICES : array [10,10] of Decimal;
        TOTAL_LEAD_PRICES : array [10] of Decimal;
        J : Integer;
        ...
        NULL_ORDER_DETAILS : Record "Item Lot Numbers";
        PURCH_NOT_HAVING_EXPEC_DT : Decimal;
        Previous_Prod_Order : Code[20];
        PRICES : array [20] of Decimal;
        Row : Integer;
