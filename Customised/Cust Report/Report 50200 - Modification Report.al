                ...
                IF USERID = 'SUPER' THEN BEGIN
                    ...
                    IF GL.FINDSET THEN
                        REPEAT
                            ...
                            IF GL."G/L Account No." = '38200' THEN BEGIN
                                GL.Amount := vatamt;
                                GLACEXIST := TRUE;
                            END;
                            IF GL."G/L Account No." = '51700' THEN BEGIN
                                GL.Amount := vatamt;
                                GLACEXIST := TRUE;
                            END;
                            GL.MODIFY;
                        UNTIL GL.NEXT = 0;
                    IF GLACEXIST = FALSE THEN BEGIN
                        GL1.GET(GL1."Entry No.");
                        IF GL1.FINDLAST THEN BEGIN
                    ...
                    IF DTE.FINDSET THEN BEGIN
                        ...
                        UNTIL DTE.NEXT = 0;
                    END ELSE BEGIN
                        IF DTEExistorNot = TRUE THEN BEGIN
