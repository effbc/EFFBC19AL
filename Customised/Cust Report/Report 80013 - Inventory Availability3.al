report 80013 "Inventory Availability3"
{
            ...
            dataitem("Prod. Order Component";"Prod. Order Component")
            {
                ...
                begin
                    ...
                    "Prod. Order Component".CALCFIELDS("Prod. Order Component"."Qty. in Posted Material Issues","Prod. Order Component"."Qty. in Material Issues");
                      IF ("Prod. Order Component"."Type of Solder2"='SMD') THEN
                      BEGIN
                        "PO-LINE".RESET;
                        ...
                        BEGIN
                          ...
                          BEGIN
                            IF STENCIL_PCB(ProdCompLine."Item No.") THEN
                            BEGIN
                              Location:='MCH';
    ...
    begin
        IF USERID = 'EFFTRONICS\PRANAVI' THEN
         ...
         // IF ITEM.FIND('-') THEN
          IF ITEM.GET(item1) THEN
          BEGIN
            IF (ITEM."Product Group Code"<>'CPCB') AND (ITEM."Product Group Code"<>'FPRODUCT') THEN
            BEGIN
              IF (ForPlanning = TRUE) OR ((NOT ITEM."Dispatch Material") AND (ForPlanning = FALSE)) THEN
              BEGIN
                ...
                BEGIN
                  ...
                  BEGIN
                    ...
                    REPEAT
                      ...
                      IF ITEM."Product Group Code"='LED' THEN
                      BEGIN
                        LotItemAvail.RESET;
                        ...
                        IF LotItemAvail.FINDFIRST THEN
                        BEGIN
          ...
          BEGIN
            ...
            REPEAT
              ...
              BEGIN
                ...
                BEGIN
                  //MNRAJU
                  IF (ItemLED.GET("Alternative Items"."Alternative Item No.")) AND (ItemLED."Product Group Code"='LED') THEN //LED POSTING     MNRAJU 06-JUN-2014
                  BEGIN
                    altLoopPrev:=1;
                    "PO-LINE".RESET;
                    ...
                    BEGIN
                      ...
                      REPEAT
                        ...
                        REPEAT
                          IF ((LotItemAvail."Total Qty"-LotItemAvail."Allocated Qty")>="Prod. Order Component"."Quantity per") THEN
                          BEGIN
    ...
    begin
        ...
        BEGIN
          ...
          IF ForPlanning = FALSE THEN
          BEGIN
            IF (ItemLED.GET(ITEM)) AND (ItemLED."Product Group Code"='LED') THEN //LED POSTING     MNRAJU 06-JUN-2014
            BEGIN
              loopPrev:=1;
              "PO-LINE".RESET;
              "PO-LINE".SETFILTER("PO-LINE"."Prod. Order No.","Prod. Order Component"."Prod. Order No.");
            ...
            ELSE
            BEGIN
              IF DUM."Maximum Inventory">=(REQUIRED_QTY)  THEN
              BEGIN
          ...
          END ELSE BEGIN    // Start--shortage calculation for planning purpose
            ...
            BEGIN
              ...
              BEGIN
                IF DUM.GET(ITEM) THEN
                BEGIN
                  IF (Required_Qty_Aftr_Alt <> REQUIRED_QTY) AND (Required_Qty_Aftr_Alt > 0) THEN
                  BEGIN
                    IF Required_Qty_Aftr_Alt  > DUM."Maximum Inventory" THEN
                      SHORTAGE_QTY:=Required_Qty_Aftr_Alt-DUM."Maximum Inventory"
                    ELSE
    ...
    begin
        ...
        BEGIN
          ...
          BEGIN
            ...
            ELSE
            BEGIN
              IF DUM."Total Inventory">=(REQUIRED_QTY)  THEN
              BEGIN
              ...
              BEGIN
                ...
                BEGIN
                  ...
                  BEGIN
                    IF DUM."Total Inventory">0 THEN
                    BEGIN
                      IF DUM."Total Inventory">=Req_Qty THEN
                      BEGIN
    ...
    begin
        ...
        IF DUM.GET(ITEM) THEN
        BEGIN
          IF DUM."Stock at Stores">=(REQUIRED_QTY)  THEN
          BEGIN
