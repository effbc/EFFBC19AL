        ...
        dataitem("Integer"; "Integer")
        {
                ...
                END ELSE BEGIN
                    ...
                    IF Update_Consumption THEN BEGIN
                        ...
                        IF (BOM_Product_Group = 'DL') AND (BOM[PROD_NO] = '99/2006DL512D32A001') THEN BEGIN
                            IF Item_Consume_Update.GET(Dum."No.") THEN BEGIN
                    ...
                    END;
                    IF QC_Report AND Excel THEN BEGIN
                    ...
                    IF Excel THEN BEGIN
                        ...
                        IF (Item."Item Tracking Code" = 'LOT') AND BATCH_INFO_DETIALS THEN BEGIN
                            ItemLedgEntry.RESET;
                            ItemLedgEntry.SETCURRENTKEY("Item No.", "Variant Code", Open, Positive, "Location Code", "Posting Date",
                                 "Expiration Date", "Lot No.", "Serial No.");
                            ItemLedgEntry.SETRANGE("Item No.", Item."No.");
                            ...
                            IF ItemLedgEntry.FINDSET THEN
                                REPEAT
                                    IF (PREV_BATCH <> ItemLedgEntry."Lot No.") AND (PREV_BATCH <> '') THEN BEGIN
                                        Row += 1;
            ...
            begin
                ...
                */
                ...
                IF Choice = Choice::Total THEN BEGIN
                    IF Excel AND QC_Report THEN BEGIN
                        Row := 1;
