report 33000029 "Pay Emp. Project Cost (Actual)"
{
    // version NEOGYNPAY13.70.00.06

    DefaultLayout = RDLC;
    RDLCLayout = './Pay Emp. Project Cost (Actual).rdlc';
    ...
    dataset
    {
        dataitem("Pay Employee Project Cost";"Pay Employee Project Cost")
        {
            ...
            column(Pay_Employee_Project_Cost__Actual_Hourly_Amount_;"Actual Hourly Amount")
            {
            }
            column(Pay_Employee_Project_Cost__Actual_Rate_Basis_Caption;Pay_Employee_Project_Cost__Actual_Rate_Basis_CaptionLbl)
            {
            }
            ...
            column(Pay_Employee_Project_Cost__Actual_Hourly_Amount_Caption;FIELDCAPTION("Actual Hourly Amount"))
            {
            }
    ...
    var
        ...
        Pay_Employee_Project_Cost__Actual_Rate_Basis_CaptionLbl : Label 'Pay Employee Project Cost (Actual Rate Basis)';
