            ...
            begin
                ...
                IF GlEntryGRec.FINDFIRST THEN
                    REPEAT
                        i := i + 1;
                        "Account Head"[i] := '';
                        IF GlEntryGRec."G/L Account No." IN ['18100', '18200', '18300', '18400'] THEN BEGIN
                        ...
                        END
                        ELSE
                            IF GlEntryGRec."G/L Account No." IN ['12951', '12952', '12953', '12954'] THEN BEGIN
                            ...
                            END
                            ELSE
                                IF GlEntryGRec."G/L Account No." IN ['15100', '15200', '15300', '15400'] THEN BEGIN
                                ...
                                END
                                ELSE
                                    IF GlEntryGRec."G/L Account No." IN ['13100', '13200', '13300', '13400'] THEN BEGIN
                                    ...
                                    END
                                    ELSE BEGIN
                                        IF Account_OLD = GlEntryGRec."G/L Account No." THEN BEGIN
                                            i := i - 1;
                                            AccountAmount[i] += GlEntryGRec.Amount;
                                        END ELSE BEGIN
                ...
                IF GlEntryGRec.FINDFIRST THEN BEGIN
                    i := i + 1;
                    REPEAT
                        IF "G/L".GET(GlEntryGRec."G/L Account No.") THEN
                            "Account Head"[i] := "G/L".Name + ' ( ' + GlEntryGRec."G/L Account No." + ' )';
