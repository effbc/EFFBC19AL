report 50010 "Material Requisition Print"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Material Requisition Print.rdlc';
                    ...
                    begin
                        ...
                        IF (Choice=Choice::Req) AND ("Material Issues Line"."Qty. to Receive" > 0 ) AND (CS=FALSE)   THEN BEGIN
                          ...
                          IF "Material Issues Line".Quantity="Material Issues Line"."Quantity Received" THEN
                            rem:=''
                          ELSE IF ("Material Issues Line".Quantity - "Material Issues Line"."Quantity Received") > 0 THEN
        ...
        dataitem(MTS1;"Mat.Issue Track. Specification")
        {
            ...
            begin
                ...
                */
                ...
                IF LOT1='' THEN
                  LOT1:=MTS1."Lot No."
                ELSE IF LOT1<>MTS1."Lot No." THEN BEGIN
                  LOT1:=MTS1."Lot No.";
                  "Prod. Orders":='';
                  "Ser No":='';
                END;
                ...
                IF MTS1."Lot No." <> NextMatIssTrSpecGRec."Lot No." THEN BEGIN
                  ...
                  END;
                    ...
                    IF ( SER_LEN<15 ) AND Excel THEN BEGIN
                      ...
                      Entercell(Row,6,item."Product Group Code",FALSE,TempExcelbuffer."Cell Type" :: Number);
