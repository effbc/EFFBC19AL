report 50058 "Purchase Order"
{
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    dataitem("Purchase Line";"Purchase Line")
                    {
                        ...
                        begin
                            ...
                            */
                            ...
                            IF (FORMAT(VAT)='') AND ("Purchase Line"."Tax Area Code"='PUCH VAT') AND ("Purchase Line"."Tax Amount">0)  THEN BEGIN
                            ...
                            IF (FORMAT(CST)='') AND ("Purchase Line"."Tax Area Code"='PUCH CST') AND ("Purchase Line"."Tax Amount">0) THEN BEGIN
                              ...
                              IF "Purchase Header"."C Form"= FALSE THEN
                                TAX_DETAIL.SETFILTER(TAX_DETAIL."Form Code",'<>C');
                            ...
                            IF (FORMAT(SERVICE)='')  AND ("Purchase Line"."Service Tax Amount">0) THEN BEGIN
                              ...
                              */
                              ...
                              IF SERVICE_TAX_SETUP.FINDLAST THEN
                              BEGIN
                            ...
                            IF ("Purchase Line"."No."<>'') AND ("Purchase Line".Type="Purchase Line".Type:: Item) THEN BEGIN
                              ...
                              IF (PurchLine."No."="Purchase Line"."No.") AND (PurchLine.Make="Purchase Line".Make) AND(Item_Cnt<>Pur_Cnt) THEN BEGIN
                                ...
                                CASE "No.Of Lines" OF
                                  1:Schedu_Number:='1st   Sch. Req qty ';
                                  2:Schedu_Number:='2nd   Sch. Req qty ';
                                  3:Schedu_Number:='3rd   Sch. Req qty ';
                                  4:Schedu_Number:='4th   Sch. Req qty ';
                                  5:Schedu_Number:='5th   Sch. Req qty ';
                                END;
                                ...
                                BEGIN
                                    ...
                                    REPEAT
                                        IF ("Purchase Line"."GST Jurisdiction Type" = "Purchase Line"."GST Jurisdiction Type"::Interstate) AND (GST_Setup."GST Component Code" = 'IGST' ) THEN
                                        BEGIN
                                              IGST := IGST + ("Purchase Line"."GST Base Amount" * GST_Setup."GST Component %")/100;
                                        END
                                        ELSE IF ("Purchase Line"."GST Jurisdiction Type" = "Purchase Line"."GST Jurisdiction Type"::Intrastate) THEN
                                        BEGIN
                                            IF  (GST_Setup."GST Component Code" = 'CGST' ) THEN
                                                CGST := CGST + ("Purchase Line"."GST Base Amount" * GST_Setup."GST Component %")/100
                                            ELSE IF  (GST_Setup."GST Component Code" = 'SGST' ) THEN
                            ...
                            IF  ("No.Of Lines"=1) AND  ("Purchase Line"."No."<>'') AND (COPYSTR("Purchase Line"."No.",1,5)<>'ECPCB')  THEN BEGIN
                             ...
                             BEGIN
                              ...
                              END ELSE IF "Purchase Line".Make<>'' THEN
                                desc_make:= 'MAKE :                '+"Purchase Line".Make;
                            END ELSE
                            ...
                            IF ( "No.Of Lines">1 ) AND ("Purchase Line"."No."<>'') AND (COPYSTR("Purchase Line"."No.",1,5)='ECPCB') THEN BEGIN
                              ...
                              IF (COPYSTR("Purchase Line"."No.",1,5)='ECPCB') THEN BEGIN
                                ...
                                IF Item2.FINDFIRST THEN BEGIN
                                  ...
                                  ELSE IF Item2."PCB Shape"=2 THEN BEGIN
                                    IF  Item2.Length >0 THEN
                                      SIZE:='Diameter :'+  FORMAT(Item2.Length)+'mm'
                                    ELSE IF  Item2.Width >0 THEN
                                      SIZE:='Diameter :'+FORMAT(Item2.Width)+'mm';
                    ...
                    dataitem(RoundLoop;"Integer")
                    {
                        ...
                        begin
                            ...
                            IF StructureLineDetails.FIND('-') THEN
                              REPEAT
                                ...
                                BEGIN
                                  ...
                                  ELSE IF StructureLineDetails."Tax/Charge Group" = 'INSURANCE' THEN
                            ...
                            // CurrReport.SHOWOUTPUT:=FALSE;
                            IF (NOT "Purchase Header"."Inclusive of All Taxes") AND ("Purchase Header"."Order Date">121709D) THEN BEGIN
                              IF EXCISE<>'' THEN
                                EXCISE:=EXCISE;
                                //EXCISE:=EXCISE+'%'; // Rev01
                              IF CST<>'' THEN
    ...
    var
        ...
        GST_TAX_TXT : Text;
        EXCISE_POSTING_SETUP : Record "Excise Posting Setup";
        SERVICE_TAX_SETUP : Record "Service Tax Setup";
        Taxes_Extra : Text[30];
        ...
        Line_DimensionsCaptionLbl : TextConst ;
        "-DIM1.0-" : Integer;
