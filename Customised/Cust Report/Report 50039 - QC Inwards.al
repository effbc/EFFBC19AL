report 50039 "QC Inwards"
{
    ...
    dataset
    {
        dataitem("Inspection Datasheet Header"; "Inspection Datasheet Header")
        {
            ...
            begin
                  IF "Inspection Datasheet Header".GETFILTER("Inspection Datasheet Header"."Created Date")<>'' THEN
                  BEGIN
        ...
        dataitem(IDH;"Inspection Datasheet Header")
        {
            ...
            begin
                       ...
                       totm:=totm+1
                       ELSE IF IDH.Location='R&D STR' THEN
                       totr:=totr+1
                       ELSE IF IDH.Location='CS STR' THEN
                       totc:=totc+1;
            end;
        ...
        dataitem(IR;"Inspection Receipt Header")
        {
            ...
            begin
                       ...
                       totm:=totm+1
                       ELSE IF  IR."Location Code"='R&D STR' THEN
                       totr:=totr+1
                       ELSE IF  IR."Location Code"='CS STR' THEN
                       totc:=totc+1;
