report 50134 "G/L Account Statement"
{
    // version Shiva Teja

    DefaultLayout = RDLC;
    RDLCLayout = './GL Account Statement.rdlc';
    Caption = 'Ledger';
    ...
    dataset
    {
        dataitem("G/L Account";"G/L Account")
        {
            ...
            {
                DataItemLink = G/L Account No.=FIELD(No.),Global Dimension 1 Code=FIELD(Global Dimension 1 Filter),Global Dimension 2 Code=FIELD(Global Dimension 2 Filter),System Date=FIELD(Date Filter);
                ...
                column(G_L_Entry_System_Date;"System Date")
                {
                }
                ...
                begin
                    ...
                    //GLEntry.SETRANGE(GLEntry."System Date",);
                end;
            }
