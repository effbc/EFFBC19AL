report 33000898 "Travelling Advance"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Travelling Advance.rdlc';
        ...
        dataitem("Analysis View Entry";"Analysis View Entry")
        {
            ...
            begin
                ...
                ELSE
                 ...
                 "Analysis View Entry".SETRANGE("Analysis View Entry"."Posting Date",040108D,maxdate);
                ...
                ave.SETRANGE(ave."Posting Date",040108D,mindate-1);
