    ...
    dataset
    {
        dataitem("Sales Invoice Header";"Sales Invoice Header")
        {
            ...
            begin
                ...
                IF SIL."Excise Prod. Posting Group"='84711000' THEN
                BEGIN
                ...
                IF SIL."Excise Prod. Posting Group"='85044010' THEN
                BEGIN
                QtyManfactured2:=QtyManfactured2+SIL.Quantity;
                Assessable2:=Assessable2+ROUND(SIL.Amount,1);
                END;
                IF SIL."Excise Prod. Posting Group"='85249112' THEN
                BEGIN
                ...
                IF SIL."Excise Prod. Posting Group"='91061000' THEN
                BEGIN
            ...
            begin
                ...
                IF (ReturnMonth=ReturnMonth::January) AND (ReturnYear=2010) THEN
                BEGIN
                ...
                IF (ReturnMonth=ReturnMonth::February) AND (ReturnYear=2010) THEN
                BEGIN
        ...
        dataitem("Purch. Inv. Header";"Purch. Inv. Header")
        {
            ...
            begin
                ...
                IF "Purch. Inv. Header"."Type of Supplier"="Purch. Inv. Header"."Type of Supplier"::Manufacturer THEN
                BEGIN
                ...
                ("Purch. Inv. Header"."Type of Supplier"="Purch. Inv. Header"."Type of Supplier"::"First Stage Dealer") THEN
                BEGIN
                ...
                IF "Purch. Inv. Header"."Type of Supplier"="Purch. Inv. Header"."Type of Supplier"::"Second Stage Dealer" THEN
                BEGIN
