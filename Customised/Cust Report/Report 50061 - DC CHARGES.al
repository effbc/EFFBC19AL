...
{
    // version Nirmala,Siva,EFFUPG

    DefaultLayout = RDLC;
    RDLCLayout = './DC CHARGES.rdlc';
    ...
    dataset
    {
        dataitem("DC Header"; "DC Header")
        {
            ...
            begin
                 ...
                 ZONE_NAME:='';
                 DIVISION.RESET;
                 DIVISION.SETRANGE(DIVISION."Division Code","DC Header"."Location Code");
                 IF DIVISION.FINDFIRST THEN
                 BEGIN
                  IF ZONE.GET(DIVISION."Zone code") THEN
