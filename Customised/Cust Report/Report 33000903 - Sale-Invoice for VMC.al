report 33000903 "Sale-Invoice for VMC"
{
    // version NAVW13.70,NAVIN3.70.00.13,sreenivas

    DefaultLayout = RDLC;
    RDLCLayout = './Sale-Invoice for VMC.rdlc';
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    dataitem("Sales Invoice Line";"Sales Invoice Line")
                    {
                        ...
                        column(DottedLine_Caption;DottedLine_CaptionLbl)
                        {
                        }
                        column(Exempted_CaptionLbl;Exempted_CaptionLbl)
                        {
                        }
                        ...
                        begin
                            ...
                            OR ("Sales Invoice Line"."Tax Group Code"='BOI-OVAT')OR ("Sales Invoice Line"."Tax Group Code"='BOI 1%')) THEN
                            BEGIN
                            ...
                            MESSAGE('%1==%2',LineTotAmt,TotalLineAmt);
                            ...
                            END;
                            IF ("Sales Invoice Line"."Tax Group Code"='LED-5%') THEN
                            BEGIN
                            ...
                            */
                            ...
                            //   tot[k][1]:=FORMAT("Sales Invoice Line"."Schedule No");
                               ...
                               IF "Sales Invoice Line"."Unit of Measure Code"='FTS' THEN
                            ...
                            //   tot[k][3]:=FORMAT("Sales Invoice Line".Quantity);
                               tot[k][4]:=FORMAT(ROUND("Sales Invoice Line"."Amount To Customer"/"Sales Invoice Line".Quantity,0.01));
                               tot[k][5]:=FORMAT(ROUND("Sales Invoice Line"."Amount To Customer",1))+'.00';
                            ...
                            /* // VISU
                            ExciseEntry.RESET;
                            ExciseEntry.SETCURRENTKEY(Type,"Document Type","Document No.","Posting Date","Item No.");
                            ...
                            ExciseEntry.SETRANGE("Posting Date","Sales Invoice Header"."Posting Date");
                            ExciseEntry.CALCSUMS(Amount);
                            
                            ExciseAmount := ExciseEntry.Amount;
                            LineTotAmt += ExciseAmount
                            */ // VISU
                            //SREENIVAS -EFF
                    ...
                    dataitem(Total;"Integer")
                    {
                        ...
                        column(Total_DottedLine_Caption;DottedLine_CaptionLbl)
                        {
                        }
    ...
    var
        ...
        CST_No__VJ2_07_1_1976_02_05_1988CaptionLbl : Label 'CST No.  28350166764 CST';
        ...
        Exempted_CaptionLbl : Label 'EXEMPTED VIDE NOTIFICATION NO.42/2001 - Central Excise ( N.T.) Dated 26th June 2001';
        DottedLine_CaptionLbl : Label '------------';
