report 50115 "Summary Aging of Customers"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Summary Aging of Customers.rdlc';
        ...
        dataitem(Customer;Customer)
        {
            ...
            begin
                ...
                //FOR i := 1 TO 5 DO BEGIN
                  ...
                  IF custbalance>100 THEN
                  BEGIN
                   IF (Customer."Customer Posting Group"='PRIVATE') OR (Customer."Customer Posting Group"='OTHERS') THEN
                    BEGIN
                    ...
                    END;
                   IF  Customer."Customer Posting Group"='RAILWAYS' THEN
                    BEGIN
                     PeriodStartDate:=StartDate-270;
                     IF PeriodStartDate<(040108D) THEN
                     PeriodStartDate:=040108D;
                    // DtldCustLedgEntry.SETRANGE("Initial Entry Due Date",PeriodStartDate,StartDate);
                    DtldCustLedgEntry.SETRANGE("Posting Date",PeriodStartDate,StartDate);
                     DtldCustLedgEntry.CALCSUMS("Debit Amount");
                     ...
                     CustBalanceDueLCY2:=custbalance;
                     IF CustBalanceDueLCY1=custbalance THEN
                     BEGIN
                     ...
                     CustBalanceDueLCY1:=custbalance;
                          END;
                    END;
                    IF (Customer."Customer Posting Group"='RAILWAYS') AND (CustBalanceDueLCY1<custbalance) THEN
                    BEGIN
                    ...
                    AND (CustBalanceDueLCY1<custbalance)) THEN
                    BEGIN
