report 50050 "Explosion Of Prod. BOM"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Explosion Of Prod. BOM.rdlc';
        ...
        dataitem("Production BOM Header"; "Production BOM Header")
        {
            ...
            dataitem("<Production BOM Line3>"; "Production BOM Line")
            {
                ...
                begin
                    ...
                    ELSE IF Fill_Form_ChoiceDIP THEN
            ...
            dataitem("Bin Type";"Bin Type")
            {
                ...
                begin
                    ...
                    IF (ChoiceItem)  THEN BEGIN
                      Item.RESET;
                      IF Item.GET("Bin Type"."Item No") THEN
                      BEGIN
                        UC:=Item."Item Final Cost";
            ...
            dataitem("<Production BOM Line1>";"Production BOM Line")
            {
                ...
                dataitem("<Production BOM Line6>";"Production BOM Line")
                {
                    ...
                    begin
                        Total:=0;
                        TUC2:=0;
                        ActiveVersionCode1 := VersionMgt.GetBOMVersion("<Production BOM Line6>"."No.",WORKDATE,TRUE);
                ...
                dataitem("<Production BOM Line2>";"Production BOM Line")
                {
                            ...
                            begin
                                ...
                                IF PBML.FIND('-') THEN BEGIN
                                  ...
                                  IF (Want_Excel) AND (ExcelVar = 2) THEN BEGIN
                                    ...
                                    EnterHeadings(ROW,6,'Item category code',TRUE,Tempexcelbuffer."Cell Type" :: Text);
                    ...
                    begin
                        ...
                        Total:=0;
                        TUC2:=0;
                        ActiveVersionCode1 := VersionMgt.GetBOMVersion("<Production BOM Line1>"."No.",WORKDATE,TRUE);
            ...
            trigger OnAfterGetRecord();
            begin
                ActiveVersionCode := VersionMgt.GetBOMVersion("Production BOM Header"."No.",WORKDATE,TRUE);
...
=CONST(Production BOM Header));
        ...
        dataitem("Tender Header";"Tender Header")
        {
            ...
            ReqFilterHeading = 'Enquriy Response Time (Tender)';
        ...
        dataitem("Sales Header";"Sales Header")
        {
            ...
            ReqFilterHeading = 'Enquriy Response Time (Quote)';
    ...
    var
        ...
        Item_Category_CodeCaption_Control1102154115Lbl : Label 'Item Category Code';
    ...
    begin
        ActiveVersionCode := VersionMgt.GetBOMVersion(BOM,WORKDATE,TRUE);
        ...
        REPEAT
          IF NOT BOM_Header.GET(BOM_Line."No.") THEN
          BEGIN
