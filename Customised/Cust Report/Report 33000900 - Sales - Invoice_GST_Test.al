report 33000900 "Sales - Invoice_GST_Test"
{
    // version NAVW19.00.00.48628,NAVIN9.00.00.48628,sreenivas,KKC

    DefaultLayout = RDLC;
    RDLCLayout = './Sales - Invoice_GST_Test.rdlc';
        ...
        dataitem("Sales Invoice Header";"Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    dataitem("Sales Invoice Line";"Sales Invoice Line")
                    {
                        ...
                        column(formatadress_ChangeCurrency_ROUND_LineTotAmt_roundoff_1_____00_;formatadress.ChangeCurrency(ROUND(LineTotAmt+roundoff,1)))
                        {
                        }
                        ...
                        column(DataItem1102152012;Certified_that_the_Particulars_given_above_are_true_and_correct_and_the_amount_indicated_represents_the_price_actually_chargeLbl)
                        {
                        }
                        column(Rupees__in_Words__Caption;Rupees__in_Words__CaptionLbl)
                        {
                        }
                        column(DataItem1102152010;For_Efftronics_Systems__P__Ltd_______________________________________________________________________________________________Lbl)
                        {
                        }
                        ...
                        begin
                            ...
                            IF ("Sales Invoice Line"."Tax Area Code"='SALES CST')AND("Sales Invoice Line"."Amount To Customer"<>0) THEN
                            BEGIN
                            ...
                            IF ("Sales Invoice Line"."Tax Area Code"='SALES VAT')AND("Sales Invoice Line"."Amount To Customer"<>0) THEN
                            BEGIN
                            ...
                            OR ("Sales Invoice Line"."Tax Group Code"='BOI-O 12.5') ) THEN
                            BEGIN
                            ...
                            IF (Type = Type::"G/L Account") AND (NOT ShowInternalInfo) THEN
                              "No." := '';
                             //SREENIVAS -EFF
                            IF ("Sales Invoice Line"."Tax Group Code"='MPBI') OR ("Sales Invoice Line"."Tax Group Code"='MPBIVAT')  THEN
                            BEGIN
                              s:='84711000';
                              capt:='(Microprocessor based data acquisition&control system)';
                            END;
                            IF COPYSTR("Sales Invoice Line"."Tax Group Code",1,3)='LED' THEN
                            BEGIN
                              IF("Sales Invoice Line"."Excise Prod. Posting Group"='94054090') THEN
                              BEGIN
                                s:='94054090';
                                capt:='(LED Lighting)';
                              END;
                              IF("Sales Invoice Line"."Excise Prod. Posting Group"='90221900')THEN
                              BEGIN
                                s:='90221900';
                                capt:='(X-Ray Viewer)';
                              END;
                              IF("Sales Invoice Line"."Excise Prod. Posting Group"='LED_MRP') THEN
                              BEGIN
                                IF Itm.GET("Sales Invoice Line"."No.") THEN
                                BEGIN
                                  IF Itm."Gen. Prod. Posting Group" = 'X-RAY VIEW' THEN
                                  BEGIN
                                    s:='90221900';
                                    capt:='(X-Ray Viewer)';
                                  END ELSE
                              ...
                              END;
                            END;
                            IF("Sales Invoice Line"."Excise Prod. Posting Group"='85414020')THEN
                            BEGIN
                              s:='85414020';
                              capt:='(Electronic Moving Display unit for information Text)';
                            END;
                            
                            IF("Sales Invoice Line"."Excise Prod. Posting Group"='85481090')THEN
                            BEGIN
                              s:='85481090';
                            ...
                            "Sales Invoice Line"."Tax Group Code"='BOI-O 4%')OR("Sales Invoice Line"."Tax Group Code"='BOI-O 5%')) THEN
                            BEGIN
                              bedamt:=0;
                              cessamt:=0;
                              ecessamt:=0;
                            ...
                            //  bedamt:=bedamt+(LineAmt*(bed)/100);
                              ...
                              IF "Sales Invoice Header"."Posting Date" < DMY2DATE(1,3,2015) THEN
                              BEGIN
                            ...
                            IF "Sales Invoice Line"."Tax Liable" =FALSE THEN
                            BEGIN
                            ...
                            Capt12:='';
                            IF "Sales Invoice Line"."Sell-to Customer No."='CUST00464' THEN
                            BEGIN
                              Capt12:='UNDER NOTIFICATION NO:10/97- CENTRAL EXCISE DT:01.03.97';
                            END;
                            IF "Sales Invoice Header"."No."='EX-INV-14-15-00611' THEN
                            BEGIN
                            ...
                            END;
                            IF "Sales Invoice Header"."No."='EX-INV-14-15-00674' THEN
                            BEGIN
                            ...
                            //   tot[k][1]:=FORMAT("Sales Invoice Line"."Schedule No");
                               ...
                               */   // Commented by Pranavi on 20-Jan-2016 to generalize
                               ...
                               IF "Sales Invoice Header"."Order No."='EFF/SAL/13-14/150' THEN
                               BEGIN
                            ...
                            //   tot[k][3]:=FORMAT("Sales Invoice Line".Quantity);
                              //Added by Pranavi on 23-Dec-2015
                               IF MRP = FALSE THEN BEGIN
                                ...
                                tot[k][4]:=formatadress.ChangeCurrency(ROUND(UnitPriceIncDiscnt,0.001));
                                Tot_1_4:=formatadress.ChangeCurrency(ROUND(UnitPriceIncDiscnt,0.001));
                                //tot[k][4]:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."Unit Price",0.001));  //commented by pranavi on 23-Dec-2015
                               END ELSE BEGIN
                                tot[k][4]:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line".Quantity*"Sales Invoice Line"."MRP Price",0.001));
                                Tot_1_4:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line".Quantity*"Sales Invoice Line"."MRP Price",0.001));
                               END;
                               //Added by Pranavi on 23-Dec-2015
                               ...
                               IF MRP = FALSE THEN BEGIN
                                ...
                                Tot_1_5:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."Line Amount",1))+'.00';
                                // tot[k][6]:=FORMAT("Sales Invoice Line"."Schedule No");
                               END ELSE BEGIN
                                tot[k][5]:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line".Quantity*("Sales Invoice Line"."MRP Price"*(100-"Sales Invoice Line"."Line Discount %")/100),1))+'.00';
                                Tot_1_5:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line".Quantity*("Sales Invoice Line"."MRP Price"*(100-"Sales Invoice Line"."Line Discount %")/100),1))+'.00';
                                tot[k][7]:=formatadress.ChangeCurrency(ROUND(("Sales Invoice Line".Quantity*"Sales Invoice Line"."MRP Price")*("Sales Invoice Line"."Line Discount %")/100,1))+'.00';
                                Tot_1_7:=formatadress.ChangeCurrency(ROUND(("Sales Invoice Line".Quantity*"Sales Invoice Line"."MRP Price")*("Sales Invoice Line"."Line Discount %")/100,1))+'.00';
                               END;
                               ...
                               BEGIN
                                ...
                                tot[k][4]:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."Unit Price",0.001));   // unit price
                                Tot_1_4:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."Unit Price",0.001));   // unit price
                                tot[k][5]:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line".Quantity*"Sales Invoice Line"."Unit Price",1));
                                Tot_1_5:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line".Quantity*"Sales Invoice Line"."Unit Price",1));
                                IF "Sales Invoice Line"."Line Discount %" <> 0 THEN
                                BEGIN
                                  tot[k][7]:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."Line Amount",1));
                                  Tot_1_7:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."Line Amount",1));
                                END;
                            
                            
                                IF ("Sales Invoice Line"."GST Jurisdiction Type" = "Sales Invoice Line"."GST Jurisdiction Type"::Interstate) THEN
                                BEGIN
                                  tot[k][8]:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."GST %",1))+'%';
                                  Tot_1_8:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."GST %",1))+'%';
                                  IF Tot_1_8 = '0%' THEN
                                    Tot_1_8 := '';
                                  tot[k][9]:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."Total GST Amount",1));
                                  Tot_1_9:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."Total GST Amount",1));
                                  IF Tot_1_9 IN['0','0.00'] THEN
                                    Tot_1_9 := '';
                                  Totals[6]+=ROUND("Sales Invoice Line"."Total GST Amount",1);  //pranavi
                                END ELSE
                                BEGIN
                                  tot[k][10]:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."GST %"/2,1))+'%';
                                  Tot_1_10:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."GST %"/2,1))+'%';
                                  IF Tot_1_10 = '0%' THEN
                                    Tot_1_10 := '';
                                  tot[k][11]:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."Total GST Amount"/2,1));
                                  Tot_1_11:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."Total GST Amount"/2,1));
                                  IF Tot_1_11 IN['0','0.00'] THEN
                                    Tot_1_11 := '';
                                  Totals[5]+=ROUND("Sales Invoice Line"."Total GST Amount"/2,1);  //pranavi
                                END;
                                tot[k][12]:="Sales Invoice Line"."HSN/SAC Code";
                                Tot_1_12:="Sales Invoice Line"."HSN/SAC Code";
                                tot[k][13]:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."Amount To Customer",1));
                                Tot_1_13:=formatadress.ChangeCurrency(ROUND("Sales Invoice Line"."Amount To Customer",1));
                            
                                Totals_Txt[1]:=formatadress.ChangeCurrency(ROUND(Totals[1],1));
                                Totals_Txt[2]:=formatadress.ChangeCurrency(ROUND(Totals[2],1));
                                Totals_Txt[3]:=formatadress.ChangeCurrency(ROUND(Totals[3],1));
                                Totals_Txt[4]:=formatadress.ChangeCurrency(ROUND(Totals[4],1));
                                Totals_Txt[5]:=formatadress.ChangeCurrency(ROUND(Totals[5],1));
                                Totals_Txt[6]:=formatadress.ChangeCurrency(ROUND(Totals[6],1));
                                Totals_Txt[7]:=formatadress.ChangeCurrency(ROUND(Totals[7],1));
                                Totals_Txt[8]:=formatadress.ChangeCurrency(ROUND(Totals[8],1));
                               END;
                               // end by pranavi
            ...
            begin
                ...
                */
                ...
                REPEAT
                  IF (SIL1."MRP Price" > 0) AND SIL1.MRP THEN
                  BEGIN
                    MRP := TRUE;
                ...
                */
                ...
                BEGIN
                  IF StateGRec.GET(Loc."State Code") THEN
                  BEGIN
                ...
                BEGIN
                  IF StateGRec.GET(Customer."State Code") THEN
                  BEGIN
    ...
    var
        ...
        waybillno : Code[10];
        caplabel1 : Text[30];
        d1 : array [20] of Text[300];
        tot : array [20,13] of Text[30];
        k : Integer;
        ...
        Unit_PriceCaptionLbl : Label 'Unit Price(Rs)';
        ...
        C_E__RegN__No__AAACE4879QXM001___________________________________________E_C__Code_No__AAACE_4879Q_XM001_Range_IV_divn_VijayaLbl : Label 'C.E. RegN. No. AAACE4879QXM001';
