report 50037 Productvity
{
    ...
    dataset
    {
        ...
        dataitem("<Capacity Ledger Entry1>";"Capacity Ledger Entry")
        {
            ...
            begin
                ...
                Card_Filters:= "<Capacity Ledger Entry1>".GETFILTERS;
                 IF "<Capacity Ledger Entry1>".GETFILTER("<Capacity Ledger Entry1>"."Posting Date")<>'' THEN
                 BEGIN
        ...
        dataitem("<Capacity Ledger Entry2>";"Capacity Ledger Entry")
        {
            ...
            begin
                 IF "<Capacity Ledger Entry2>"."Work Center No."='P1' THEN
                 BEGIN
                   ...
                   ActualValue[1][DATE2DMY("<Capacity Ledger Entry2>"."Posting Date",2)]+="<Capacity Ledger Entry2>"."Actual Run Time"
                                                                                           *"<Capacity Ledger Entry2>"."Work Center Unit Cost" ;
                 END ELSE IF "<Capacity Ledger Entry2>"."Work Center No."='P2' THEN
                 BEGIN
                 ...
                 END ELSE IF "<Capacity Ledger Entry2>"."Work Center No."='P3' THEN
                 BEGIN
                 ...
                 END ELSE IF "<Capacity Ledger Entry2>"."Work Center No."='P4' THEN
                 BEGIN
                 ...
                 END ELSE IF "<Capacity Ledger Entry2>"."Work Center No."='PSD' THEN
                 BEGIN
                 ...
                 END ELSE IF "<Capacity Ledger Entry2>"."Work Center No."='MPR' THEN
                 BEGIN
                 ...
                 END ELSE IF "<Capacity Ledger Entry2>"."Work Center No."='QAS' THEN
                 BEGIN
                 ...
                 END ELSE IF "<Capacity Ledger Entry2>"."Work Center No."='SHF' THEN
                 BEGIN
