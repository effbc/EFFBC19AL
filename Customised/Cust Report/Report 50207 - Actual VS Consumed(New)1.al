report 50207 "Actual VS Consumed(New)1"
{
    // version NAVW13.70,Rev01,EFFUPG

    DefaultLayout = RDLC;
    RDLCLayout = './Actual VS Consumed(New)1.rdlc';
    ...
    dataset
    {
        dataitem("Sales Shipment Line";"Sales Shipment Line")
        {
                                ...
                                dataitem("Posted Material Issues Line";"Posted Material Issues Line")
                                {
                                    ...
                                    begin
                                        ...
                                        // VERIFY THAT WHETHER IN SALE ORDER  OR NOT
                                           ...
                                           Sales_Shipment_Line2.SETRANGE("Order No.","Sales Shipment Line"."Order No.");
                                           Sales_Shipment_Line2.SETRANGE("No.","Posted Material Issues Line"."Item No.");
            ...
            begin
                ...
                NEW_ORDER:=FALSE;
                IF PREV_SAL_ORDER<>"Sales Shipment Line"."Order No." THEN
                BEGIN
                  NEW_ORDER:=TRUE;
