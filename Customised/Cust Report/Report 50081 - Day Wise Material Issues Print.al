report 50081 "Day Wise Material Issues Print"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Day Wise Material Issues Print.rdlc';
    ...
    dataset
    {
                ...
                dataitem("Item Ledger Entry";"Item Ledger Entry")
                {
                    ...
                    begin
                        IF (Choice<>Choice::Issue) THEN
                          CurrReport.BREAK
                        ELSE IF (Choice=Choice::Issue) AND Pick THEN
                          CurrReport.BREAK;
                    end;
                }
                ...
                begin
                    ...
                    */
                    ...
                    BEGIN
                      ...
                      END;
                    END
                    ELSE IF (Choice=Choice::SETSM) AND Pick THEN
                    BEGIN
                      IF "Posted Material Issues Line".Quantity > 0 THEN
                      BEGIN
                        PCL.RESET;
                    ...
                    //     ELSE MESSAGE('NOT MATCH! '+FORMAT(PCL."BOM Type")+', me/WR: '+FORMAT("ME/WR")+', '+PCL."Item No.");
                       END;
                    END
                    ELSE IF (Choice=Choice::Sets) AND Pick THEN
                    BEGIN
                      IF "Posted Material Issues Line".Quantity > 0 THEN
                      BEGIN
                        PCL.RESET;
                    ...
                    IF "Posted Material Issues Line"."Item No." <> '' THEN
                    BEGIN
                      Item_Dummy.RESET;
                      Item_Dummy.SETRANGE(Item_Dummy."No.","Posted Material Issues Line"."Item No.");
                      IF NOT Item_Dummy.FINDFIRST THEN
                      BEGIN
                        Item_Dummy.INIT;
            ...
            begin
                  ...
                  */
                  IF Not_Consider_Pcb THEN
                    "<Item Ledger Entry1>".SETFILTER("<Item Ledger Entry1>"."Product Group Code",'<>%1','PCB');
                  IF Only_Pcb THEN
                      "<Item Ledger Entry1>".SETFILTER("<Item Ledger Entry1>"."Product Group Code",'PCB');
            ...
            begin
                ...
                BEGIN
                  ...
                  IF Only_Pcb AND (COPYSTR(PostMaterialQry.Item_No,1,5)<>'ECPCB') THEN
                    CurrReport.SKIP;
                  item.RESET;
                  IF item.GET(PostMaterialQry.Item_No) THEN
                  BEGIN
                ...
                //    MESSAGE(Item_Test+', '+temp11+', '+FORMAT(Item_Count));
                 ...
                 /* IF prevdept<>PostMaterialQry.Dept1 then
                  BEGIN
                    ...
                    END;
                  END;   */
                  IF prevdate<>PostMaterialQry.Material_Requisition_Date1 THEN
                  BEGIN
                    IF ISSERVICETIER THEN BEGIN
                       PageGroupNo += 1;
                    END;
        ...
        dataitem("Mech & Wirning Items";"Mech & Wirning Items")
        {
            ...
            begin
                ...
                IF ProdOrdrComp.FINDFIRST THEN
                BEGIN
                ...
                IF Prev_ItemNo <>  "Mech & Wirning Items"."Item No." THEN
                BEGIN
                  Mech_i+=1;
        ...
        dataitem("<Material Issues Line1>";"Material Issues Line")
        {
            ...
            begin
                ...
                IF Prev_ItemNo <>  "<Material Issues Line1>"."Item No." THEN
                BEGIN
                  MWshortgCount+=1;
                  Tot_Qty:=QTY;
                  QTY:=0;
                ...
                group(Options)
                {
                    grid(Control1102152006)
                    {
                        ...
                        group(Control1102152007)
                        {
                            ...
                            field(Control1102152009;'')
                            {
                                ShowCaption = false;
                            }
                            field(Control1102152010;'')
                            {
                                ShowCaption = false;
                            }
                            field(Control1102152011;'')
                            {
                                ShowCaption = false;
                            }
