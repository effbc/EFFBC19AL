report 33000910 "Service & Req. Excel"
{
    ...
    //       DD               Dispatch Date
    DefaultLayout = RDLC;
    RDLCLayout = './Service & Req. Excel.rdlc';
    ...
    dataset
    {
        dataitem("Service Header"; "Service Header")
        {
            ...
            dataitem("Service Item Line"; "Service Item Line")
            {
                ...
                dataitem("Service Line";"Service Line")
                {
                    ...
                    begin
                          IF EXCEL AND ("Service Line".Type="Service Line".Type::Item) AND (Choice<>Choice::PC) THEN
                          BEGIN
                            IF J<>0 THEN
                            BEGIN
                              Row+=1;
                            ...
                            BEGIN
                              ...
                              IF PMIH.FINDFIRST THEN
                              REPEAT
                                IF PMIH."Service Order No."<>"Service Header"."No." THEN
                                BEGIN
                                  ILE.RESET;
                                  ILE.SETFILTER(ILE."Entry Type",'%1',4);
                                  ILE.SETFILTER(ILE."Item No.","Service Line"."No.");
                          ...
                          IF EXCEL AND ("Service Line".Type="Service Line".Type::Resource) AND (Choice<>Choice::PC) THEN
                          BEGIN
                            test1:=0;
                            ServiceLine.RESET;
                            ServiceLine.SETFILTER(ServiceLine."Document No.","Service Line"."Document No.");
                ...
                begin
                      ...
                      IF "Service Item Line"."To Location" <>'' THEN
                      BEGIN
                        ILE.RESET;
                        ILE.SETFILTER(ILE."Item No.","Service Item Line"."Item No.");
                        ILE.SETRANGE(ILE."Serial No.","Service Item Line"."Serial No.");
                        ...
                        IF ILE.FINDFIRST THEN
                        BEGIN
                          IF  (ILE."Location Code" ='SITE') OR (ILE."Location Code" ='CS') THEN
                          BEGIN
                            DV.RESET;
                      ...
                      BEGIN
                        ...
                        IF "Manf.Date"<>0D THEN
                          Entercell(Row,9,FORMAT("Manf.Date"),FALSE,Tempexcelbuffer."Cell Type" :: Date);
                        IF "Service Item Line"."Finishing Date" <>0D THEN
                        BEGIN
                          Entercell(Row,22,FORMAT("Service Item Line"."Finishing Date"),FALSE,Tempexcelbuffer."Cell Type" :: Date);
        ...
        dataitem("Material Issues Header";"Material Issues Header")
        {
            ...
            begin
                ...
                REPEAT
                  ...
                  IF (Choice=Choice::REQ) OR (Choice=Choice::REQ_TOT) THEN
                  BEGIN
                    Row+=1;
            ...
            begin
                ...
                CurrReport.BREAK;
                IF EXCEL AND((Choice=Choice::REQ) OR (Choice=Choice::REQ_TOT)) THEN
                BEGIN
                  Row:=1;
        ...
        dataitem("Posted Material Issues Header";"Posted Material Issues Header")
        {
            ...
            begin
                ...
                IF EXCEL AND ((Choice=Choice::REQ_1) OR (Choice=Choice::REQ_TOT))  THEN
                BEGIN
            ...
            begin
                ...
                REPEAT
                  ...
                  REPEAT
                    ...
                    BEGIN   // <<Added by Pranavi on 01-06-2017
                      ServiceLine.RESET;
                      ...
                      BEGIN
                        ...
                        IF service_item.GET(PMIH."Service Item") THEN
                        BEGIN
