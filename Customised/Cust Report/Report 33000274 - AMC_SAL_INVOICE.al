...
{
    // version NAVW19.00.00.49326,NAVIN9.00.00.49326,sreenivas,KKC

    DefaultLayout = RDLC;
    RDLCLayout = './AMC_SAL_INVOICE.rdlc';
    ...
    dataset
    {
        dataitem("Sales Invoice Header";"Sales Invoice Header")
        {
                            ...
                            //   tot[k][3]:=FORMAT("Sales Invoice Line".Quantity);
                              //Added by Pranavi on 23-Dec-2015
                               ...
                               BEGIN
                                ...
                                Totals_Txt[7]:=formatadress.ChangeCurrency(Totals[7]);
            ...
            trigger OnAfterGetRecord();
            begin
                IF ("Sales Invoice Header"."Currency Code" = 'USD') THEN
                  BEGIN
                  Amount_type := 'Dollars';
