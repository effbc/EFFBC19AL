report 32000002 "GL Entries Dim Correction"
{
    // version ONETIME
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './GL Entries Dim Correction.rdlc';
    ...
    dataset
    {
        dataitem("G/L Entry";"G/L Entry")
        {
            ...
            begin
                ...
                DimensionSetEntryBackup.SETRANGE("Dimension Set ID","G/L Entry"."OLD Dim Set ID");
                ...
                IF NewDimSetID <> 0 THEN BEGIN
                  "G/L Entry"."Dimension Set ID" :=  NewDimSetID;
                  "G/L Entry"."Dimension Corrected"   := TRUE;
                  MODIFY;
                END;
            end;
            ...
            begin
                SETFILTER("Dimension Corrected",'%1',FALSE);
                SETFILTER("OLD Dim Set ID",'<>%1',0);
