...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Day Wise Issues New.rdlc';
    ...
    dataset
    {
        dataitem("Posted Material Issues Line";"Posted Material Issues Line")
        {
            ...
            begin
                ...
                BEGIN
                  ...
                  ELSE IF MechOrWring IN['Testing','TESTING'] THEN
                    HeaderDesc:='Testing Sets for '+ProdBOMDesc
                  ELSE IF MechOrWring IN['Packing','PACKING'] THEN
        ...
        dataitem("Material Issues Line";"Material Issues Line")
        {
            ...
            begin
                ...
                ELSE IF MMechOrWring IN['Testing','TESTING'] THEN
                  MHeaderDesc:='Wiring Sets for '+ProdBOMDesc
                ELSE IF MMechOrWring IN['Packing','PACKING'] THEN
                  MHeaderDesc:='Wiring Sets for '+ProdBOMDesc
                ELSE
