            ...
            dataitem("<Routing Line1>";"Routing Line")
            {
                ...
                begin
                    // <Routing Line1>, Body (2) - OnPreSection() >>
                      ...
                      ELSE IF "<Routing Line1>".Description='SHOP FLOOR' THEN
                           Totals1[4]+="<Routing Line1>"."Run Time"
                      ELSE IF "<Routing Line1>".Description='QUALITY CONTROL' THEN
                      ...
                      ELSE
                       ...
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='CHW' THEN
                           Totals[2]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='CSA' THEN
                           Totals[3]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='CSM' THEN
                           Totals[4]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='CST' THEN
                           Totals[5]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='DES' THEN
                           Totals[6]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='MCH' THEN
                           Totals[7]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='MPR' THEN
                           Totals[8]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='P1' THEN
                           Totals[9]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='P2' THEN
                           Totals[10]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='P3' THEN
                           Totals[11]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='P4' THEN
                           Totals[12]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='PSD' THEN
                           Totals[13]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='QAS' THEN
                           Totals[14]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='RHW' THEN
                           Totals[15]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='SHF' THEN
                           Totals[16]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='STR' THEN
                           Totals[17]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='WAIT TIME' THEN
                           Totals[18]+="<Routing Line1>"."Run Time"
                       ELSE IF "<Routing Line1>"."Work Center Group Code"='OTHER DEPT' THEN
                            BEGIN
                            ...
                            END
                      ELSE IF "<Routing Line1>"."Work Center Group Code"= 'OUT SOURCE' THEN // added by vishnu Priya on 15-05-2020 for the testing
                          Totals[19]+="<Routing Line1>"."Run Time"
                      ELSE IF "<Routing Line1>"."Work Center Group Code"='DIS' THEN
                           Totals[20]+="<Routing Line1>"."Run Time"
                      ELSE IF "<Routing Line1>"."Work Center Group Code"='TCE' THEN
                           Totals[24]+="<Routing Line1>"."Run Time"
                      ELSE IF "<Routing Line1>"."Work Center Group Code"='TST' THEN
                           Totals[25]+="<Routing Line1>"."Run Time"
                      ELSE IF "<Routing Line1>"."Work Center Group Code"='WIR' THEN
                ...
                dataitem("Routing Line";"Routing Line")
                {
                    ...
                    begin
                        ...
                        //}
                          ...
                          ELSE IF "Routing Line".Description='SHOP FLOOR' THEN
                               Totals1[4]+="Production BOM Line".Quantity*"Routing Line"."Run Time"
                          ELSE IF "Routing Line".Description='QUALITY CONTROL' THEN
                          ...
                          ELSE
                           ...
                           ELSE IF "Routing Line"."Work Center Group Code"='OTHER DEPT' THEN
                                ...
                                END
                          ELSE IF "Routing Line"."Work Center Group Code"='OUT SOURCE' THEN // added by vishnu on 15-05-2020
                               Totals[19]+="Production BOM Line".Quantity*"Routing Line"."Run Time"
                          ELSE IF "Routing Line"."Work Center Group Code"='DIS' THEN
                               Totals[20]+="Production BOM Line".Quantity*"Routing Line"."Run Time"
                          ELSE IF "Routing Line"."Work Center Group Code"='TCE' THEN
                               Totals[24]+="Production BOM Line".Quantity*"Routing Line"."Run Time"
                          ELSE IF "Routing Line"."Work Center Group Code"='TST' THEN
                               Totals[25]+="Production BOM Line".Quantity*"Routing Line"."Run Time"
                          ELSE IF "Routing Line"."Work Center Group Code"='WIR' THEN
                    ...
                    dataitem("<Routing Line2>";"Routing Line")
                    {
                        ...
                        begin
                            ...
                            END;
                              ...
                              ELSE IF "<Routing Line2>".Description='SHOP FLOOR' THEN
                                   Totals1[4]+="<Production BOM Line2>".Quantity*"<Routing Line2>"."Run Time"
                              ELSE IF "<Routing Line2>".Description='QUALITY CONTROL' THEN
                              ...
                              ELSE
                               ...
                               ELSE IF "<Routing Line2>"."Work Center Group Code"='OTHER DEPT' THEN
                                    ...
                                    END
                              ELSE IF "<Routing Line2>"."Work Center Group Code"='OUT SOURCE' THEN //ADDED BY VISHNU PRIYA ON 15-05-2020
                                   Totals[19]+="Production BOM Line".Quantity*"<Production BOM Line2>".Quantity*"<Routing Line2>"."Run Time"
                              ELSE IF "<Routing Line2>"."Work Center Group Code"='DIS' THEN
                                   Totals[20]+="Production BOM Line".Quantity*"<Production BOM Line2>".Quantity*"<Routing Line2>"."Run Time"
                              ELSE IF "<Routing Line2>"."Work Center Group Code"='TCE' THEN
                                   Totals[24]+="Production BOM Line".Quantity*"<Production BOM Line2>".Quantity*"<Routing Line2>"."Run Time"
                              ELSE IF "<Routing Line2>"."Work Center Group Code"='TST' THEN
                                   Totals[25]+="Production BOM Line".Quantity*"<Production BOM Line2>".Quantity*"<Routing Line2>"."Run Time"
                              ELSE IF "<Routing Line2>"."Work Center Group Code"='WIR' THEN
                        ...
                        dataitem("<Routing Line3>";"Routing Line")
                        {
                            ...
                            begin
                                ...
                                END;
                                  ...
                                  ELSE IF "<Routing Line3>".Description='SHOP FLOOR' THEN
                                       Totals1[4]+="<Production BOM Line3>".Quantity*"<Routing Line3>"."Run Time"
                                  ELSE IF "<Routing Line3>".Description='QUALITY CONTROL' THEN
                                  ...
                                  ELSE
                                   ...
                                   ELSE IF "<Routing Line3>"."Work Center Group Code"='P3' THEN
                                   ...
                                   ELSE IF "<Routing Line3>"."Work Center Group Code"='P4' THEN
                                   ...
                                   ELSE IF "<Routing Line3>"."Work Center Group Code"='PSD' THEN
                                   ...
                                   ELSE IF "<Routing Line3>"."Work Center Group Code"='QAS' THEN
                                   ...
                                   ELSE IF "<Routing Line3>"."Work Center Group Code"='RHW' THEN
                                   ...
                                   ELSE IF "<Routing Line3>"."Work Center Group Code"='SHF' THEN
                                   ...
                                   ELSE IF "<Routing Line3>"."Work Center Group Code"='STR' THEN
                                   ...
                                   ELSE IF "<Routing Line3>"."Work Center Group Code"='WAIT TIME' THEN
                                   ...
                                   ELSE IF "<Routing Line3>"."Work Center Group Code"='OTHER DEPT' THEN
                                        BEGIN
                                        ...
                                        END
                                  ELSE IF "<Routing Line3>"."Work Center Group Code"='OUT SOURCE' THEN //ADDED BY VISHNU PRIYA ON 15-05-2020
                                       Totals[19]+="Production BOM Line".Quantity*"<Production BOM Line2>".Quantity*"<Production BOM Line3>".Quantity*"<Routing Line3>"."Run Time"
                                  ELSE IF "<Routing Line3>"."Work Center Group Code"='DIS' THEN
                                  ...
                                  ELSE IF "<Routing Line3>"."Work Center Group Code"='TCE' THEN
                                  ...
                                  ELSE IF "<Routing Line3>"."Work Center Group Code"='TST' THEN
                                  ...
                                  ELSE IF "<Routing Line3>"."Work Center Group Code"='WIR' THEN
            ...
            begin
                ...
                BEGIN
                  ...
                  BEGIN
                    IF ISG <> '' THEN
                    BEGIN
                      IF ISG = Itm."Item Sub Group Code" THEN
                      BEGIN
                        IF ISSG <> '' THEN
                        BEGIN
                ...
                END
                ELSE IF EXCEL AND (Choice=Choice::Brief) THEN   //Added by pranavi on16-mar-2016
                BEGIN
                  Itm.RESET;
                  Itm.SETRANGE(Itm."No.","Production BOM Header"."No.");
                  IF Itm.FINDFIRST THEN
            ...
            begin
                ...
                */
                // Production BOM Header, GroupFooter (5) - OnPreSection() >>
                  ...
                  END
                  ELSE IF EXCEL AND (Choice=Choice::Brief) THEN
                  BEGIN
                    Row+=1;
                    ColNo+=1;
                    ...
                    field(ISSG;ISSG)
                    {
                        ...
                        begin
                            ...
                            IF PAGE.RUNMODAL(60055,IssgRec) = ACTION :: LookupOK THEN
                              ISSG := IssgRec.Code;
                            END
                            ELSE ERROR('Please select Item Sub Group Code first!');
                        end;
                    }
