        ...
        dataitem("Production BOM Header"; "Production BOM Header")
        {
            ...
            dataitem("Production BOM Line"; "Production BOM Line")
            {
                ...
                dataitem("<Production BOM Line1>"; "Production BOM Line")
                {
                    ...
                    begin
                        IF choice = choice::PROD THEN BEGIN
                            IF item.GET("<Production BOM Line1>"."No.") THEN BEGIN
                                IF PBMH2.GET("<Production BOM Line1>"."No.") THEN BEGIN
                        ...
                        END ELSE BEGIN
                            IF item.GET("<Production BOM Line1>"."No.") THEN BEGIN
                                IF (item."Product Group Code" = 'CPCB') OR (item."Product Group Code" = 'FPRODUCT') THEN BEGIN
                                    TPROD := 0;
                                    TSHF := 0;
                                    TQAS := 0;
                                    TMPR := 0;
                                        ...
                                        IF (item."Product Group Code" = 'CPCB') OR (item."Product Group Code" = 'FPRODUCT') THEN BEGIN
                                            ...
                                            IF RoutLine.FIND('-') THEN BEGIN
                                                REPEAT
                                                    CASE RoutLine."No." OF
                                                        'MPR':
                                                            TMPR += RoutLine."Run Time";
                                                        'SHF':
                                                            TSHF += RoutLine."Run Time";
                                                        'QAS':
                                                            TQAS += RoutLine."Run Time";
                                                        'P1' .. 'P4':
                                                            TPROD += RoutLine."Run Time";
                                                    END;
                                                ...
                                                IF PBML.FIND('-') THEN BEGIN
                                                    ...
                                                    IF RoutLine.FIND('-') THEN
                                                        REPEAT
                                                            CASE RoutLine."No." OF
                                                                'MPR':
                                                                    TMPR1 += RoutLine."Run Time";
                                                                'SHF':
                                                                    TSHF1 += RoutLine."Run Time";
                                                                'QAS':
                                                                    TQAS1 += RoutLine."Run Time";
                                                                'P1' .. 'P4':
                                                                    TPROD1 += RoutLine."Run Time";
                                                            END;
                                                        UNTIL RoutLine.NEXT = 0;
                                                    T1 := TMPR1 / 60;
                                                    T2 := TSHF1 / 60;
                ...
                begin
                    ...
                    TOT_DIP := 0;
                    IF choice = choice::PROD THEN BEGIN
                        IF itemrec.GET("Production BOM Line"."No.") THEN BEGIN
