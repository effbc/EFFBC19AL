report 80009 "Shortage Authorisation Report3"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Shortage Authorisation Report3.rdlc';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING(Product,Production Order No.) ORDER(Ascending) WHERE(Authorisation=FILTER(WAP|WFA|Authorised|indent),Shortage=FILTER(>0),Sales Order No.=FILTER(<>''));
        ...
        {
            DataItemTableView = SORTING(Item No.) ORDER(Ascending) WHERE(Not Needed=CONST(Yes));
        ...
        {
            DataItemTableView = SORTING(Item No.) ORDER(Ascending) WHERE(Don't Repeat=CONST(Yes));
        ...
        dataitem("Shortage Temp4";"Shortage Temp")
        {
            ...
            begin
                ShotageTemp4Visi := TRUE;
                    ...
                    Item.RESET;
                 IF Item.GET("Shortage Temp4"."Item No.") THEN
                 BEGIN
        ...
        {
            DataItemTableView = SORTING(Sales Order No.,Product Type,Production Order No.,Authorisation,Lead Time2) ORDER(Ascending) WHERE(Authorisation=FILTER(WFA|Authorised|indent),Shortage=FILTER(>0),Planned Purchase Date=FILTER(<>''),Sales Order No.=FILTER(<>''),Vendor Name=FILTER(<>''));
            ...
            begin
                ...
                ELSE IF "Item Lot Numbers3"."Lead Time2"='4D' THEN
                   TOTAL_LEAD_PRICES[2]+="Item Lot Numbers3".Total
                ELSE IF "Item Lot Numbers3"."Lead Time2"='7D' THEN
                   TOTAL_LEAD_PRICES[3]+="Item Lot Numbers3".Total
                ELSE IF "Item Lot Numbers3"."Lead Time2"='15D' THEN
                   TOTAL_LEAD_PRICES[4]+="Item Lot Numbers3".Total
                ELSE IF "Item Lot Numbers3"."Lead Time2"='21D' THEN
                   TOTAL_LEAD_PRICES[5]+="Item Lot Numbers3".Total
                ELSE IF "Item Lot Numbers3"."Lead Time2"='25D' THEN
                   TOTAL_LEAD_PRICES[6]+="Item Lot Numbers3".Total
                ELSE IF "Item Lot Numbers3"."Lead Time2"='30D' THEN
                   TOTAL_LEAD_PRICES[7]+="Item Lot Numbers3".Total
                ELSE IF "Item Lot Numbers3"."Lead Time2"='45D' THEN
                   TOTAL_LEAD_PRICES[8]+="Item Lot Numbers3".Total
                ELSE IF "Item Lot Numbers3"."Lead Time2"='60D' THEN
                   TOTAL_LEAD_PRICES[9]+="Item Lot Numbers3".Total
                ELSE IF "Item Lot Numbers3"."Lead Time2"='90D' THEN
                ...
                END ELSE BEGIN
                  ...
                  END ELSE IF Prev_Production_Order<>"Item Lot Numbers3"."Production Order No." THEN BEGIN
                      PRODUCTS_COUNT[i]+=1;
