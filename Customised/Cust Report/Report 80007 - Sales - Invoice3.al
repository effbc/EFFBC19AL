report 80007 "Sales - Invoice3"
{
    // version NAVW13.70,NAVIN3.70.00.13,sreenivas,KKC

    DefaultLayout = RDLC;
    RDLCLayout = './Sales - Invoice3.rdlc';
                        ...
                        begin
                            ...
                            //   tot[k][1]:=FORMAT("Sales Invoice Line"."Schedule No");
                               ...
                               */   // Commented by Pranavi on 20-Jan-2016 to generalize
                               ...
                               ELSE tot[k][3]:=FORMAT("Sales Invoice Line".Quantity);
                            ...
                            //   tot[k][3]:=FORMAT("Sales Invoice Line".Quantity);
                              //Added by Pranavi on 23-Dec-2015
                               ...
                               END ELSE BEGIN
                                ...
                                tot[k][7]:=formatadress.ChangeCurrency(ROUND(("Sales Invoice Line".Quantity*"Sales Invoice Line"."MRP Price")*("Sales Invoice Line"."Line Discount %")/100,1));
                               END;
    ...
    var
        ...
        PostedDocDim1 : Record Table359;
        PostedDocDim2 : Record Table359;
