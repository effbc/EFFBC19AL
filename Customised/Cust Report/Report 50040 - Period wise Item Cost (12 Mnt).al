        ...
        dataitem("Production BOM Header";"Production BOM Header")
        {
            ...
            dataitem("Production BOM Line";"Production BOM Line")
            {
                        ...
                        begin
                            ...
                            DO BEGIN
                             ...
                             BEGIN
                              ...
                              END;
                              IF (("Period cost"[I]=0) OR(cost=0) ) AND (I>2) THEN
                              BEGIN
                               "Period cost"[I]:="Period cost"[I-1];
                ...
                begin
                    ...
                    IF (PGC<>'FPRODUCT') AND (PGC<>'CPCB') THEN
                    BEGIN
                      FOR I:=1 TO 12 DO
                      "Period cost"[I]:=0;
                    END;
                    ...
                    DO BEGIN
                      ...
                      BEGIN
                        ...
                        END;
                      END;
                      IF ("Period cost"[I]=0) AND (I>1)   THEN
                      BEGIN
                        "Period cost"[I]:="Period cost"[I-1];
                 ...
                 DO BEGIN
                  ...
                  BEGIN
                   ...
                   BEGIN
                    ...
                    IF PIL.FIND('+') THEN
                    BEGIN
                      IF (PIL."Amount To Vendor">0) AND (PIL.Quantity>0) THEN
                      BEGIN
                    ...
                    "Period cost"[I]:="Period cost"[I-1];
                    TOTPRDCOST[I]+="Period cost"[I-1];
                    END ELSE IF ("Period cost"[I]=0)     THEN BEGIN
                     // "Period cost"[I]:="Period cost"[I-1];
                       // TOTPRDCOST[I]+="Period cost"[I-1];
                        END;
                   END ELSE
