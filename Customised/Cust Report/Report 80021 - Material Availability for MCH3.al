report 80021 "Material Availability for MCH3"
{
    // version NAVW17.00,ESPL 1.0,Rev01

    DefaultLayout = RDLC;
    RDLCLayout = './Material Availability for MCH3.rdlc';
    ...
    begin
            ...
            BEGIN
              ...
              IF Item.FIND('-') THEN
              BEGIN
                Item.CALCFIELDS(Item."Stock At MCH Location");
                ...
                BOM_DUM["Product_No."]."Stock at Stores":=Item."Stock At MCH Location";
    ...
    begin
              ...
              BEGIN
                ...
                BEGIN
                  ...
                  Dum."Maximum Inventory":=Item."Stock At MCH Location";
    ...
    begin
            ...
            BEGIN
              ...
              BEGIN
                ...
                Dum."Stock at Stores"+=Item."Stock At MCH Location";
