        ...
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
            ...
            begin
                ...
                IF GSTManagement.IsGSTApplicable("Purch. Inv. Header".Structure) THEN BEGIN
                    ...
                    IF PIL.FIND('-') THEN
                        REPEAT
                            IF CurrHSN <> PIL."HSN/SAC Code" THEN BEGIN
                                Assessable := 0;
                                Tot_Inv_Amt := 0;
                                PackingnForwrdingCharges := 0;
                                FrieghtCharges := 0;
                                ...
                                IF PIL1.FINDSET THEN
                                    REPEAT
                                        ...
                                        //BEGIN
                                        IF PIL1."GST Jurisdiction Type" = PIL1."GST Jurisdiction Type"::Interstate THEN BEGIN
                                            IF "Purch. Inv. Header"."Currency Factor" > 0 THEN
                                ...
                                IF Assessable > 0 THEN BEGIN
                                    ...
                                    END;
                                    IF PIL."GST Credit" = PIL."GST Credit"::"Non-Availment" THEN BEGIN
                                    ...
                                    ELSE
                                        ...
                                        END ELSE
                                            IF PIL."GST Group Type" = PIL."GST Group Type"::Goods THEN BEGIN
                                                Entercell(Row, 25, 'Input', FALSE, TempExcelbuffer."Cell Type"::Text);
                                            END ELSE
                                                IF PIL."GST Group Type" = PIL."GST Group Type"::Service THEN BEGIN
                                                ...
                                                END;
                                    IF "Purch. Inv. Header"."GST Vendor Type" = "Purch. Inv. Header"."GST Vendor Type"::SEZ THEN BEGIN
                ...
                END ELSE BEGIN
                        ...
                        REPEAT
                            IF "Purch. Inv. Header".Structure = 'FORIEGN' THEN BEGIN
                                IF PstrDetails."Account No." IN ['51300'] THEN
                                    PackingnForwrdingCharges += PstrDetails."Amount (LCY)"
                                ELSE
                                    IF PstrDetails."Account No." IN ['51400'] THEN
                                        FrieghtCharges += PstrDetails."Amount (LCY)"
                                    ELSE
                                        IF PstrDetails."Account No." IN ['61924', '67600', '51800', '53400', '48400'] THEN
                                            OtherCharges += PstrDetails."Amount (LCY)"
                                        ELSE
                                            IF PstrDetails."Account No." IN ['23300'] THEN
                            ...
                            ELSE BEGIN
                                IF PstrDetails."Account No." IN ['53903'] THEN
                                    PackingnForwrdingCharges += PstrDetails."Amount (LCY)"
                                ELSE
                                    IF PstrDetails."Account No." IN ['51100'] THEN
                                        FrieghtCharges += PstrDetails."Amount (LCY)"
                                    ELSE
                                        IF PstrDetails."Account No." IN ['58700'] THEN
                                            InsuranceCharges += PstrDetails."Amount (LCY)"
                                        ELSE
                                            IF PstrDetails."Account No." IN ['61924', '67600', '51800', '53400', '48400'] THEN
                                                OtherCharges += PstrDetails."Amount (LCY)";
                    ...
                    END ELSE BEGIN
                        ...
                        IF PIL."Tax Area Code" = 'PUCH CST' THEN BEGIN
