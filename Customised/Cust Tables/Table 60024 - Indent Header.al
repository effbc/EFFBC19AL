table 60024 "Indent Header"
{
    ...
    begin
        ...
        IF NOT (USERID IN ['EFFTRONICS\PRANAVI', 'EFFTRONICS\ANILKUMAR', 'EFFTRONICS\ANVESH', 'EFFTRONICS\SPURTHI', 'EFFTRONICS\VIJAYA', 'EFFTRONICS\SUJANI', 'EFFTRONICS\RRAHUL']) THEN BEGIN
            UserGRec.RESET;
