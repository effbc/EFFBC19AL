table 60024 "Indent Header"
{
    ...
    fields
    {
        ...
        {
            TableRelation = IF (Type of Indent=CONST(Sale Order)) "Sales Header".No. WHERE (Document Type=FILTER(Order|Blanket Order)) ELSE IF (Type of Indent=CONST(AMC Order)) "Sales Header".No. WHERE (Document Type=CONST(Amc));
    ...
    begin
        ...
        IF NOT (USERID IN ['EFFTRONICS\PRANAVI','EFFTRONICS\ANILKUMAR','EFFTRONICS\ANVESH','EFFTRONICS\SPURTHI','EFFTRONICS\VIJAYA','EFFTRONICS\SUJANI','EFFTRONICS\RRAHUL']) THEN
        BEGIN
          UserGRec.RESET;
