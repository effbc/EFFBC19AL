table 60025 "Indent Line"
{
    ...
    fields
    {
        ...
        {
            DataClassification = CustomerContent;
            TableRelation = IF (Type = CONST(Item)) Item WHERE("Product Group Code" = FILTER(<> FPRODUCT & <> CPCB), Blocked = CONST(No)) ELSE
                ...
                CASE Type OF
                    Type::Item:
                        ...
                        IF Item.GET("No.") THEN BEGIN
                            ...
                            //b2b EFF
                            IF NOT ((Item."Product Group Code" = 'STATIONARY') OR (Item."Gen. Prod. Posting Group" = 'STATIONARY') OR (Item."Item Category Code" = 'OFFICE MAI')) THEN BEGIN
