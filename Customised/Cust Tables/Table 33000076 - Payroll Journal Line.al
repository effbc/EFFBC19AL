table 33000076 "Payroll Journal Line"
{
    ...
    fields
    {
        ...
        field(5;"Account No.";Code[20])
        {
            ...
            TableRelation = IF ("Account Type"=FILTER("G/L Account")) "G/L Account"."No."
                            ELSE IF ("Account Type"=FILTER(Employee)) Employee."No.";
                  ...
                  "Account Type"::"G/L Account":
                    begin
                      ...
                      if ("Bal. Account No." = '') or ("Bal. Account Type" in
                                                      ["Bal. Account Type"::"G/L Account","Bal. Account Type"::"Bank Account"]) then
                        begin
                          "Posting Group" := '';
                          //"Payment Terms Code" := '';
                        end;
        ...
        field(22;"Bal. Account No.";Code[20])
        {
            ...
            TableRelation = IF ("Bal. Account Type"=FILTER("G/L Account")) "G/L Account"."No."
                            ELSE IF ("Bal. Account Type"=FILTER(Employee)) Employee."No.";
                  ...
                  "Bal. Account Type"::"G/L Account":
                    begin
                      ...
                      */
                      ...
                      if ("Account No." = '') or ("Account Type" in ["Account Type"::"G/L Account","Account Type"::"Bank Account"]) then
                        begin
                          "Posting Group" := '';
                          //"Payment Terms Code" := '';
                        end;
    ...
    begin
        ...
        if PayrollJournalLine.Find('-') then
          ...
          begin
            ...
            if PayGenJournalBatch."No. Series" <> '' then
              begin
                Clear(NoSeriesMgt);
    ...
    begin
        if Rec."Bal. Account Type" in ["Bal. Account Type"::Employee] then
          begin
