table 33000044 "Pay Employee Loan Detail"
{
    ...
    fields
    {
        ...
        field(30;"EMI Deducted";Decimal)
        {
            ...
            begin
                ...
                if "EMI Deducted" > "Installment Amount" then
                  begin
        ...
        field(50010;"Requested EMI Deduction";Decimal)
        {
            ...
            begin
                ...
                if "Requested EMI Deduction" > "Installment Amount" then
                begin
                  Error(Text001);
                  "Requested EMI Deduction" := "Installment Amount";
                  exit;
    ...
    begin
        ...
        if PayEmployeeLoanDetail.Find('-') then
        begin
           EntNo := EntryNo;
           LoanAmount := Balance;
    ...
    begin
        ...
        if (PrincipalAmount > LoanAmount) then
          begin
