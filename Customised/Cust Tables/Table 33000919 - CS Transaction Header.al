table 33000919 "CS Transaction Header"
{
    ...
    fields
    {
        ...
        field(3;"Transfer From Location";Code[20])
        {
            ...
            begin
                ...
                BEGIN
                  ...
                  ELSE "Responsible Persion" := USERID;
                END
                ELSE IF NOT ("Transfer From Location" IN['H-OFF','SERVICE']) THEN
                BEGIN
                  DivisionGRec.RESET;
                  DivisionGRec.SETRANGE(DivisionGRec."Division Code","Transfer From Location");
                  ...
                  BEGIN
                    ...
                    IF UserGRec.FINDFIRST THEN
                      "Responsible Persion" := UserGRec."User Name";
                  END;
                END;
            end;
        }
        ...
        {
            TableRelation = "Dimension Value".Code WHERE (Global Dimension No.=CONST(2),Blocked=FILTER(No),Code=FILTER(<>H-OFF));
        }
