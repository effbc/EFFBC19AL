...
.;
        ...
        {
            CalcFormula = Sum("Inspection Receipt Header".Quantity WHERE (Parent IDS=FIELD(No.),Status=FILTER(Yes)));
            FieldClass = FlowField;
        }
        ...
        field(60131;"Assigned User";Code[50])
        {
            ...
            TableRelation = User."User Name" WHERE (Field60106=CONST(QAS),Field60103=CONST(No));
